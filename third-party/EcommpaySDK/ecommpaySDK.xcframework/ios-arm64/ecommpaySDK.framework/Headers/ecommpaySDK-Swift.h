...
@property (nonatomic, strong) UIColor * _Nonnull btnDisableBackgroundColor;
...
@property (nonatomic, strong) UIColor * _Nonnull searchInputViewPlaceholderColor;
@property (nonatomic, strong) UIColor * _Nonnull bankItemTextColor;
@property (nonatomic, strong) UIColor * _Nonnull loadingScreenBackground;
@property (nonatomic, strong) UIColor * _Nonnull clarificationInfoTextColor;
@property (nonatomic, strong) UIColor * _Nonnull clarificationHeaderTextColor;
@property (nonatomic, strong) UIColor * _Nonnull clarificationInfoBackgroundColor;
@property (nonatomic, strong) UIColor * _Nonnull clarificationInfoCircleColor;
@property (nonatomic, strong) UIColor * _Nonnull clarificationPaymentInfoBackgroundColor;
@property (nonatomic, strong) UIColor * _Nonnull clarificationInfoTintColor;
...
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
/// \param callback Payment callbacks
///
- (nonnull instancetype)callback:(id <ECMPCallback> _Nullable)callback OBJC_DESIGNATED_INITIALIZER SWIFT_METHOD_FAMILY(init);
