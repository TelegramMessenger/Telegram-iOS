...
#define FFMPEG_CONFIGURATION "--target-os=darwin --arch=arm64 --cc='xcrun -sdk iphoneos clang' --as='gas-preprocessor.pl -arch aarch64 -- xcrun -sdk iphoneos clang' --enable-cross-compile --disable-debug --disable-programs --disable-doc --enable-pic --disable-all --disable-everything --disable-videotoolbox --enable-avcodec --enable-swresample --enable-avformat --disable-xlib --enable-audiotoolbox --enable-libopus --enable-bsf=aac_adtstoasc --enable-decoder='h264,libopus,mp3_at,aac_at,flac,alac_at,pcm_s16le,pcm_s24le,gsm_ms_at' --enable-demuxer='aac,mov,m4v,mp3,ogg,libopus,flac,wav' --enable-parser='aac,h264,mp3,libopus' --enable-protocol=http --extra-cflags='-arch arm64 -mios-version-min=8.0 -fembed-bitcode' --extra-ldflags='-arch arm64 -mios-version-min=8.0 -fembed-bitcode' --prefix=/Users/peter/build/FFmpeg-iOS-build-script/thin/arm64"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2018
#define FFMPEG_DATADIR "/Users/peter/build/FFmpeg-iOS-build-script/thin/arm64/share/ffmpeg"
#define AVCONV_DATADIR "/Users/peter/build/FFmpeg-iOS-build-script/thin/arm64/share/ffmpeg"
