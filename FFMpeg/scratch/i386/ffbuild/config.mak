...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=darwin --arch=i386 --cc='xcrun -sdk iphonesimulator clang' --as='gas-preprocessor.pl -- xcrun -sdk iphonesimulator clang' --enable-cross-compile --disable-debug --disable-programs --disable-doc --enable-pic --disable-all --disable-everything --disable-videotoolbox --enable-avcodec --enable-swresample --enable-avformat --disable-xlib --enable-audiotoolbox --enable-libopus --enable-bsf=aac_adtstoasc --enable-decoder='h264,libopus,mp3_at,aac_at,flac,alac_at,pcm_s16le,pcm_s24le,gsm_ms_at' --enable-demuxer='aac,mov,m4v,mp3,ogg,libopus,flac,wav' --enable-parser='aac,h264,mp3,libopus' --enable-protocol=http --extra-cflags='-arch i386 -mios-simulator-version-min=8.0' --extra-ldflags='-arch i386 -mios-simulator-version-min=8.0' --prefix=/Users/peter/build/FFmpeg-iOS-build-script/thin/i386
prefix=/Users/peter/build/FFmpeg-iOS-build-script/thin/i386
...
SRC_PATH=/Users/peter/build/FFmpeg-iOS-build-script/ffmpeg-4.1
SRC_LINK=src
...
CFLAGS=  -arch i386 -mios-simulator-version-min=8.0 -std=c11 -Werror=partial-availability -fomit-frame-pointer -fPIC -pthread  -I/Users/peter/build/ffmpeg/libopus/include/opus -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -O3 -fno-math-errno -fno-signed-zeros -mstack-alignment=16 -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
...
EXTRALIBS-avcodec=-pthread -liconv -lm -framework AudioToolbox -L/Users/peter/build/ffmpeg/libopus/lib -lopus
