...
- [Changelog](http://www.hockeyapp.net/help/sdk/ios/4.0.0-alpha.2/docs/docs/Changelog.html)
...
Our documentation can be found on [HockeyApp](http://hockeyapp.net/help/sdk/ios/4.0.0-alpha.2/index.html).
...
### iTunes Connect rejection
  ...
  - `de.bitstadium.HockeySDK-iOS-4.0.0-alpha.2.docset`
