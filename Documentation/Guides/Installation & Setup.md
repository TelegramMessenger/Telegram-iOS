...
- [Changelog](http://www.hockeyapp.net/help/sdk/ios/5.0.1/docs/docs/Changelog.html)
...
Our documentation can be found on [HockeyApp](http://hockeyapp.net/help/sdk/ios/5.0.1/index.html).
...
### iTunes Connect rejection
  ...
  - `de.bitstadium.HockeySDK-iOS-5.0.1.docset`
