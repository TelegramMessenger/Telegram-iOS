            ...
            if self.stateAndStatus != oldValue {
                ...
                if previousPlaylistPeerId != updatedPlaylistPeerId {
                    ...
                    if let updatedPlaylistPeerId = updatedPlaylistPeerId {
                        ...
                        }, presentController: { _, _ in }, presentGlobalOverlayController: { _, _ in }, callPeer: { _ in }, longTap: { _ in }, openCheckoutOrReceipt: { _ in }, openSearch: { }, setupReply: { _ in }, canSetupReply: { return false }, requestMessageUpdate: { _ in }, automaticMediaDownloadSettings: .none)
