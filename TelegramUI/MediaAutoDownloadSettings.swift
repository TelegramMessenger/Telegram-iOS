...
public struct MediaAutoDownloadSettings: PreferencesEntry, Equatable {
    ...
    func connectionSettings(for networkType: MediaAutoDownloadNetworkType) -> MediaAutoDownloadConnection {
        switch networkType {
            case .cellular:
...
func updateMediaDownloadSettingsInteractively(accountManager: AccountManager, _ f: @escaping (MediaAutoDownloadSettings) -> MediaAutoDownloadSettings) -> Signal<Void, NoError> {
...
func isAutodownloadEnabledForPeerType(_ peerType: MediaAutoDownloadPeerType, category: MediaAutoDownloadCategory) -> Bool {
    switch peerType {
        case .contact:
...
func isAutodownloadEnabledForAnyPeerType(category: MediaAutoDownloadCategory) -> Bool {
