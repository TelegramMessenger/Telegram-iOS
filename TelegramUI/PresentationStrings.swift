...
public final class PresentationStrings {
    ...
    public var SocksProxySetup_Status: String { return self._s[2003]! }
    public var PrivacyPolicy_Accept: String { return self._s[2004]! }
    public var Notifications_ExceptionsMessagePlaceholder: String { return self._s[2005]! }
    ...
    public var InfoPlist_NSLocationAlwaysUsageDescription: String { return self._s[2007]! }
    public var AutoNightTheme_Automatic: String { return self._s[2008]! }
    public var Channel_Username_InvalidStartsWithNumber: String { return self._s[2009]! }
    public var Privacy_ContactsSyncHelp: String { return self._s[2010]! }
    public var Cache_Help: String { return self._s[2011]! }
    public var Passport_Language_fa: String { return self._s[2012]! }
    public var Login_ResetAccountProtected_TimerTitle: String { return self._s[2013]! }
    public var PrivacySettings_LastSeen: String { return self._s[2014]! }
    public func DialogList_MultipleTyping(_ _0: String, _ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2015]!, self._r[2015]!, [_0, _1])
    }
    public var Preview_SaveGif: String { return self._s[2019]! }
    public var Profile_About: String { return self._s[2020]! }
    public var Channel_About_Placeholder: String { return self._s[2021]! }
    public var Login_InfoTitle: String { return self._s[2022]! }
    ...
    public var Watch_Suggestion_CantTalk: String { return self._s[2025]! }
    public var ContactInfo_Title: String { return self._s[2026]! }
    public var Media_ShareThisVideo: String { return self._s[2027]! }
    public var Weekday_ShortFriday: String { return self._s[2028]! }
    public var AccessDenied_Contacts: String { return self._s[2029]! }
    public var Notification_CallIncomingShort: String { return self._s[2030]! }
    public var Group_Setup_TypePublic: String { return self._s[2031]! }
    public var Notifications_MessageNotificationsExceptions: String { return self._s[2032]! }
    public var Notifications_Badge_IncludeChannels: String { return self._s[2033]! }
    public var Notifications_MessageNotificationsPreview: String { return self._s[2036]! }
    public var ConversationProfile_ErrorCreatingConversation: String { return self._s[2037]! }
    public var Group_ErrorAddTooMuchBots: String { return self._s[2038]! }
    public var Privacy_GroupsAndChannels_CustomShareHelp: String { return self._s[2039]! }
    public var Permissions_CellularDataAllowInSettings_v0: String { return self._s[2040]! }
    public var DialogList_Typing: String { return self._s[2041]! }
    public var CallFeedback_IncludeLogs: String { return self._s[2043]! }
    public var Checkout_Phone: String { return self._s[2045]! }
    public var Login_InfoFirstNamePlaceholder: String { return self._s[2048]! }
    public var Privacy_Calls_Integration: String { return self._s[2049]! }
    public var Notifications_PermissionsAllow: String { return self._s[2050]! }
    public var TwoStepAuth_AddHintDescription: String { return self._s[2054]! }
    public var Settings_ChatSettings: String { return self._s[2055]! }
    ...
    public var GroupRemoved_DeleteUser: String { return self._s[2058]! }
    ...
    public var Passport_Language_dz: String { return self._s[2072]! }
    public var Passport_Language_tk: String { return self._s[2073]! }
    ...
    public var InfoPlist_NSPhotoLibraryUsageDescription: String { return self._s[2075]! }
    public var Conversation_ContextMenuReply: String { return self._s[2076]! }
    public var WallpaperSearch_ColorBrown: String { return self._s[2077]! }
    public var Tour_Title1: String { return self._s[2078]! }
    public var Conversation_ClearGroupHistory: String { return self._s[2080]! }
    public var WallpaperPreview_Motion: String { return self._s[2081]! }
    ...
    public var Channel_AdminLog_BanSendStickersAndGifs: String { return self._s[2084]! }
    public var Passport_PasswordCompleteSetup: String { return self._s[2085]! }
    public var Conversation_InputTextSilentBroadcastPlaceholder: String { return self._s[2086]! }
    public var UserInfo_LastNamePlaceholder: String { return self._s[2088]! }
    public func Login_WillCallYou(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2090]!, self._r[2090]!, [_0])
    }
    public var Compose_Create: String { return self._s[2091]! }
    public var Contacts_InviteToTelegram: String { return self._s[2092]! }
    public var GroupInfo_Notifications: String { return self._s[2093]! }
    public var Message_PinnedLiveLocationMessage: String { return self._s[2095]! }
    public var Month_GenApril: String { return self._s[2096]! }
    public var Appearance_AutoNightTheme: String { return self._s[2097]! }
    public var ChatSettings_AutomaticAudioDownload: String { return self._s[2099]! }
    public var Login_CodeSentSms: String { return self._s[2101]! }
    ...
    public var EmptyGroupInfo_Line3: String { return self._s[2103]! }
    public var Passport_Language_hr: String { return self._s[2104]! }
    ...
    public var GroupInfo_InviteLink_CopyLink: String { return self._s[2106]! }
    public var Conversation_InputTextBroadcastPlaceholder: String { return self._s[2107]! }
    public var Privacy_SecretChatsTitle: String { return self._s[2108]! }
    public var Notification_SecretChatMessageScreenshotSelf: String { return self._s[2110]! }
    public var GroupInfo_AddUserLeftError: String { return self._s[2111]! }
    ...
    public var WallpaperColors_Title: String { return self._s[2127]! }
    public var SocksProxySetup_ShareQRCodeInfo: String { return self._s[2128]! }
    ...
    public var CallFeedback_WhatWentWrong: String { return self._s[2133]! }
    ...
    public var WallpaperPreview_Blurred: String { return self._s[2153]! }
    ...
    public var WallpaperSearch_ColorRed: String { return self._s[2159]! }
    public var GroupPermission_NoPinMessages: String { return self._s[2160]! }
    public var Passport_Language_es: String { return self._s[2161]! }
    public var Permissions_ContactsAllow_v0: String { return self._s[2163]! }
    public var Conversation_EditingMessageMediaEditCurrentVideo: String { return self._s[2164]! }
    ...
    public var WebPreview_GettingLinkInfo: String { return self._s[2166]! }
    public var Watch_UserInfo_Unmute: String { return self._s[2167]! }
    public var GroupInfo_ChannelListNamePlaceholder: String { return self._s[2168]! }
    public var AccessDenied_CameraRestricted: String { return self._s[2170]! }
    ...
    public var ChatList_ReadAll: String { return self._s[2173]! }
    public var Settings_CopyUsername: String { return self._s[2174]! }
    public var Contacts_SearchLabel: String { return self._s[2175]! }
    public var Map_OpenInYandexNavigator: String { return self._s[2177]! }
    public var PasscodeSettings_EncryptData: String { return self._s[2178]! }
    public var WallpaperSearch_ColorPrefix: String { return self._s[2179]! }
    public var Notifications_GroupNotificationsPreview: String { return self._s[2180]! }
    public var DialogList_AdNoticeAlert: String { return self._s[2181]! }
    ...
    public var CallFeedback_Title: String { return self._s[2187]! }
    ...
    public func ForwardedAuthorsOthers(_ selector: Int32, _ _0: String, _ _1: String) -> String {
        ...
        return String(format: self._ps[18 * 6 + Int(form.rawValue)]!, _0, _1)
    }
