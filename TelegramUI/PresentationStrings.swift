...
public final class PresentationStrings {
    ...
    public var Login_ContinueWithLocalization: String { return self._s[1933]! }
    public var Watch_Message_ForwardedFrom: String { return self._s[1934]! }
    public var TwoStepAuth_EnterEmailCode: String { return self._s[1936]! }
    public var Conversation_Unblock: String { return self._s[1937]! }
    public var PrivacySettings_DataSettings: String { return self._s[1938]! }
    public var Notifications_InAppNotificationsVibrate: String { return self._s[1939]! }
    public func Privacy_GroupsAndChannels_InviteToChannelError(_ _0: String, _ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[1940]!, self._r[1940]!, [_0, _1])
    }
    public var PrivacySettings_Passcode: String { return self._s[1943]! }
    public func ENCRYPTION_ACCEPT(_ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[1944]!, self._r[1944]!, [_1])
    }
    public var Passport_Language_dz: String { return self._s[1945]! }
    public var Passport_Language_tk: String { return self._s[1946]! }
    ...
    public var InfoPlist_NSPhotoLibraryUsageDescription: String { return self._s[1948]! }
    public var Conversation_ContextMenuReply: String { return self._s[1949]! }
    public var Tour_Title1: String { return self._s[1950]! }
    ...
    public var Conversation_ClearGroupHistory: String { return self._s[1953]! }
    ...
    public var Passport_PasswordCompleteSetup: String { return self._s[1956]! }
    public var Conversation_InputTextSilentBroadcastPlaceholder: String { return self._s[1957]! }
    public var UserInfo_LastNamePlaceholder: String { return self._s[1959]! }
    public func Login_WillCallYou(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[1961]!, self._r[1961]!, [_0])
    }
    public var Compose_Create: String { return self._s[1962]! }
    public var Contacts_InviteToTelegram: String { return self._s[1963]! }
    public var GroupInfo_Notifications: String { return self._s[1964]! }
    public var Message_PinnedLiveLocationMessage: String { return self._s[1966]! }
    public var Month_GenApril: String { return self._s[1967]! }
    public var Appearance_AutoNightTheme: String { return self._s[1968]! }
    public var ChatSettings_AutomaticAudioDownload: String { return self._s[1970]! }
    public var Login_CodeSentSms: String { return self._s[1972]! }
    ...
    public var Passport_Language_hr: String { return self._s[1974]! }
    ...
    public var GroupInfo_InviteLink_CopyLink: String { return self._s[1976]! }
    public var Conversation_InputTextBroadcastPlaceholder: String { return self._s[1977]! }
    public var Privacy_SecretChatsTitle: String { return self._s[1978]! }
    public var Notification_SecretChatMessageScreenshotSelf: String { return self._s[1980]! }
    public var GroupInfo_AddUserLeftError: String { return self._s[1981]! }
    public var Preview_DeleteGif: String { return self._s[1982]! }
    public var Group_ErrorNotMutualContact: String { return self._s[1983]! }
    public var Notification_MessageLifetime5s: String { return self._s[1984]! }
    ...
    public var Passport_Address_AddBankStatement: String { return self._s[1987]! }
    public var Notification_CallIncoming: String { return self._s[1988]! }
    public var Compose_NewGroupTitle: String { return self._s[1989]! }
    public var TwoStepAuth_RecoveryCodeHelp: String { return self._s[1991]! }
    public var Passport_Address_Postcode: String { return self._s[1993]! }
    ...
    public var Checkout_NewCard_SaveInfoHelp: String { return self._s[1995]! }
    public func Cache_Clear(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[1996]!, self._r[1996]!, [_0])
    }
    public var Bot_GroupStatusDoesNotReadHistory: String { return self._s[1997]! }
    public var Username_Placeholder: String { return self._s[1998]! }
    public var Passport_FieldAddressUploadHelp: String { return self._s[1999]! }
    public var Permissions_NotificationsAllowInSettings_v0: String { return self._s[2000]! }
    public var Passport_PasswordDescription: String { return self._s[2002]! }
    public var Channel_MessagePhotoUpdated: String { return self._s[2003]! }
    public var MediaPicker_TapToUngroupDescription: String { return self._s[2004]! }
    public var AttachmentMenu_PhotoOrVideo: String { return self._s[2005]! }
    public var Conversation_ContextMenuMore: String { return self._s[2006]! }
    public var Privacy_PaymentsClearInfo: String { return self._s[2007]! }
    public var CallSettings_TabIcon: String { return self._s[2008]! }
    public var KeyCommand_Find: String { return self._s[2009]! }
    public var Message_PinnedGame: String { return self._s[2010]! }
    public var Notifications_Badge_CountUnreadMessages_InfoOff: String { return self._s[2011]! }
    public var Login_CallRequestState2: String { return self._s[2013]! }
    public var CheckoutInfo_ReceiverInfoNamePlaceholder: String { return self._s[2015]! }
    public func Checkout_PayPrice(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2017]!, self._r[2017]!, [_0])
    }
    public var Conversation_InstantPagePreview: String { return self._s[2018]! }
    ...
    public var SecretTimer_VideoDescription: String { return self._s[2022]! }
    public var Passport_Language_es: String { return self._s[2023]! }
    public var Permissions_ContactsAllow_v0: String { return self._s[2025]! }
    public var Conversation_EditingMessageMediaEditCurrentVideo: String { return self._s[2026]! }
    public var WebPreview_GettingLinkInfo: String { return self._s[2027]! }
    public var Watch_UserInfo_Unmute: String { return self._s[2028]! }
    public var GroupInfo_ChannelListNamePlaceholder: String { return self._s[2029]! }
    public var ChatList_ReadAll: String { return self._s[2031]! }
    public var AccessDenied_CameraRestricted: String { return self._s[2032]! }
    ...
    public var Contacts_SearchLabel: String { return self._s[2036]! }
    public var Settings_CopyUsername: String { return self._s[2037]! }
    public func MESSAGE_GEOLIVE(_ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2038]!, self._r[2038]!, [_1])
    }
    public var Map_OpenInYandexNavigator: String { return self._s[2039]! }
    public var PasscodeSettings_EncryptData: String { return self._s[2040]! }
    public var Notifications_GroupNotificationsPreview: String { return self._s[2041]! }
    public var DialogList_AdNoticeAlert: String { return self._s[2042]! }
    ...
    public var CheckoutInfo_ShippingInfoAddress1: String { return self._s[2045]! }
    public var CheckoutInfo_ShippingInfoAddress2: String { return self._s[2046]! }
    public var Localization_LanguageCustom: String { return self._s[2047]! }
    public var Passport_Identity_TypeDriversLicenseUploadScan: String { return self._s[2048]! }
    ...
    public var Passport_Address_OneOfTypePassportRegistration: String { return self._s[2052]! }
    public var Conversation_InfoGroup: String { return self._s[2053]! }
    public var Compose_NewMessage: String { return self._s[2054]! }
    public var FastTwoStepSetup_HintPlaceholder: String { return self._s[2055]! }
    public var ChatSettings_AutoDownloadVideoMessages: String { return self._s[2056]! }
    ...
    public var Channel_AdminLog_CanDeleteMessages: String { return self._s[2058]! }
    public var Login_CancelSignUpConfirmation: String { return self._s[2059]! }
    public var ChangePhoneNumberCode_Help: String { return self._s[2060]! }
    public var PrivacySettings_DeleteAccountHelp: String { return self._s[2061]! }
    public var Channel_BlackList_Title: String { return self._s[2062]! }
    public var UserInfo_PhoneCall: String { return self._s[2063]! }
    public var Passport_Address_OneOfTypeBankStatement: String { return self._s[2065]! }
    public var State_connecting: String { return self._s[2066]! }
    ...
    public var Notifications_GroupNotifications: String { return self._s[2068]! }
    public var Passport_Identity_EditPassport: String { return self._s[2069]! }
    public var EnterPasscode_RepeatNewPasscode: String { return self._s[2071]! }
    public var Localization_EnglishLanguageName: String { return self._s[2072]! }
    public var Share_AuthDescription: String { return self._s[2073]! }
    public var Passport_Identity_Surname: String { return self._s[2074]! }
    public var Compose_TokenListPlaceholder: String { return self._s[2075]! }
    public var Passport_Identity_OneOfTypePassport: String { return self._s[2076]! }
    public var Settings_AboutEmpty: String { return self._s[2077]! }
    public var Conversation_Unmute: String { return self._s[2078]! }
    public var Login_CodeSentCall: String { return self._s[2081]! }
    public var ContactInfo_PhoneLabelHomeFax: String { return self._s[2082]! }
    public var ChatSettings_Appearance: String { return self._s[2083]! }
    public var Appearance_PickAccentColor: String { return self._s[2084]! }
    public var Notification_CallMissed: String { return self._s[2085]! }
    public var Channel_AdminLogFilter_EventsInfo: String { return self._s[2086]! }
    public var ChatAdmins_AdminLabel: String { return self._s[2088]! }
    public var KeyCommand_JumpToNextChat: String { return self._s[2089]! }
    public var Conversation_StopPollConfirmationTitle: String { return self._s[2091]! }
    public var ChangePhoneNumberCode_CodePlaceholder: String { return self._s[2092]! }
    public var Month_GenJune: String { return self._s[2093]! }
    public var Watch_Location_Current: String { return self._s[2094]! }
    public var Conversation_TitleMute: String { return self._s[2095]! }
    public func PINNED_ROUND(_ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2096]!, self._r[2096]!, [_1])
    }
    public var GroupInfo_DeleteAndExit: String { return self._s[2097]! }
    ...
    public var Call_ReportPlaceholder: String { return self._s[2099]! }
    public var MaskStickerSettings_Info: String { return self._s[2100]! }
    ...
    public var Checkout_NewCard_PostcodeTitle: String { return self._s[2102]! }
    public var Passport_Address_RegionPlaceholder: String { return self._s[2104]! }
    public var Contacts_ShareTelegram: String { return self._s[2105]! }
    public var EnterPasscode_EnterNewPasscodeNew: String { return self._s[2106]! }
    public var Channel_ErrorAccessDenied: String { return self._s[2107]! }
    public var Stickers_GroupChooseStickerPack: String { return self._s[2109]! }
    public var Call_ConnectionErrorTitle: String { return self._s[2110]! }
    public var UserInfo_NotificationsEnable: String { return self._s[2111]! }
    public var Tour_Text4: String { return self._s[2114]! }
    ...
    public var Profile_MessageLifetime2s: String { return self._s[2117]! }
    public var Notification_MessageLifetime2s: String { return self._s[2118]! }
    ...
    public var Cache_ClearCache: String { return self._s[2120]! }
    public var AutoNightTheme_UpdateLocation: String { return self._s[2121]! }
    public var Permissions_NotificationsUnreachableText_v0: String { return self._s[2122]! }
    ...
    public var Channel_AdminLog_EmptyFilterTitle: String { return self._s[2126]! }
    public var SocksProxySetup_TypeSocks: String { return self._s[2127]! }
    public var AutoNightTheme_Title: String { return self._s[2128]! }
    public var InstantPage_FeedbackButton: String { return self._s[2129]! }
    public var Passport_FieldAddress: String { return self._s[2130]! }
    public var Month_ShortMarch: String { return self._s[2131]! }
    public var SocksProxySetup_UsernamePlaceholder: String { return self._s[2132]! }
    public var Conversation_ShareInlineBotLocationConfirmation: String { return self._s[2133]! }
    public var Passport_FloodError: String { return self._s[2134]! }
    public var SecretGif_Title: String { return self._s[2135]! }
    public var Passport_Language_th: String { return self._s[2137]! }
    public var Passport_Address_Address: String { return self._s[2138]! }
    public var Login_InvalidLastNameError: String { return self._s[2139]! }
    public var Notifications_InAppNotificationsPreview: String { return self._s[2140]! }
    public var Notifications_PermissionsUnreachableTitle: String { return self._s[2141]! }
