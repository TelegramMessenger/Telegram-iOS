...
<<<<<<< HEAD
    ...
    public var ChatList_UndoArchiveText: String { return self._s[1922]! }
    public func FileSize_KB(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[1923]!, self._r[1923]!, [_0])
    }
    public var PasscodeSettings_ChangePasscode: String { return self._s[1924]! }
    public var Conversation_SecretLinkPreviewAlert: String { return self._s[1926]! }
    public var Privacy_SecretChatsLinkPreviews: String { return self._s[1927]! }
    ...
    public var Contacts_InviteFriends: String { return self._s[1930]! }
    public var Map_ChooseLocationTitle: String { return self._s[1931]! }
    public var Conversation_StopPoll: String { return self._s[1933]! }
    ...
    public var Call_Camera: String { return self._s[1935]! }
    public var LogoutOptions_ChangePhoneNumberTitle: String { return self._s[1936]! }
    public var Calls_RatingFeedback: String { return self._s[1937]! }
    public var GroupInfo_BroadcastListNamePlaceholder: String { return self._s[1938]! }
    public var NotificationsSound_Pulse: String { return self._s[1939]! }
    public var Watch_LastSeen_Lately: String { return self._s[1940]! }
    public var Widget_NoUsers: String { return self._s[1943]! }
    public var Conversation_UnvotePoll: String { return self._s[1944]! }
    public var SettingsSearch_Synonyms_Privacy_ProfilePhoto: String { return self._s[1946]! }
    public var Privacy_ProfilePhoto_WhoCanSeeMyPhoto: String { return self._s[1947]! }
    public var NotificationsSound_Circles: String { return self._s[1948]! }
    public var PrivacyLastSeenSettings_AlwaysShareWith_Title: String { return self._s[1950]! }
    public var TwoStepAuth_RecoveryCodeExpired: String { return self._s[1951]! }
    public var Proxy_TooltipUnavailable: String { return self._s[1952]! }
    public var Passport_Identity_CountryPlaceholder: String { return self._s[1954]! }
    public var Conversation_FileDropbox: String { return self._s[1956]! }
    public var Notifications_ExceptionsUnmuted: String { return self._s[1957]! }
    public var Tour_Text3: String { return self._s[1959]! }
    public var Login_ResetAccountProtected_Title: String { return self._s[1961]! }
    public var GroupPermission_NoSendMessages: String { return self._s[1962]! }
    public var WallpaperSearch_ColorTitle: String { return self._s[1963]! }
    public var ChatAdmins_AllMembersAreAdminsOnHelp: String { return self._s[1964]! }
    ...
    public var GroupInfo_AddParticipantTitle: String { return self._s[1967]! }
    public var Checkout_ShippingOption_Title: String { return self._s[1968]! }
    public var ChatSettings_AutoDownloadTitle: String { return self._s[1969]! }
    ...
    public var PrivacyLastSeenSettings_NeverShareWith_Placeholder: String { return self._s[1972]! }
    public var AutoDownloadSettings_Photos: String { return self._s[1974]! }
    public var Appearance_PreviewIncomingText: String { return self._s[1975]! }
    public var ChannelInfo_ConfirmLeave: String { return self._s[1976]! }
    public var MediaPicker_MomentsDateRangeSameMonthYearFormat: String { return self._s[1977]! }
    public var Passport_Identity_DocumentNumberPlaceholder: String { return self._s[1978]! }
    public var Channel_AdminLogFilter_EventsNewMembers: String { return self._s[1979]! }
    public var PasscodeSettings_AutoLock_IfAwayFor_5minutes: String { return self._s[1980]! }
    public var GroupInfo_SetGroupPhotoStop: String { return self._s[1981]! }
    public var Notification_SecretChatScreenshot: String { return self._s[1982]! }
    public var AccessDenied_Wallpapers: String { return self._s[1983]! }
    public var Passport_Address_City: String { return self._s[1985]! }
    public var InfoPlist_NSPhotoLibraryAddUsageDescription: String { return self._s[1986]! }
    public var SocksProxySetup_SecretPlaceholder: String { return self._s[1987]! }
    public var AccessDenied_LocationDisabled: String { return self._s[1988]! }
    public var SocksProxySetup_HostnamePlaceholder: String { return self._s[1990]! }
    public var GroupInfo_Sound: String { return self._s[1991]! }
    public var Stickers_RemoveFromFavorites: String { return self._s[1992]! }
    public var Contacts_Title: String { return self._s[1993]! }
    public var Passport_Language_fr: String { return self._s[1994]! }
    public var Notifications_ResetAllNotifications: String { return self._s[1995]! }
    public var PrivacySettings_SecurityTitle: String { return self._s[1998]! }
    public var Checkout_NewCard_Title: String { return self._s[1999]! }
    public var Login_HaveNotReceivedCodeInternal: String { return self._s[2000]! }
    public var Conversation_ForwardChats: String { return self._s[2001]! }
    public var Settings_FAQ: String { return self._s[2004]! }
    public var AutoDownloadSettings_DocumentsTitle: String { return self._s[2005]! }
    public var Conversation_ContextMenuForward: String { return self._s[2006]! }
    public var PrivacyPolicy_Title: String { return self._s[2011]! }
    public var Notifications_TextTone: String { return self._s[2012]! }
    public var Profile_CreateNewContact: String { return self._s[2013]! }
    public var Call_Speaker: String { return self._s[2015]! }
    public var AutoNightTheme_AutomaticSection: String { return self._s[2016]! }
    public var Channel_Username_InvalidCharacters: String { return self._s[2018]! }
    public func Channel_AdminLog_MessageChangedChannelUsername(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2019]!, self._r[2019]!, [_0])
    }
    public var AutoDownloadSettings_AutodownloadFiles: String { return self._s[2020]! }
    public var PrivacySettings_LastSeenTitle: String { return self._s[2021]! }
    public var Channel_AdminLog_CanInviteUsers: String { return self._s[2022]! }
    public var SettingsSearch_Synonyms_Privacy_Data_ClearPaymentsInfo: String { return self._s[2023]! }
    public var Conversation_MessageDeliveryFailed: String { return self._s[2024]! }
    public var Watch_ChatList_NoConversationsText: String { return self._s[2025]! }
    public var Bot_Unblock: String { return self._s[2026]! }
    public var TextFormat_Italic: String { return self._s[2027]! }
    public var WallpaperSearch_ColorPink: String { return self._s[2028]! }
    public var Settings_About_Help: String { return self._s[2029]! }
    public var SearchImages_Title: String { return self._s[2030]! }
    public var Weekday_Wednesday: String { return self._s[2031]! }
    public var Conversation_ClousStorageInfo_Description1: String { return self._s[2032]! }
    public var ExplicitContent_AlertTitle: String { return self._s[2033]! }
    public func Time_PreciseDate_m5(_ _1: String, _ _2: String, _ _3: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2034]!, self._r[2034]!, [_1, _2, _3])
    }
    public var Weekday_Thursday: String { return self._s[2035]! }
    public var Channel_BanUser_PermissionChangeGroupInfo: String { return self._s[2036]! }
    public var Channel_Members_AddMembersHelp: String { return self._s[2037]! }
    ...
    public var SettingsSearch_Synonyms_Notifications_InAppNotificationsVibrate: String { return self._s[2039]! }
    public var Passport_RequestedInformation: String { return self._s[2040]! }
    public var Login_PhoneAndCountryHelp: String { return self._s[2041]! }
    public var Conversation_EncryptionProcessing: String { return self._s[2043]! }
    public var Notifications_PermissionsSuppressWarningTitle: String { return self._s[2044]! }
    public var PhotoEditor_EnhanceTool: String { return self._s[2046]! }
    public var Channel_Setup_Title: String { return self._s[2047]! }
    public var Conversation_SearchPlaceholder: String { return self._s[2048]! }
    public var AccessDenied_LocationAlwaysDenied: String { return self._s[2049]! }
    public var Checkout_ErrorGeneric: String { return self._s[2050]! }
    public var Passport_Language_hu: String { return self._s[2051]! }
    ...
    public func PUSH_MESSAGE(_ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2056]!, self._r[2056]!, [_1])
    }
    public var Conversation_CloudStorageInfo_Title: String { return self._s[2057]! }
    public var PhotoEditor_CropAspectRatioSquare: String { return self._s[2058]! }
    ...
    public var Conversation_ClearPrivateHistory: String { return self._s[2060]! }
    public var ContactInfo_PhoneLabelHome: String { return self._s[2061]! }
    public var PrivacySettings_LastSeenContacts: String { return self._s[2062]! }
    ...
    public var Passport_Language_cs: String { return self._s[2064]! }
    public var Message_PinnedAnimationMessage: String { return self._s[2066]! }
    public var Passport_Identity_ReverseSideHelp: String { return self._s[2068]! }
    public var SettingsSearch_Synonyms_Data_Storage_Title: String { return self._s[2069]! }
    public var SettingsSearch_Synonyms_Privacy_PasscodeAndTouchId: String { return self._s[2071]! }
    public var Embed_PlayingInPIP: String { return self._s[2072]! }
    public var AutoNightTheme_ScheduleSection: String { return self._s[2073]! }
    ...
    public var MediaPicker_LivePhotoDescription: String { return self._s[2075]! }
    public func Channel_AdminLog_MessageRestrictedName(_ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2076]!, self._r[2076]!, [_1])
    }
    public var Notification_PaymentSent: String { return self._s[2077]! }
    public var PhotoEditor_CurvesGreen: String { return self._s[2078]! }
    public var SaveIncomingPhotosSettings_Title: String { return self._s[2079]! }
    public var NotificationSettings_ShowNotificationsAllAccounts: String { return self._s[2080]! }
    ...
    public func ApplyLanguage_UnsufficientDataText(_ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2085]!, self._r[2085]!, [_1])
    }
    public var NetworkUsageSettings_CallDataSection: String { return self._s[2087]! }
    public var PasscodeSettings_HelpTop: String { return self._s[2088]! }
    public var Passport_Address_TypeRentalAgreement: String { return self._s[2089]! }
    public var ReportPeer_ReasonOther_Placeholder: String { return self._s[2090]! }
    public var CheckoutInfo_ErrorPhoneInvalid: String { return self._s[2091]! }
    public var Call_Accept: String { return self._s[2093]! }
    public var GroupRemoved_RemoveInfo: String { return self._s[2094]! }
    public var Month_GenMarch: String { return self._s[2096]! }
    public var PhotoEditor_ShadowsTool: String { return self._s[2097]! }
    public var LoginPassword_Title: String { return self._s[2098]! }
    public var Call_End: String { return self._s[2099]! }
    public var Watch_Conversation_GroupInfo: String { return self._s[2100]! }
    public var CallSettings_Always: String { return self._s[2101]! }
    public var CallFeedback_Success: String { return self._s[2102]! }
    public var TwoStepAuth_SetupHint: String { return self._s[2103]! }
    public var ConversationProfile_UsersTooMuchError: String { return self._s[2104]! }
    public var Login_PhoneTitle: String { return self._s[2105]! }
    public var Passport_FieldPhoneHelp: String { return self._s[2106]! }
    public var Weekday_ShortSunday: String { return self._s[2107]! }
    public var Passport_InfoFAQ_URL: String { return self._s[2108]! }
    public var ContactInfo_Job: String { return self._s[2110]! }
    public var UserInfo_InviteBotToGroup: String { return self._s[2111]! }
    public var TwoStepAuth_PasswordRemovePassportConfirmation: String { return self._s[2112]! }
    public var SettingsSearch_Synonyms_Notifications_InAppNotificationsPreview: String { return self._s[2113]! }
    public var Passport_DeletePersonalDetailsConfirmation: String { return self._s[2114]! }
    public var CallFeedback_ReasonNoise: String { return self._s[2115]! }
    public var Passport_Identity_AddInternalPassport: String { return self._s[2117]! }
    public var MediaPicker_AddCaption: String { return self._s[2118]! }
    public var CallSettings_TabIconDescription: String { return self._s[2119]! }
    public var Privacy_GroupsAndChannels_AlwaysAllow: String { return self._s[2120]! }
    public var Passport_Identity_TypePersonalDetails: String { return self._s[2121]! }
    public var DialogList_SearchSectionRecent: String { return self._s[2122]! }
    public var PrivacyPolicy_DeclineMessage: String { return self._s[2123]! }
    public var LogoutOptions_ClearCacheText: String { return self._s[2126]! }
    public var LastSeen_WithinAWeek: String { return self._s[2127]! }
    public var ChannelMembers_GroupAdminsTitle: String { return self._s[2128]! }
    public var Conversation_CloudStorage_ChatStatus: String { return self._s[2130]! }
    public var Passport_Address_TypeResidentialAddress: String { return self._s[2131]! }
    public var Conversation_StatusLeftGroup: String { return self._s[2132]! }
    public var SocksProxySetup_ProxyDetailsTitle: String { return self._s[2133]! }
    public var SettingsSearch_Synonyms_Calls_Title: String { return self._s[2135]! }
    public var GroupPermission_AddSuccess: String { return self._s[2136]! }
    public var PhotoEditor_BlurToolRadial: String { return self._s[2138]! }
    public var Conversation_ContextMenuCopy: String { return self._s[2139]! }
    public var AccessDenied_CallMicrophone: String { return self._s[2140]! }
    public func Time_PreciseDate_m2(_ _1: String, _ _2: String, _ _3: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2141]!, self._r[2141]!, [_1, _2, _3])
    }
    public var Login_InvalidFirstNameError: String { return self._s[2142]! }
    public var Notifications_Badge_CountUnreadMessages_InfoOn: String { return self._s[2143]! }
    public var Checkout_PaymentMethod_New: String { return self._s[2144]! }
    public var ShareMenu_CopyShareLinkGame: String { return self._s[2145]! }
    public var PhotoEditor_QualityTool: String { return self._s[2146]! }
    public var Login_SendCodeViaSms: String { return self._s[2147]! }
    public var SettingsSearch_Synonyms_Privacy_DeleteAccountIfAwayFor: String { return self._s[2148]! }
    public var Login_EmailNotConfiguredError: String { return self._s[2149]! }
    public var SocksProxySetup_Status: String { return self._s[2150]! }
    public var PrivacyPolicy_Accept: String { return self._s[2151]! }
    public var Notifications_ExceptionsMessagePlaceholder: String { return self._s[2152]! }
    public func PUSH_CHAT_MESSAGE_TEXT(_ _1: String, _ _2: String, _ _3: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2153]!, self._r[2153]!, [_1, _2, _3])
    }
    public var InfoPlist_NSLocationAlwaysUsageDescription: String { return self._s[2154]! }
    public var AutoNightTheme_Automatic: String { return self._s[2155]! }
    public var Channel_Username_InvalidStartsWithNumber: String { return self._s[2156]! }
    public var Privacy_ContactsSyncHelp: String { return self._s[2157]! }
    public var Cache_Help: String { return self._s[2158]! }
    public var Passport_Language_fa: String { return self._s[2159]! }
    public var Login_ResetAccountProtected_TimerTitle: String { return self._s[2160]! }
    public var PrivacySettings_LastSeen: String { return self._s[2161]! }
    public func DialogList_MultipleTyping(_ _0: String, _ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2162]!, self._r[2162]!, [_0, _1])
    }
    public var Preview_SaveGif: String { return self._s[2166]! }
    public var SettingsSearch_Synonyms_Privacy_TwoStepAuth: String { return self._s[2167]! }
    public var Profile_About: String { return self._s[2168]! }
    public var Channel_About_Placeholder: String { return self._s[2169]! }
    public var Login_InfoTitle: String { return self._s[2170]! }
    ...
    public var Watch_Suggestion_CantTalk: String { return self._s[2173]! }
    public var ContactInfo_Title: String { return self._s[2174]! }
    public var Media_ShareThisVideo: String { return self._s[2175]! }
    public var Weekday_ShortFriday: String { return self._s[2176]! }
    public var AccessDenied_Contacts: String { return self._s[2177]! }
    public var Notification_CallIncomingShort: String { return self._s[2178]! }
    public var Group_Setup_TypePublic: String { return self._s[2179]! }
    public var Notifications_MessageNotificationsExceptions: String { return self._s[2180]! }
    public var Notifications_Badge_IncludeChannels: String { return self._s[2181]! }
    public var Notifications_MessageNotificationsPreview: String { return self._s[2184]! }
    public var ConversationProfile_ErrorCreatingConversation: String { return self._s[2185]! }
    public var Group_ErrorAddTooMuchBots: String { return self._s[2186]! }
    public var Privacy_GroupsAndChannels_CustomShareHelp: String { return self._s[2187]! }
    public var Permissions_CellularDataAllowInSettings_v0: String { return self._s[2188]! }
    public var DialogList_Typing: String { return self._s[2189]! }
    public var CallFeedback_IncludeLogs: String { return self._s[2191]! }
    public var Checkout_Phone: String { return self._s[2193]! }
    public var Login_InfoFirstNamePlaceholder: String { return self._s[2196]! }
    public var Privacy_Calls_Integration: String { return self._s[2197]! }
    public var Notifications_PermissionsAllow: String { return self._s[2198]! }
    public var TwoStepAuth_AddHintDescription: String { return self._s[2202]! }
    public var Settings_ChatSettings: String { return self._s[2203]! }
    ...
    public var GroupRemoved_DeleteUser: String { return self._s[2207]! }
    ...
    public func PUSH_MESSAGE_PHOTO(_ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2209]!, self._r[2209]!, [_1])
    }
    public var Login_ContinueWithLocalization: String { return self._s[2210]! }
    public var Watch_Message_ForwardedFrom: String { return self._s[2211]! }
    public var TwoStepAuth_EnterEmailCode: String { return self._s[2213]! }
    public var Conversation_Unblock: String { return self._s[2214]! }
    public var PrivacySettings_DataSettings: String { return self._s[2215]! }
    public var Notifications_InAppNotificationsVibrate: String { return self._s[2216]! }
    public func Privacy_GroupsAndChannels_InviteToChannelError(_ _0: String, _ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2217]!, self._r[2217]!, [_0, _1])
    }
    public var PrivacySettings_Passcode: String { return self._s[2220]! }
    public var Call_Mute: String { return self._s[2221]! }
    public var Passport_Language_dz: String { return self._s[2222]! }
    public var Passport_Language_tk: String { return self._s[2223]! }
    ...
    public var Settings_Search: String { return self._s[2225]! }
    public var InfoPlist_NSPhotoLibraryUsageDescription: String { return self._s[2226]! }
    public var Conversation_ContextMenuReply: String { return self._s[2227]! }
    public var WallpaperSearch_ColorBrown: String { return self._s[2228]! }
    public var Tour_Title1: String { return self._s[2229]! }
    public var Conversation_ClearGroupHistory: String { return self._s[2231]! }
    public var WallpaperPreview_Motion: String { return self._s[2232]! }
    public func Checkout_PasswordEntry_Text(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2233]!, self._r[2233]!, [_0])
    }
    public var Call_RateCall: String { return self._s[2234]! }
    public var Channel_AdminLog_BanSendStickersAndGifs: String { return self._s[2235]! }
    public var Passport_PasswordCompleteSetup: String { return self._s[2236]! }
    public var Conversation_InputTextSilentBroadcastPlaceholder: String { return self._s[2237]! }
    public var UserInfo_LastNamePlaceholder: String { return self._s[2239]! }
    public func Login_WillCallYou(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2241]!, self._r[2241]!, [_0])
    }
    public var Compose_Create: String { return self._s[2242]! }
    public var Contacts_InviteToTelegram: String { return self._s[2243]! }
    public var GroupInfo_Notifications: String { return self._s[2244]! }
    public var Message_PinnedLiveLocationMessage: String { return self._s[2246]! }
    public var Month_GenApril: String { return self._s[2247]! }
    public var Appearance_AutoNightTheme: String { return self._s[2248]! }
    public var ChatSettings_AutomaticAudioDownload: String { return self._s[2250]! }
    public var Login_CodeSentSms: String { return self._s[2252]! }
    public func UserInfo_UnblockConfirmation(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2253]!, self._r[2253]!, [_0])
    }
    public var EmptyGroupInfo_Line3: String { return self._s[2254]! }
    public var LogoutOptions_ContactSupportText: String { return self._s[2255]! }
    public var Passport_Language_hr: String { return self._s[2256]! }
    ...
    public var GroupInfo_InviteLink_CopyLink: String { return self._s[2258]! }
    public var Conversation_InputTextBroadcastPlaceholder: String { return self._s[2259]! }
    public var Privacy_SecretChatsTitle: String { return self._s[2260]! }
    public var Notification_SecretChatMessageScreenshotSelf: String { return self._s[2262]! }
    public var GroupInfo_AddUserLeftError: String { return self._s[2263]! }
    public var AutoDownloadSettings_TypePrivateChats: String { return self._s[2264]! }
    public var LogoutOptions_ContactSupportTitle: String { return self._s[2265]! }
    public var Preview_DeleteGif: String { return self._s[2266]! }
    public var GroupInfo_Permissions_Exceptions: String { return self._s[2267]! }
    public var Group_ErrorNotMutualContact: String { return self._s[2268]! }
    public var Notification_MessageLifetime5s: String { return self._s[2269]! }
    ...
    public var Passport_Address_AddBankStatement: String { return self._s[2272]! }
    public var Notification_CallIncoming: String { return self._s[2273]! }
    public var Compose_NewGroupTitle: String { return self._s[2274]! }
    public var TwoStepAuth_RecoveryCodeHelp: String { return self._s[2276]! }
    public var Passport_Address_Postcode: String { return self._s[2278]! }
    ...
    public var Checkout_NewCard_SaveInfoHelp: String { return self._s[2280]! }
    public var WallpaperColors_Title: String { return self._s[2281]! }
    public var SocksProxySetup_ShareQRCodeInfo: String { return self._s[2282]! }
    public var GroupPermission_Duration: String { return self._s[2283]! }
    public func Cache_Clear(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2284]!, self._r[2284]!, [_0])
    }
    public var Bot_GroupStatusDoesNotReadHistory: String { return self._s[2285]! }
    public var Username_Placeholder: String { return self._s[2286]! }
    public var CallFeedback_WhatWentWrong: String { return self._s[2287]! }
    public var Passport_FieldAddressUploadHelp: String { return self._s[2288]! }
    public var Permissions_NotificationsAllowInSettings_v0: String { return self._s[2289]! }
    public var Passport_PasswordDescription: String { return self._s[2291]! }
    public var Channel_MessagePhotoUpdated: String { return self._s[2292]! }
    public var MediaPicker_TapToUngroupDescription: String { return self._s[2293]! }
    public var SettingsSearch_Synonyms_Notifications_BadgeCountUnreadMessages: String { return self._s[2294]! }
    public var AttachmentMenu_PhotoOrVideo: String { return self._s[2295]! }
    public var Conversation_ContextMenuMore: String { return self._s[2296]! }
    public var Privacy_PaymentsClearInfo: String { return self._s[2297]! }
    public var CallSettings_TabIcon: String { return self._s[2298]! }
    public var KeyCommand_Find: String { return self._s[2299]! }
    public var Message_PinnedGame: String { return self._s[2300]! }
    public var Notifications_Badge_CountUnreadMessages_InfoOff: String { return self._s[2302]! }
    public var Login_CallRequestState2: String { return self._s[2304]! }
    public var CheckoutInfo_ReceiverInfoNamePlaceholder: String { return self._s[2306]! }
    public func Checkout_PayPrice(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2308]!, self._r[2308]!, [_0])
    }
    public var WallpaperPreview_Blurred: String { return self._s[2309]! }
    public var Conversation_InstantPagePreview: String { return self._s[2310]! }
    ...
    public var SecretTimer_VideoDescription: String { return self._s[2314]! }
    public var WallpaperSearch_ColorRed: String { return self._s[2315]! }
    public var GroupPermission_NoPinMessages: String { return self._s[2316]! }
    public var Passport_Language_es: String { return self._s[2317]! }
    public var Permissions_ContactsAllow_v0: String { return self._s[2319]! }
    public var Conversation_EditingMessageMediaEditCurrentVideo: String { return self._s[2320]! }
    ...
    public var Privacy_Forwards_CustomHelp: String { return self._s[2322]! }
    public var WebPreview_GettingLinkInfo: String { return self._s[2323]! }
    public var Watch_UserInfo_Unmute: String { return self._s[2324]! }
    public var GroupInfo_ChannelListNamePlaceholder: String { return self._s[2325]! }
    public var AccessDenied_CameraRestricted: String { return self._s[2327]! }
    ...
    public var ChatList_ReadAll: String { return self._s[2330]! }
    public var Settings_CopyUsername: String { return self._s[2331]! }
    public var Contacts_SearchLabel: String { return self._s[2332]! }
    public var Map_OpenInYandexNavigator: String { return self._s[2334]! }
    public var PasscodeSettings_EncryptData: String { return self._s[2335]! }
    public var WallpaperSearch_ColorPrefix: String { return self._s[2336]! }
    public var Notifications_GroupNotificationsPreview: String { return self._s[2337]! }
    public var DialogList_AdNoticeAlert: String { return self._s[2338]! }
    public var CheckoutInfo_ShippingInfoAddress1: String { return self._s[2340]! }
    public var CheckoutInfo_ShippingInfoAddress2: String { return self._s[2341]! }
    public var Localization_LanguageCustom: String { return self._s[2342]! }
    public var Passport_Identity_TypeDriversLicenseUploadScan: String { return self._s[2343]! }
    public var CallFeedback_Title: String { return self._s[2344]! }
    public var Passport_Address_OneOfTypePassportRegistration: String { return self._s[2347]! }
    public var Conversation_InfoGroup: String { return self._s[2348]! }
    public var Compose_NewMessage: String { return self._s[2349]! }
    public var FastTwoStepSetup_HintPlaceholder: String { return self._s[2350]! }
    public var ChatSettings_AutoDownloadVideoMessages: String { return self._s[2351]! }
    ...
    public var Channel_AdminLog_CanDeleteMessages: String { return self._s[2353]! }
    public var Login_CancelSignUpConfirmation: String { return self._s[2354]! }
    public var ChangePhoneNumberCode_Help: String { return self._s[2355]! }
    public var PrivacySettings_DeleteAccountHelp: String { return self._s[2356]! }
    public var Channel_BlackList_Title: String { return self._s[2357]! }
    public var UserInfo_PhoneCall: String { return self._s[2358]! }
    public var Passport_Address_OneOfTypeBankStatement: String { return self._s[2360]! }
    public var State_connecting: String { return self._s[2361]! }
    ...
    public var Notifications_GroupNotifications: String { return self._s[2363]! }
    public var Passport_Identity_EditPassport: String { return self._s[2364]! }
    public var EnterPasscode_RepeatNewPasscode: String { return self._s[2366]! }
    public var Localization_EnglishLanguageName: String { return self._s[2367]! }
    public var Share_AuthDescription: String { return self._s[2368]! }
    public var SettingsSearch_Synonyms_Notifications_ChannelNotificationsAlert: String { return self._s[2369]! }
    public var Passport_Identity_Surname: String { return self._s[2370]! }
    public var Compose_TokenListPlaceholder: String { return self._s[2371]! }
    public var Passport_Identity_OneOfTypePassport: String { return self._s[2372]! }
    public var Settings_AboutEmpty: String { return self._s[2373]! }
    public var Conversation_Unmute: String { return self._s[2374]! }
    ...
    public var Login_CodeSentCall: String { return self._s[2377]! }
    public var ContactInfo_PhoneLabelHomeFax: String { return self._s[2379]! }
    public var ChatSettings_Appearance: String { return self._s[2380]! }
    public var Appearance_PickAccentColor: String { return self._s[2381]! }
    ...
    public var Notification_CallMissed: String { return self._s[2384]! }
    public var SettingsSearch_Synonyms_Appearance_ChatBackground_Custom: String { return self._s[2385]! }
    public var Channel_AdminLogFilter_EventsInfo: String { return self._s[2386]! }
    public var ChatAdmins_AdminLabel: String { return self._s[2388]! }
    public var KeyCommand_JumpToNextChat: String { return self._s[2389]! }
    public var Conversation_StopPollConfirmationTitle: String { return self._s[2391]! }
    public var ChangePhoneNumberCode_CodePlaceholder: String { return self._s[2392]! }
    public var Month_GenJune: String { return self._s[2393]! }
    public var Watch_Location_Current: String { return self._s[2394]! }
    public var Conversation_TitleMute: String { return self._s[2395]! }
    ...
    public var Call_ReportPlaceholder: String { return self._s[2399]! }
    public var MaskStickerSettings_Info: String { return self._s[2400]! }
    ...
    public var Checkout_NewCard_PostcodeTitle: String { return self._s[2402]! }
    public var Passport_Address_RegionPlaceholder: String { return self._s[2404]! }
    public var Contacts_ShareTelegram: String { return self._s[2405]! }
    public var EnterPasscode_EnterNewPasscodeNew: String { return self._s[2406]! }
    public var Channel_ErrorAccessDenied: String { return self._s[2407]! }
    public var Stickers_GroupChooseStickerPack: String { return self._s[2409]! }
    public var Call_ConnectionErrorTitle: String { return self._s[2410]! }
    public var UserInfo_NotificationsEnable: String { return self._s[2411]! }
    public var Tour_Text4: String { return self._s[2414]! }
    public var WallpaperSearch_Recent: String { return self._s[2415]! }
    public var Profile_MessageLifetime2s: String { return self._s[2417]! }
    public var Notification_MessageLifetime2s: String { return self._s[2418]! }
    public func Time_PreciseDate_m10(_ _1: String, _ _2: String, _ _3: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2419]!, self._r[2419]!, [_1, _2, _3])
    }
    public var Cache_ClearCache: String { return self._s[2420]! }
    public var AutoNightTheme_UpdateLocation: String { return self._s[2421]! }
    public var Permissions_NotificationsUnreachableText_v0: String { return self._s[2422]! }
    ...
    public var Channel_AdminLog_EmptyFilterTitle: String { return self._s[2428]! }
    public var SocksProxySetup_TypeSocks: String { return self._s[2429]! }
    public var ChatList_UnarchiveAction: String { return self._s[2430]! }
    public var AutoNightTheme_Title: String { return self._s[2431]! }
    public var InstantPage_FeedbackButton: String { return self._s[2432]! }
    public var Passport_FieldAddress: String { return self._s[2433]! }
    public var Month_ShortMarch: String { return self._s[2434]! }
    ...
    public var SocksProxySetup_UsernamePlaceholder: String { return self._s[2436]! }
    public var Conversation_ShareInlineBotLocationConfirmation: String { return self._s[2437]! }
    public var Passport_FloodError: String { return self._s[2438]! }
    public var SecretGif_Title: String { return self._s[2439]! }
    public var NotificationSettings_ShowNotificationsAllAccountsInfoOn: String { return self._s[2440]! }
    public var Passport_Language_th: String { return self._s[2442]! }
    public var Passport_Address_Address: String { return self._s[2443]! }
    public var Login_InvalidLastNameError: String { return self._s[2444]! }
    public var Notifications_InAppNotificationsPreview: String { return self._s[2445]! }
    public var Notifications_PermissionsUnreachableTitle: String { return self._s[2446]! }
    public var SettingsSearch_FAQ: String { return self._s[2447]! }
    public var ShareMenu_Send: String { return self._s[2448]! }
    public var WallpaperSearch_ColorYellow: String { return self._s[2450]! }
    public var Month_GenNovember: String { return self._s[2452]! }
    public var SettingsSearch_Synonyms_Appearance_LargeEmoji: String { return self._s[2454]! }
    public var Checkout_Email: String { return self._s[2455]! }
    public var NotificationsSound_Tritone: String { return self._s[2456]! }
    public var StickerPacksSettings_ManagingHelp: String { return self._s[2458]! }
    public func PUSH_PINNED_ROUND(_ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2461]!, self._r[2461]!, [_1])
    }
    public var ChangePhoneNumberNumber_Help: String { return self._s[2462]! }
    public func Checkout_LiabilityAlert(_ _1: String, _ _2: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2463]!, self._r[2463]!, [_1, _1, _1, _2])
    }
    public var ChatList_UndoArchiveTitle: String { return self._s[2464]! }
    public var DialogList_You: String { return self._s[2465]! }
    public var MediaPicker_Send: String { return self._s[2468]! }
    public var SettingsSearch_Synonyms_Stickers_Title: String { return self._s[2469]! }
    public var Call_AudioRouteSpeaker: String { return self._s[2470]! }
    public var Watch_UserInfo_Title: String { return self._s[2471]! }
    public var Appearance_AccentColor: String { return self._s[2472]! }
    ...
    public var Permissions_ContactsAllowInSettings_v0: String { return self._s[2474]! }
    public func PUSH_CHANNEL_MESSAGE_GAME(_ _1: String, _ _2: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2475]!, self._r[2475]!, [_1, _2])
    }
    public var Conversation_ClousStorageInfo_Description2: String { return self._s[2476]! }
    public var WebSearch_RecentClearConfirmation: String { return self._s[2477]! }
    public var Notification_CallOutgoing: String { return self._s[2478]! }
    public var PrivacySettings_PasscodeAndFaceId: String { return self._s[2479]! }
    public var Call_RecordingDisabledMessage: String { return self._s[2480]! }
    public var Message_Game: String { return self._s[2481]! }
    public var Conversation_PressVolumeButtonForSound: String { return self._s[2482]! }
    public var PrivacyLastSeenSettings_CustomHelp: String { return self._s[2483]! }
    public var Channel_EditAdmin_PermissionAddAdmins: String { return self._s[2484]! }
    public var Date_DialogDateFormat: String { return self._s[2485]! }
    public var WallpaperColors_SetCustomColor: String { return self._s[2486]! }
    public var Notifications_InAppNotifications: String { return self._s[2487]! }
    ...
    public var NewContact_Title: String { return self._s[2490]! }
    ...
    public var Conversation_ViewContactDetails: String { return self._s[2492]! }
    ...
    public var Checkout_NewCard_CardholderNameTitle: String { return self._s[2495]! }
    public var Passport_Identity_ExpiryDateNone: String { return self._s[2496]! }
    public var PrivacySettings_Title: String { return self._s[2497]! }
    public var Conversation_SilentBroadcastTooltipOff: String { return self._s[2500]! }
    public var GroupRemoved_UsersSectionTitle: String { return self._s[2501]! }
    public var Contacts_PhoneNumber: String { return self._s[2502]! }
    public var Map_ShowPlaces: String { return self._s[2504]! }
    public var ChatAdmins_Title: String { return self._s[2505]! }
    public var InstantPage_Reference: String { return self._s[2507]! }
    public func PUSH_CHAT_MESSAGE_FWD(_ _1: String, _ _2: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2508]!, self._r[2508]!, [_1, _2])
    }
    public var Camera_FlashOff: String { return self._s[2509]! }
    public var Watch_UserInfo_Block: String { return self._s[2510]! }
    public var ChatSettings_Stickers: String { return self._s[2511]! }
    public var ChatSettings_DownloadInBackground: String { return self._s[2512]! }
    ...
    public var Settings_ViewPhoto: String { return self._s[2514]! }
    public var Login_CheckOtherSessionMessages: String { return self._s[2515]! }
    public var AutoDownloadSettings_Cellular: String { return self._s[2516]! }
    public var SettingsSearch_Synonyms_Notifications_GroupNotificationsExceptions: String { return self._s[2517]! }
    ...
    public var Privacy_DeleteDrafts: String { return self._s[2520]! }
    public var Wallpaper_SetCustomBackgroundInfo: String { return self._s[2521]! }
    public func LastSeen_AtDate(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2522]!, self._r[2522]!, [_0])
    }
    public var DialogList_SavedMessagesHelp: String { return self._s[2523]! }
    public var DialogList_SavedMessages: String { return self._s[2524]! }
    public var GroupInfo_UpgradeButton: String { return self._s[2525]! }
    public var DialogList_Pin: String { return self._s[2527]! }
    ...
    public var Notification_Exceptions_AlwaysOn: String { return self._s[2530]! }
    public var UserInfo_NotificationsDisable: String { return self._s[2531]! }
    public var Paint_Outlined: String { return self._s[2532]! }
    public var Activity_PlayingGame: String { return self._s[2533]! }
    public var SearchImages_NoImagesFound: String { return self._s[2534]! }
    public var SocksProxySetup_ProxyType: String { return self._s[2535]! }
    public var AppleWatch_ReplyPresetsHelp: String { return self._s[2537]! }
    public var Conversation_ContextMenuCancelSending: String { return self._s[2538]! }
    public var Settings_AppLanguage: String { return self._s[2539]! }
    public var TwoStepAuth_ResetAccountHelp: String { return self._s[2540]! }
    public var Common_ChoosePhoto: String { return self._s[2541]! }
    public var CallFeedback_ReasonEcho: String { return self._s[2542]! }
    public func PUSH_PINNED_AUDIO(_ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2543]!, self._r[2543]!, [_1])
    }
    public var Privacy_Calls_AlwaysAllow: String { return self._s[2544]! }
    public var Activity_UploadingVideo: String { return self._s[2545]! }
    public var ChannelInfo_DeleteChannelConfirmation: String { return self._s[2546]! }
    public var NetworkUsageSettings_Wifi: String { return self._s[2547]! }
    public var Channel_BanUser_PermissionReadMessages: String { return self._s[2548]! }
    public var Checkout_PayWithTouchId: String { return self._s[2549]! }
    public var Wallpaper_ResetWallpapersConfirmation: String { return self._s[2550]! }
    ...
    public var Notifications_ExceptionsNone: String { return self._s[2553]! }
    ...
    public var AuthSessions_IncompleteAttempts: String { return self._s[2557]! }
    public var Passport_Address_Region: String { return self._s[2560]! }
    public var ChatList_DeleteChat: String { return self._s[2561]! }
    public var LogoutOptions_ClearCacheTitle: String { return self._s[2562]! }
    public var PhotoEditor_TiltShift: String { return self._s[2563]! }
    public var Settings_FAQ_URL: String { return self._s[2564]! }
    public var Passport_Language_sl: String { return self._s[2565]! }
    public var Settings_PrivacySettings: String { return self._s[2567]! }
    public var SharedMedia_TitleLink: String { return self._s[2568]! }
    public var Passport_Identity_TypePassportUploadScan: String { return self._s[2569]! }
    public var Settings_SetProfilePhoto: String { return self._s[2570]! }
    public var Channel_About_Help: String { return self._s[2571]! }
    public var Contacts_PermissionsEnable: String { return self._s[2572]! }
    public var SettingsSearch_Synonyms_Notifications_GroupNotificationsAlert: String { return self._s[2573]! }
    public var AttachmentMenu_SendAsFiles: String { return self._s[2574]! }
    public var CallFeedback_ReasonInterruption: String { return self._s[2576]! }
    public var Passport_Address_AddTemporaryRegistration: String { return self._s[2577]! }
    public var AutoDownloadSettings_AutodownloadVideos: String { return self._s[2578]! }
    public var ChatSettings_AutoDownloadSettings_Delimeter: String { return self._s[2579]! }
    public var PrivacySettings_DeleteAccountTitle: String { return self._s[2580]! }
    public var AccessDenied_VideoMessageCamera: String { return self._s[2582]! }
    public var Map_OpenInYandexMaps: String { return self._s[2584]! }
    public var PhotoEditor_SaturationTool: String { return self._s[2585]! }
    ...
    public var Notification_Exceptions_NewException_NotificationHeader: String { return self._s[2587]! }
    public var Appearance_TextSize: String { return self._s[2588]! }
    ...
    public var Channel_Username_InvalidTooShort: String { return self._s[2591]! }
    public func PUSH_CHAT_MESSAGE_GAME(_ _1: String, _ _2: String, _ _3: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2592]!, self._r[2592]!, [_1, _2, _3])
    }
    public var Passport_PassportInformation: String { return self._s[2595]! }
    public var WatchRemote_AlertTitle: String { return self._s[2596]! }
    public var Privacy_GroupsAndChannels_NeverAllow: String { return self._s[2597]! }
    public var ConvertToSupergroup_HelpText: String { return self._s[2599]! }
    ...
    public func PUSH_PHONE_CALL_REQUEST(_ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2601]!, self._r[2601]!, [_1])
    }
    public var Privacy_GroupsAndChannels_CustomHelp: String { return self._s[2602]! }
    public var TwoStepAuth_RecoveryCodeInvalid: String { return self._s[2604]! }
    public var AccessDenied_CameraDisabled: String { return self._s[2605]! }
    ...
    public var PhotoEditor_ContrastTool: String { return self._s[2609]! }
    public func PUSH_PINNED_DOC(_ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2610]!, self._r[2610]!, [_1])
    }
    public var DialogList_Draft: String { return self._s[2611]! }
    public var Privacy_TopPeersDelete: String { return self._s[2613]! }
    public var LoginPassword_PasswordPlaceholder: String { return self._s[2614]! }
    public var Passport_Identity_TypeIdentityCardUploadScan: String { return self._s[2615]! }
    public var WebSearch_RecentSectionClear: String { return self._s[2616]! }
    public var Watch_ChatList_NoConversationsTitle: String { return self._s[2618]! }
    public var Common_Done: String { return self._s[2620]! }
    public var AuthSessions_EmptyText: String { return self._s[2621]! }
    public var Conversation_ShareBotContactConfirmation: String { return self._s[2622]! }
    public var Tour_Title5: String { return self._s[2623]! }
    ...
    public var ApplyLanguage_UnsufficientDataTitle: String { return self._s[2625]! }
    public var Conversation_LinkDialogSave: String { return self._s[2626]! }
    public var GroupInfo_ActionRestrict: String { return self._s[2627]! }
    public var Checkout_Title: String { return self._s[2628]! }
    public var Channel_AdminLog_CanChangeInfo: String { return self._s[2631]! }
    public var Notification_RenamedGroup: String { return self._s[2632]! }
    public var Checkout_PayWithFaceId: String { return self._s[2633]! }
    public var Channel_BanList_BlockedTitle: String { return self._s[2634]! }
    public var SettingsSearch_Synonyms_Notifications_InAppNotificationsSound: String { return self._s[2636]! }
    public var Checkout_WebConfirmation_Title: String { return self._s[2637]! }
    public var Notifications_MessageNotificationsAlert: String { return self._s[2638]! }
    public var Profile_AddToExisting: String { return self._s[2640]! }
    public func Profile_CreateEncryptedChatOutdatedError(_ _0: String, _ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2641]!, self._r[2641]!, [_0, _1])
    }
    public var Cache_Files: String { return self._s[2643]! }
    public var Permissions_PrivacyPolicy: String { return self._s[2644]! }
    public var SocksProxySetup_ConnectAndSave: String { return self._s[2645]! }
    public var UserInfo_NotificationsDefaultDisabled: String { return self._s[2646]! }
    public var AutoDownloadSettings_TypeContacts: String { return self._s[2648]! }
    public var Calls_NoCallsPlaceholder: String { return self._s[2650]! }
    public var Channel_Username_RevokeExistingUsernamesInfo: String { return self._s[2651]! }
    public var Notifications_ExceptionsGroupPlaceholder: String { return self._s[2653]! }
    public func PUSH_CHAT_MESSAGE_INVOICE(_ _1: String, _ _2: String, _ _3: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2654]!, self._r[2654]!, [_1, _2, _3])
    }
    public var SettingsSearch_Synonyms_Notifications_GroupNotificationsSound: String { return self._s[2655]! }
    public var Passport_FieldAddressHelp: String { return self._s[2656]! }
    public var Privacy_GroupsAndChannels_InviteToChannelMultipleError: String { return self._s[2657]! }
    ...
    public var Channel_AdminLog_EmptyTitle: String { return self._s[2659]! }
    public var Privacy_Calls_NeverAllow_Title: String { return self._s[2661]! }
    public var Login_UnknownError: String { return self._s[2662]! }
    public var Group_UpgradeNoticeText2: String { return self._s[2664]! }
    public var Watch_Compose_AddContact: String { return self._s[2665]! }
    public var Web_Error: String { return self._s[2666]! }
    public var Gif_Search: String { return self._s[2667]! }
    public var Profile_MessageLifetime1h: String { return self._s[2668]! }
    public var CheckoutInfo_ReceiverInfoEmailPlaceholder: String { return self._s[2669]! }
    public var Channel_Username_CheckingUsername: String { return self._s[2670]! }
    public var CallFeedback_ReasonSilentRemote: String { return self._s[2671]! }
    public var AutoDownloadSettings_TypeChannels: String { return self._s[2672]! }
    public var Channel_AboutItem: String { return self._s[2673]! }
    public var Privacy_GroupsAndChannels_AlwaysAllow_Placeholder: String { return self._s[2675]! }
    public var GroupInfo_SharedMedia: String { return self._s[2676]! }
    public func Channel_AdminLog_MessagePromotedName(_ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2677]!, self._r[2677]!, [_1])
    }
    public var Call_PhoneCallInProgressMessage: String { return self._s[2678]! }
    public func PUSH_CHANNEL_ALBUM(_ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2679]!, self._r[2679]!, [_1])
    }
    public var GroupInfo_InviteLink_RevokeAlert_Text: String { return self._s[2680]! }
    public var Conversation_SearchByName_Placeholder: String { return self._s[2681]! }
    public var CreatePoll_AddOption: String { return self._s[2682]! }
    public var GroupInfo_Permissions_SearchPlaceholder: String { return self._s[2683]! }
    public var Group_UpgradeNoticeHeader: String { return self._s[2684]! }
    public var Channel_Management_AddModerator: String { return self._s[2685]! }
    public var AutoDownloadSettings_MaxFileSize: String { return self._s[2686]! }
    public var StickerPacksSettings_ShowStickersButton: String { return self._s[2687]! }
    public var NotificationsSound_Hello: String { return self._s[2688]! }
    public var SocksProxySetup_SavedProxies: String { return self._s[2689]! }
    public var Channel_Stickers_Placeholder: String { return self._s[2691]! }
    ...
    public var PrivacyPolicy_DeclineDeclineAndDelete: String { return self._s[2693]! }
    public var Channel_Management_AddModeratorHelp: String { return self._s[2694]! }
    public var ContactInfo_BirthdayLabel: String { return self._s[2695]! }
    public var ChangePhoneNumberCode_RequestingACall: String { return self._s[2696]! }
    public var AutoDownloadSettings_Channels: String { return self._s[2697]! }
    public var Passport_Language_mn: String { return self._s[2698]! }
    public var Notifications_ResetAllNotificationsHelp: String { return self._s[2701]! }
    public var Passport_Language_ja: String { return self._s[2703]! }
    public var Settings_About_Title: String { return self._s[2704]! }
    public var Settings_NotificationsAndSounds: String { return self._s[2705]! }
    public var ChannelInfo_DeleteGroup: String { return self._s[2706]! }
    public var Settings_BlockedUsers: String { return self._s[2707]! }
    ...
    public var AutoDownloadSettings_PreloadVideo: String { return self._s[2709]! }
    public var Passport_Address_AddResidentialAddress: String { return self._s[2710]! }
    public var Channel_Username_Title: String { return self._s[2711]! }
    ...
    public var AttachmentMenu_File: String { return self._s[2714]! }
    public var AppleWatch_Title: String { return self._s[2715]! }
    public var Activity_RecordingVideoMessage: String { return self._s[2716]! }
    public var Weekday_Saturday: String { return self._s[2717]! }
    public var WallpaperPreview_SwipeColorsTopText: String { return self._s[2718]! }
    public var Profile_CreateEncryptedChatError: String { return self._s[2719]! }
    public var Common_Next: String { return self._s[2721]! }
    public var Channel_Stickers_YourStickers: String { return self._s[2723]! }
    public var Call_AudioRouteHeadphones: String { return self._s[2724]! }
    public var TwoStepAuth_EnterPasswordForgot: String { return self._s[2726]! }
    public var Watch_Contacts_NoResults: String { return self._s[2728]! }
    public var PhotoEditor_TintTool: String { return self._s[2731]! }
    public var LoginPassword_ResetAccount: String { return self._s[2733]! }
    public var Settings_SavedMessages: String { return self._s[2734]! }
    public var SettingsSearch_Synonyms_Appearance_Animations: String { return self._s[2735]! }
    public var Bot_GenericSupportStatus: String { return self._s[2736]! }
    public var StickerPack_Add: String { return self._s[2737]! }
    public var Checkout_TotalAmount: String { return self._s[2738]! }
    public var Your_cards_number_is_invalid: String { return self._s[2739]! }
    public var SettingsSearch_Synonyms_Appearance_AutoNightTheme: String { return self._s[2740]! }
    ...
    public var ChatSettings_ConnectionType_UseSocks5: String { return self._s[2743]! }
    ...
    public var GroupInfo_InviteLink_ShareLink: String { return self._s[2747]! }
    public var StickerPack_Share: String { return self._s[2748]! }
    public var Passport_DeleteAddress: String { return self._s[2749]! }
    public var Settings_Passport: String { return self._s[2750]! }
    public var SharedMedia_EmptyFilesText: String { return self._s[2751]! }
    public var Conversation_DeleteMessagesForMe: String { return self._s[2752]! }
    public var PasscodeSettings_AutoLock_IfAwayFor_1hour: String { return self._s[2753]! }
    public var Contacts_PermissionsText: String { return self._s[2754]! }
    public var Group_Setup_HistoryVisible: String { return self._s[2755]! }
    public var Passport_Address_AddRentalAgreement: String { return self._s[2757]! }
    public var SocksProxySetup_Title: String { return self._s[2758]! }
    public var Notification_Mute1h: String { return self._s[2759]! }
    ...
    public var NotificationSettings_ShowNotificationsAllAccountsInfoOff: String { return self._s[2761]! }
    public func PUSH_PINNED_GEOLIVE(_ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2762]!, self._r[2762]!, [_1])
    }
    public var FastTwoStepSetup_PasswordSection: String { return self._s[2763]! }
    public var NetworkUsageSettings_ResetStatsConfirmation: String { return self._s[2766]! }
    public var InfoPlist_NSFaceIDUsageDescription: String { return self._s[2768]! }
    public var DialogList_NoMessagesText: String { return self._s[2769]! }
    public var Privacy_ContactsResetConfirmation: String { return self._s[2770]! }
    public var Privacy_Calls_P2PHelp: String { return self._s[2771]! }
    public var Your_cards_expiration_year_is_invalid: String { return self._s[2773]! }
    public var Common_TakePhotoOrVideo: String { return self._s[2774]! }
    public var Call_StatusBusy: String { return self._s[2775]! }
    public var Conversation_PinnedMessage: String { return self._s[2776]! }
    public var AutoDownloadSettings_VoiceMessagesTitle: String { return self._s[2777]! }
    public var TwoStepAuth_SetupPasswordConfirmFailed: String { return self._s[2778]! }
    public var Undo_ChatCleared: String { return self._s[2779]! }
    public var AppleWatch_ReplyPresets: String { return self._s[2780]! }
    public var Passport_DiscardMessageDescription: String { return self._s[2782]! }
    public var Login_NetworkError: String { return self._s[2783]! }
    ...
    public var SocksProxySetup_PasswordPlaceholder: String { return self._s[2786]! }
    public var Login_ResetAccountProtected_LimitExceeded: String { return self._s[2788]! }
    ...
    public var Call_ConnectionErrorMessage: String { return self._s[2791]! }
    public var SettingsSearch_Synonyms_Notifications_MessageNotificationsSound: String { return self._s[2792]! }
    public var Compose_GroupTokenListPlaceholder: String { return self._s[2794]! }
    public var ConversationMedia_Title: String { return self._s[2795]! }
    public var EncryptionKey_Title: String { return self._s[2797]! }
    public var TwoStepAuth_EnterPasswordTitle: String { return self._s[2798]! }
    public var Notification_Exceptions_AddException: String { return self._s[2799]! }
    public var Profile_MessageLifetime1m: String { return self._s[2800]! }
    public func Channel_AdminLog_MessageUnkickedName(_ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2801]!, self._r[2801]!, [_1])
    }
    public var Month_GenMay: String { return self._s[2802]! }
    ...
    public var ChannelMembers_WhoCanAddMembersAllHelp: String { return self._s[2804]! }
    public var AutoDownloadSettings_ResetSettings: String { return self._s[2805]! }
    public var Conversation_EmptyPlaceholder: String { return self._s[2807]! }
    public var Passport_Address_AddPassportRegistration: String { return self._s[2808]! }
    public var Notifications_ChannelNotificationsAlert: String { return self._s[2809]! }
    public var ChatSettings_AutoDownloadUsingCellular: String { return self._s[2810]! }
    public var Camera_TapAndHoldForVideo: String { return self._s[2811]! }
    public var Channel_JoinChannel: String { return self._s[2813]! }
    public var Appearance_Animations: String { return self._s[2816]! }
    public func Notification_MessageLifetimeChanged(_ _1: String, _ _2: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2817]!, self._r[2817]!, [_1, _2])
    }
    public var Stickers_GroupStickers: String { return self._s[2819]! }
    public var ConvertToSupergroup_HelpTitle: String { return self._s[2821]! }
    public var Passport_Address_Street: String { return self._s[2822]! }
    public var Conversation_AddContact: String { return self._s[2823]! }
    public var Login_PhonePlaceholder: String { return self._s[2824]! }
    public var Channel_Members_InviteLink: String { return self._s[2826]! }
    public var Bot_Stop: String { return self._s[2827]! }
    public var SettingsSearch_Synonyms_Proxy_UseForCalls: String { return self._s[2829]! }
    public var Notification_PassportValueAddress: String { return self._s[2830]! }
    public var Month_ShortJuly: String { return self._s[2831]! }
    public var Passport_Address_TypeTemporaryRegistrationUploadScan: String { return self._s[2832]! }
    public var Channel_AdminLog_BanSendMedia: String { return self._s[2833]! }
    public var Passport_Identity_ReverseSide: String { return self._s[2834]! }
    public var Watch_Stickers_Recents: String { return self._s[2837]! }
    public var PrivacyLastSeenSettings_EmpryUsersPlaceholder: String { return self._s[2839]! }
    public var Map_SendThisLocation: String { return self._s[2840]! }
    ...
    public var ConvertToSupergroup_Note: String { return self._s[2843]! }
    public func FileSize_MB(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2844]!, self._r[2844]!, [_0])
    }
    public var NetworkUsageSettings_GeneralDataSection: String { return self._s[2845]! }
    public func Compatibility_SecretMediaVersionTooLow(_ _0: String, _ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2846]!, self._r[2846]!, [_0, _1])
    }
    public var Login_CallRequestState3: String { return self._s[2848]! }
    public var Wallpaper_SearchShort: String { return self._s[2849]! }
    public var SettingsSearch_Synonyms_Appearance_ColorTheme: String { return self._s[2851]! }
    public var PasscodeSettings_UnlockWithFaceId: String { return self._s[2852]! }
    ...
    public var Channel_AdminLogFilter_Title: String { return self._s[2854]! }
    public var Notifications_GroupNotificationsExceptions: String { return self._s[2858]! }
    public func FileSize_B(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2859]!, self._r[2859]!, [_0])
    }
    public var Passport_CorrectErrors: String { return self._s[2860]! }
    ...
    public var Map_SendMyCurrentLocation: String { return self._s[2862]! }
    public func PUSH_PINNED_CONTACT(_ _1: String, _ _2: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2863]!, self._r[2863]!, [_1, _2])
    }
    public var SharedMedia_SearchNoResults: String { return self._s[2864]! }
    public var Permissions_NotificationsText_v0: String { return self._s[2865]! }
    public var LoginPassword_FloodError: String { return self._s[2866]! }
    public var Group_Setup_HistoryHiddenHelp: String { return self._s[2868]! }
    ...
    public var Passport_Language_bn: String { return self._s[2870]! }
    public func DialogList_SingleUploadingPhotoSuffix(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2871]!, self._r[2871]!, [_0])
    }
    ...
    public var GroupInfo_InvitationLinkGroupFull: String { return self._s[2876]! }
    public var Group_EditAdmin_PermissionChangeInfo: String { return self._s[2878]! }
    public var Contacts_PermissionsAllow: String { return self._s[2879]! }
    public var ReportPeer_ReasonCopyright: String { return self._s[2880]! }
    public var Channel_EditAdmin_PermissinAddAdminOn: String { return self._s[2881]! }
    public var WallpaperPreview_Pattern: String { return self._s[2882]! }
    public var Paint_Duplicate: String { return self._s[2883]! }
    public var Passport_Address_Country: String { return self._s[2884]! }
    public var Notification_RenamedChannel: String { return self._s[2886]! }
    public var CheckoutInfo_ErrorPostcodeInvalid: String { return self._s[2887]! }
    public var Group_MessagePhotoUpdated: String { return self._s[2888]! }
    public var Channel_BanUser_PermissionSendMedia: String { return self._s[2889]! }
    public var Conversation_ContextMenuBan: String { return self._s[2890]! }
    public var TwoStepAuth_EmailSent: String { return self._s[2891]! }
    public var MessagePoll_NoVotes: String { return self._s[2892]! }
    public var Passport_Language_is: String { return self._s[2893]! }
    public var Tour_Text5: String { return self._s[2895]! }
    ...
    public var Undo_SecretChatDeleted: String { return self._s[2898]! }
    public var SocksProxySetup_ShareQRCode: String { return self._s[2899]! }
    public var LogoutOptions_ChangePhoneNumberText: String { return self._s[2900]! }
    public var Paint_Edit: String { return self._s[2902]! }
    public var Undo_DeletedGroup: String { return self._s[2905]! }
    public var LoginPassword_ForgotPassword: String { return self._s[2906]! }
    public var GroupInfo_GroupNamePlaceholder: String { return self._s[2907]! }
    public func Notification_Kicked(_ _0: String, _ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2908]!, self._r[2908]!, [_0, _1])
    }
    public var Conversation_InputTextCaptionPlaceholder: String { return self._s[2909]! }
    public var AutoDownloadSettings_VideoMessagesTitle: String { return self._s[2910]! }
    public var Passport_Language_uz: String { return self._s[2911]! }
    public var Conversation_PinMessageAlertGroup: String { return self._s[2912]! }
    public var SettingsSearch_Synonyms_Privacy_GroupsAndChannels: String { return self._s[2913]! }
    public var Map_StopLiveLocation: String { return self._s[2915]! }
    public var PasscodeSettings_Help: String { return self._s[2917]! }
    public var NotificationsSound_Input: String { return self._s[2918]! }
    public var Share_Title: String { return self._s[2921]! }
    public var LogoutOptions_Title: String { return self._s[2922]! }
    public var Login_TermsOfServiceAgree: String { return self._s[2923]! }
    public var Compose_NewEncryptedChatTitle: String { return self._s[2924]! }
    public var Channel_AdminLog_TitleSelectedEvents: String { return self._s[2925]! }
    public var Channel_EditAdmin_PermissionEditMessages: String { return self._s[2926]! }
    public var EnterPasscode_EnterTitle: String { return self._s[2927]! }
    ...
    public var Settings_CopyPhoneNumber: String { return self._s[2929]! }
    public var NotificationsSound_Keys: String { return self._s[2930]! }
    ...
    public var Notification_MessageLifetime1w: String { return self._s[2932]! }
    public var Message_Video: String { return self._s[2933]! }
    public var AutoDownloadSettings_CellularTitle: String { return self._s[2934]! }
    public func PUSH_CHANNEL_MESSAGE_PHOTO(_ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2935]!, self._r[2935]!, [_1])
    }
    ...
    public var Passport_Language_mk: String { return self._s[2940]! }
    public var CreatePoll_CancelConfirmation: String { return self._s[2941]! }
    public var Conversation_SilentBroadcastTooltipOn: String { return self._s[2943]! }
    public var PrivacyPolicy_Decline: String { return self._s[2944]! }
    public var Passport_Identity_DoesNotExpire: String { return self._s[2945]! }
    public var Channel_AdminLogFilter_EventsRestrictions: String { return self._s[2946]! }
    public var Permissions_SiriAllow_v0: String { return self._s[2948]! }
    ...
    public var Paint_Regular: String { return self._s[2951]! }
    public var ChatSettings_AutoDownloadReset: String { return self._s[2952]! }
    public var SocksProxySetup_ShareLink: String { return self._s[2953]! }
    public var BlockedUsers_SelectUserTitle: String { return self._s[2954]! }
    public var GroupInfo_InviteByLink: String { return self._s[2956]! }
    public var MessageTimer_Custom: String { return self._s[2957]! }
    public var UserInfo_NotificationsDefaultEnabled: String { return self._s[2958]! }
    public var Passport_Address_TypeTemporaryRegistration: String { return self._s[2960]! }
    public var ChatSettings_AutoDownloadUsingWiFi: String { return self._s[2961]! }
    public var Channel_Username_InvalidTaken: String { return self._s[2962]! }
    public var Conversation_ClousStorageInfo_Description3: String { return self._s[2963]! }
    public var Settings_ChatBackground: String { return self._s[2964]! }
    public var Channel_Subscribers_Title: String { return self._s[2965]! }
    public var ApplyLanguage_ChangeLanguageTitle: String { return self._s[2966]! }
    public var Watch_ConnectionDescription: String { return self._s[2967]! }
    public var ChatList_ArchivedChatsTitle: String { return self._s[2971]! }
    public var Wallpaper_ResetWallpapers: String { return self._s[2972]! }
    public var EditProfile_Title: String { return self._s[2973]! }
    public var NotificationsSound_Bamboo: String { return self._s[2975]! }
    public var Channel_AdminLog_MessagePreviousMessage: String { return self._s[2977]! }
    public var Login_SmsRequestState2: String { return self._s[2978]! }
    public var Passport_Language_ar: String { return self._s[2979]! }
    public var SettingsSearch_Synonyms_EditProfile_Title: String { return self._s[2980]! }
    public var Conversation_MessageDialogEdit: String { return self._s[2981]! }
    public func PUSH_AUTH_UNKNOWN(_ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2982]!, self._r[2982]!, [_1])
    }
    public var Common_Close: String { return self._s[2983]! }
    public var SettingsSearch_Synonyms_Notifications_GroupNotificationsPreview: String { return self._s[2984]! }
    ...
    public var UserInfo_About_Placeholder: String { return self._s[2989]! }
    ...
    public var GroupInfo_Permissions_SectionTitle: String { return self._s[2991]! }
    public var Channel_Info_Banned: String { return self._s[2993]! }
    ...
    public var Appearance_Other: String { return self._s[2995]! }
    public var Passport_Language_my: String { return self._s[2996]! }
    public var Group_Setup_BasicHistoryHiddenHelp: String { return self._s[2997]! }
    ...
    public var SettingsSearch_Synonyms_Privacy_PasscodeAndFaceId: String { return self._s[2999]! }
    public var Preview_CopyAddress: String { return self._s[3000]! }
    ...
    public var KeyCommand_JumpToPreviousChat: String { return self._s[3002]! }
    public var UserInfo_BotSettings: String { return self._s[3003]! }
    public var LiveLocation_MenuStopAll: String { return self._s[3005]! }
    public var Passport_PasswordCreate: String { return self._s[3006]! }
    public var StickerSettings_MaskContextInfo: String { return self._s[3007]! }
    public var Message_PinnedLocationMessage: String { return self._s[3008]! }
    public var Map_Satellite: String { return self._s[3009]! }
    public var Watch_Message_Unsupported: String { return self._s[3010]! }
    public var Username_TooManyPublicUsernamesError: String { return self._s[3011]! }
    public var TwoStepAuth_EnterPasswordInvalid: String { return self._s[3012]! }
    ...
    public var Notifications_ChannelNotificationsHelp: String { return self._s[3014]! }
    public var Privacy_Calls_P2PContacts: String { return self._s[3015]! }
    public var NotificationsSound_None: String { return self._s[3016]! }
    public var AccessDenied_VoiceMicrophone: String { return self._s[3018]! }
    ...
    public var Cache_Indexing: String { return self._s[3020]! }
    public var DialogList_RecentTitlePeople: String { return self._s[3022]! }
    public var DialogList_EncryptionRejected: String { return self._s[3023]! }
    public var GroupInfo_Administrators: String { return self._s[3024]! }
    public var Passport_ScanPassportHelp: String { return self._s[3025]! }
    public var Application_Name: String { return self._s[3026]! }
    public var Channel_AdminLogFilter_ChannelEventsInfo: String { return self._s[3027]! }
    public var Passport_Identity_TranslationHelp: String { return self._s[3029]! }
    ...
    public var Channel_EditAdmin_PermissionDeleteMessages: String { return self._s[3032]! }
    public var Privacy_ChatsTitle: String { return self._s[3033]! }
    public var DialogList_ClearHistoryConfirmation: String { return self._s[3034]! }
    public var SettingsSearch_Synonyms_Data_Storage_ClearCache: String { return self._s[3035]! }
    public var Watch_Suggestion_HoldOn: String { return self._s[3036]! }
    public var SocksProxySetup_RequiredCredentials: String { return self._s[3037]! }
    public var Passport_Address_TypeRentalAgreementUploadScan: String { return self._s[3038]! }
    public var TwoStepAuth_EmailSkipAlert: String { return self._s[3039]! }
    public var Channel_Setup_TypePublic: String { return self._s[3042]! }
    ...
    public var Channel_TypeSetup_Title: String { return self._s[3045]! }
    public var Map_OpenInMaps: String { return self._s[3047]! }
    public func PUSH_PINNED_NOTEXT(_ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[3048]!, self._r[3048]!, [_1])
    }
    public var NotificationsSound_Tremolo: String { return self._s[3050]! }
    ...
    public var ConversationProfile_UnknownAddMemberError: String { return self._s[3052]! }
    public var Passport_PasswordHelp: String { return self._s[3053]! }
    public var Login_CodeExpiredError: String { return self._s[3054]! }
    public var Channel_EditAdmin_PermissionChangeInfo: String { return self._s[3055]! }
    public var Conversation_TitleUnmute: String { return self._s[3056]! }
    public var Passport_Identity_ScansHelp: String { return self._s[3057]! }
    public var Passport_Language_lo: String { return self._s[3058]! }
    public var Camera_FlashAuto: String { return self._s[3059]! }
    public var Common_Cancel: String { return self._s[3060]! }
    public var DialogList_SavedMessagesTooltip: String { return self._s[3061]! }
    public var TwoStepAuth_SetupPasswordTitle: String { return self._s[3062]! }
    public func PUSH_MESSAGE_FWD(_ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[3063]!, self._r[3063]!, [_1])
    }
    public var Conversation_ReportSpamConfirmation: String { return self._s[3064]! }
    public var ChatSettings_Title: String { return self._s[3066]! }
    public var Passport_PasswordReset: String { return self._s[3067]! }
    public var SocksProxySetup_TypeNone: String { return self._s[3068]! }
    public var PhoneNumberHelp_Help: String { return self._s[3070]! }
    public var Checkout_EnterPassword: String { return self._s[3071]! }
    public var Share_AuthTitle: String { return self._s[3073]! }
    public var Activity_UploadingDocument: String { return self._s[3074]! }
    public var State_Connecting: String { return self._s[3075]! }
    public var Profile_MessageLifetime1w: String { return self._s[3076]! }
    public var Conversation_ContextMenuReport: String { return self._s[3077]! }
    public var CheckoutInfo_ReceiverInfoPhone: String { return self._s[3078]! }
    public var AutoNightTheme_ScheduledTo: String { return self._s[3079]! }
    public var AuthSessions_Terminate: String { return self._s[3080]! }
    public var Checkout_NewCard_CardholderNamePlaceholder: String { return self._s[3081]! }
    public var KeyCommand_JumpToPreviousUnreadChat: String { return self._s[3082]! }
    public var PhotoEditor_Set: String { return self._s[3083]! }
    public var EmptyGroupInfo_Title: String { return self._s[3084]! }
    public var Login_PadPhoneHelp: String { return self._s[3085]! }
    public var AutoDownloadSettings_TypeGroupChats: String { return self._s[3087]! }
    public var PrivacyPolicy_DeclineLastWarning: String { return self._s[3089]! }
    public var NotificationsSound_Complete: String { return self._s[3090]! }
    public var SettingsSearch_Synonyms_Privacy_Data_Title: String { return self._s[3091]! }
    public var Group_Info_AdminLog: String { return self._s[3092]! }
    public var GroupPermission_NotAvailableInPublicGroups: String { return self._s[3093]! }
    public var Channel_AdminLog_InfoPanelAlertText: String { return self._s[3094]! }
    public var Conversation_Admin: String { return self._s[3096]! }
    public var Conversation_GifTooltip: String { return self._s[3097]! }
    public var Passport_NotLoggedInMessage: String { return self._s[3098]! }
    ...
    public var Profile_MessageLifetimeForever: String { return self._s[3100]! }
    public var SharedMedia_EmptyTitle: String { return self._s[3102]! }
    public var Channel_Edit_PrivatePublicLinkAlert: String { return self._s[3104]! }
    public var Username_Help: String { return self._s[3105]! }
    public var DialogList_LanguageTooltip: String { return self._s[3107]! }
    public var Map_LoadError: String { return self._s[3108]! }
    public var Login_PhoneNumberAlreadyAuthorized: String { return self._s[3109]! }
    public var Channel_AdminLog_AddMembers: String { return self._s[3110]! }
    public var Notification_Exceptions_NewException: String { return self._s[3111]! }
    public var TwoStepAuth_EmailTitle: String { return self._s[3112]! }
    public var WatchRemote_AlertText: String { return self._s[3113]! }
    public var ChatSettings_ConnectionType_Title: String { return self._s[3116]! }
    ...
    public var SettingsSearch_Synonyms_Calls_CallTab: String { return self._s[3118]! }
    public var Passport_Address_CountryPlaceholder: String { return self._s[3119]! }
    ...
    public var Group_AdminLog_EmptyText: String { return self._s[3122]! }
    public var SettingsSearch_Synonyms_Appearance_Title: String { return self._s[3123]! }
    public var AccessDenied_VideoMicrophone: String { return self._s[3125]! }
    public var Conversation_ContextMenuStickerPackAdd: String { return self._s[3126]! }
    public var Cache_ClearNone: String { return self._s[3127]! }
    public var SocksProxySetup_FailedToConnect: String { return self._s[3128]! }
    public var Permissions_NotificationsTitle_v0: String { return self._s[3129]! }
    ...
    public var Passport_Identity_Country: String { return self._s[3131]! }
    ...
    public var AccessDenied_Settings: String { return self._s[3134]! }
    public var Passport_Address_TypeUtilityBillUploadScan: String { return self._s[3135]! }
    public var Month_ShortMay: String { return self._s[3136]! }
    public var Compose_NewGroup: String { return self._s[3137]! }
    public var Group_Setup_TypePrivate: String { return self._s[3139]! }
    public var Login_PadPhoneHelpTitle: String { return self._s[3141]! }
    public var Appearance_ThemeDayClassic: String { return self._s[3142]! }
    public var Channel_AdminLog_MessagePreviousCaption: String { return self._s[3143]! }
    public var AutoDownloadSettings_OffForAll: String { return self._s[3144]! }
    public var Privacy_GroupsAndChannels_WhoCanAddMe: String { return self._s[3145]! }
    public var Conversation_typing: String { return self._s[3147]! }
    public var Paint_Masks: String { return self._s[3148]! }
    public var Username_InvalidTaken: String { return self._s[3149]! }
    public var Call_StatusNoAnswer: String { return self._s[3150]! }
    public var TwoStepAuth_EmailAddSuccess: String { return self._s[3151]! }
    public var SettingsSearch_Synonyms_Privacy_BlockedUsers: String { return self._s[3152]! }
    public var Passport_Identity_Selfie: String { return self._s[3153]! }
    public var Login_InfoLastNamePlaceholder: String { return self._s[3154]! }
    public var Privacy_SecretChatsLinkPreviewsHelp: String { return self._s[3155]! }
    public var Conversation_ClearSecretHistory: String { return self._s[3156]! }
    public var NetworkUsageSettings_Title: String { return self._s[3158]! }
    public var Your_cards_security_code_is_invalid: String { return self._s[3160]! }
    ...
    public func Call_CallInProgressMessage(_ _1: String, _ _2: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[3163]!, self._r[3163]!, [_1, _2])
    }
    public var SaveIncomingPhotosSettings_From: String { return self._s[3165]! }
    public var Map_LiveLocationTitle: String { return self._s[3166]! }
    public var Login_InfoAvatarAdd: String { return self._s[3167]! }
    public var Passport_Identity_FilesView: String { return self._s[3168]! }
    public var UserInfo_GenericPhoneLabel: String { return self._s[3169]! }
    public var Privacy_Calls_NeverAllow: String { return self._s[3170]! }
    ...
    public var TwoStepAuth_ConfirmationText: String { return self._s[3172]! }
    public var ChatSettings_AutomaticVideoMessageDownload: String { return self._s[3173]! }
    public func PUSH_CHAT_MESSAGE_VIDEOS(_ _1: String, _ _2: String, _ _3: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[3174]!, self._r[3174]!, [_1, _2, _3])
    }
    public var Channel_AdminLogFilter_AdminsAll: String { return self._s[3175]! }
    public var Tour_Title2: String { return self._s[3176]! }
    public var Conversation_FileOpenIn: String { return self._s[3177]! }
    public var Checkout_ErrorPrecheckoutFailed: String { return self._s[3178]! }
    public var Wallpaper_Set: String { return self._s[3179]! }
    public var Passport_Identity_Translations: String { return self._s[3181]! }
    ...
    public var Channel_LeaveChannel: String { return self._s[3183]! }
    public func PINNED_INVOICE(_ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[3184]!, self._r[3184]!, [_1])
    }
    public var SettingsSearch_Synonyms_Proxy_AddProxy: String { return self._s[3185]! }
    public var PhotoEditor_HighlightsTint: String { return self._s[3186]! }
    public var Passport_Email_Delete: String { return self._s[3187]! }
    public var Conversation_Mute: String { return self._s[3189]! }
    public var Channel_AdminLog_CanSendMessages: String { return self._s[3191]! }
    ...
    public var Calls_CallTabDescription: String { return self._s[3194]! }
    public var Passport_Identity_NativeNameHelp: String { return self._s[3195]! }
    public var Common_No: String { return self._s[3196]! }
    public var Weekday_Sunday: String { return self._s[3197]! }
    public var Notification_Reply: String { return self._s[3198]! }
    public var Conversation_ViewMessage: String { return self._s[3199]! }
    ...
    public var SettingsSearch_Synonyms_EditProfile_AddAccount: String { return self._s[3202]! }
    public var Message_PinnedDocumentMessage: String { return self._s[3203]! }
    public var DialogList_TabTitle: String { return self._s[3205]! }
    public var ChatSettings_AutoPlayTitle: String { return self._s[3206]! }
    public var Passport_FieldEmail: String { return self._s[3207]! }
    public var Conversation_UnpinMessageAlert: String { return self._s[3208]! }
    public var Passport_Address_TypeBankStatement: String { return self._s[3209]! }
    public var Passport_Identity_ExpiryDate: String { return self._s[3210]! }
    public var Privacy_Calls_P2P: String { return self._s[3211]! }
    ...
    public var SocksProxySetup_UseForCallsHelp: String { return self._s[3214]! }
    public func PUSH_CHAT_ALBUM(_ _1: String, _ _2: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[3215]!, self._r[3215]!, [_1, _2])
    }
    public var Stickers_ClearRecent: String { return self._s[3216]! }
    public var EnterPasscode_ChangeTitle: String { return self._s[3217]! }
    public var Passport_InfoText: String { return self._s[3218]! }
    public var Checkout_NewCard_SaveInfoEnableHelp: String { return self._s[3219]! }
    ...
    public var SettingsSearch_Synonyms_Notifications_BadgeIncludeMutedChannels: String { return self._s[3222]! }
    public var Passport_Identity_EditDriversLicense: String { return self._s[3223]! }
    public var Conversation_TapAndHoldToRecord: String { return self._s[3225]! }
    public var SettingsSearch_Synonyms_Notifications_BadgeIncludeMutedChats: String { return self._s[3226]! }
    public func Notification_CallTimeFormat(_ _1: String, _ _2: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[3227]!, self._r[3227]!, [_1, _2])
    }
    public var Channel_EditAdmin_PermissionInviteViaLink: String { return self._s[3229]! }
    ...
    public var DialogList_Unread: String { return self._s[3232]! }
    ...
    public var User_DeletedAccount: String { return self._s[3234]! }
    ...
    public var UserInfo_NotificationsDefault: String { return self._s[3236]! }
    public var SharedMedia_CategoryMedia: String { return self._s[3237]! }
    public var SocksProxySetup_ProxyStatusUnavailable: String { return self._s[3238]! }
    public var Channel_AdminLog_MessageRestrictedForever: String { return self._s[3239]! }
    public var Watch_ChatList_Compose: String { return self._s[3240]! }
    public var Notifications_MessageNotificationsExceptionsHelp: String { return self._s[3241]! }
    public var AutoDownloadSettings_Delimeter: String { return self._s[3242]! }
    public var Watch_Microphone_Access: String { return self._s[3243]! }
    public var Group_Setup_HistoryHeader: String { return self._s[3244]! }
    public var Activity_UploadingPhoto: String { return self._s[3245]! }
    public var Conversation_Edit: String { return self._s[3247]! }
    public var Group_ErrorSendRestrictedMedia: String { return self._s[3248]! }
    public var Login_TermsOfServiceDecline: String { return self._s[3249]! }
    public var Message_PinnedContactMessage: String { return self._s[3250]! }
    ...
    public func Login_PhoneBannedEmailBody(_ _1: String, _ _2: String, _ _3: String, _ _4: String, _ _5: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[3252]!, self._r[3252]!, [_1, _2, _3, _4, _5])
    }
    public var Appearance_LargeEmoji: String { return self._s[3253]! }
    public var TwoStepAuth_AdditionalPassword: String { return self._s[3255]! }
    ...
    public var Passport_Phone_EnterOtherNumber: String { return self._s[3257]! }
    public var Message_PinnedPhotoMessage: String { return self._s[3258]! }
    public var Passport_FieldPhone: String { return self._s[3259]! }
    public var TwoStepAuth_RecoveryEmailAddDescription: String { return self._s[3260]! }
    public var ChatSettings_AutoPlayGifs: String { return self._s[3261]! }
    public var InfoPlist_NSCameraUsageDescription: String { return self._s[3263]! }
    public var Conversation_Call: String { return self._s[3264]! }
    public var Common_TakePhoto: String { return self._s[3266]! }
    public var Channel_NotificationLoading: String { return self._s[3267]! }
    ...
    public func PUSH_CHANNEL_MESSAGE_VIDEO(_ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[3269]!, self._r[3269]!, [_1])
    }
    public var Permissions_SiriTitle_v0: String { return self._s[3270]! }
    ...
    public var Channel_MessagePhotoRemoved: String { return self._s[3272]! }
    public var Common_edit: String { return self._s[3273]! }
    public var PrivacySettings_AuthSessions: String { return self._s[3274]! }
    public var Month_ShortJune: String { return self._s[3275]! }
    public var PrivacyLastSeenSettings_AlwaysShareWith_Placeholder: String { return self._s[3276]! }
    public var Call_ReportSend: String { return self._s[3277]! }
    public var Watch_LastSeen_JustNow: String { return self._s[3278]! }
    public var Notifications_MessageNotifications: String { return self._s[3279]! }
    public var WallpaperSearch_ColorGreen: String { return self._s[3280]! }
    public var BroadcastListInfo_AddRecipient: String { return self._s[3282]! }
    public var Group_Status: String { return self._s[3283]! }
    public func AutoNightTheme_LocationHelp(_ _0: String, _ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[3284]!, self._r[3284]!, [_0, _1])
    }
    public var ShareMenu_ShareTo: String { return self._s[3285]! }
    public var Conversation_Moderate_Ban: String { return self._s[3286]! }
    ...
    public var SharedMedia_ViewInChat: String { return self._s[3288]! }
    public var Map_LiveLocationFor8Hours: String { return self._s[3289]! }
    ...
    public func Map_AccurateTo(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[3293]!, self._r[3293]!, [_0])
    }
    public var Map_OpenInHereMaps: String { return self._s[3294]! }
    public var Appearance_ReduceMotion: String { return self._s[3295]! }
    ...
    public var Channel_Setup_TypePublicHelp: String { return self._s[3297]! }
    public var Passport_Identity_EditInternalPassport: String { return self._s[3298]! }
    public var PhotoEditor_Skip: String { return self._s[3299]! }
    public func CreatePoll_AddMoreOptions(_ value: Int32) -> String {
=======
        return formatWithArgumentRanges(self._s[1237]!, self._r[1237]!, [_0])
    }
    public var Channel_Stickers_Searching: String { return self._s[1238]! }
    public var Conversation_EncryptedDescription1: String { return self._s[1239]! }
    public var Conversation_EncryptedDescription2: String { return self._s[1240]! }
    public var PasscodeSettings_PasscodeOptions: String { return self._s[1241]! }
    ...
    public var Conversation_ErrorInaccessibleMessage: String { return self._s[1393]! }
    public var Map_OpenIn: String { return self._s[1394]! }
    public func PUSH_PHONE_CALL_MISSED(_ _1: String) -> (String, [(Int, NSRange)]) {
    ...
    public var MessagePoll_LabelClosed: String { return self._s[1399]! }
    public var GroupPermission_PermissionGloballyDisabled: String { return self._s[1401]! }
    public var Passport_Identity_MiddleNamePlaceholder: String { return self._s[1402]! }
    public var UserInfo_FirstNamePlaceholder: String { return self._s[1403]! }
    public var PrivacyLastSeenSettings_WhoCanSeeMyTimestamp: String { return self._s[1404]! }
    public var Login_SelectCountry_Title: String { return self._s[1405]! }
    public var Channel_EditAdmin_PermissionBanUsers: String { return self._s[1406]! }
    public var Channel_AdminLog_ChangeInfo: String { return self._s[1407]! }
    public var Watch_Suggestion_BRB: String { return self._s[1408]! }
    public var Passport_Identity_EditIdentityCard: String { return self._s[1409]! }
    public var Contacts_PermissionsTitle: String { return self._s[1410]! }
    public var Conversation_RestrictedInline: String { return self._s[1411]! }
    public var StickerPack_ViewPack: String { return self._s[1413]! }
    public func Update_AppVersion(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[1414]!, self._r[1414]!, [_0])
    }
    public var Compose_NewChannel: String { return self._s[1416]! }
    public var ChatSettings_AutoDownloadSettings_TypePhoto: String { return self._s[1419]! }
    public var Channel_Info_Stickers: String { return self._s[1421]! }
    public var AutoNightTheme_PreferredTheme: String { return self._s[1422]! }
    public var PrivacyPolicy_AgeVerificationAgree: String { return self._s[1423]! }
    public var Passport_DeletePersonalDetails: String { return self._s[1424]! }
    public var LogoutOptions_AddAccountTitle: String { return self._s[1425]! }
    public var Conversation_SearchNoResults: String { return self._s[1427]! }
    public var MessagePoll_LabelAnonymous: String { return self._s[1428]! }
    public var Channel_Members_AddAdminErrorNotAMember: String { return self._s[1429]! }
    public var Login_Code: String { return self._s[1430]! }
    public var Watch_Suggestion_WhatsUp: String { return self._s[1431]! }
    public var Weekday_ShortThursday: String { return self._s[1432]! }
    public var Resolve_ErrorNotFound: String { return self._s[1434]! }
    public var LastSeen_Offline: String { return self._s[1435]! }
    public var GroupPermission_AddMembersNotAvailable: String { return self._s[1436]! }
    public var Privacy_Calls_AlwaysAllow_Title: String { return self._s[1437]! }
    public var GroupInfo_Title: String { return self._s[1438]! }
    public var NotificationsSound_Note: String { return self._s[1439]! }
    public var Conversation_EditingMessagePanelTitle: String { return self._s[1440]! }
    public var Watch_Message_Poll: String { return self._s[1441]! }
    public var Privacy_Calls: String { return self._s[1442]! }
    public var Month_ShortAugust: String { return self._s[1443]! }
    public var TwoStepAuth_SetPasswordHelp: String { return self._s[1444]! }
    public var Notifications_Reset: String { return self._s[1445]! }
    public var Conversation_Pin: String { return self._s[1446]! }
    public var Passport_Language_lv: String { return self._s[1447]! }
    public var BlockedUsers_Info: String { return self._s[1448]! }
    public var SettingsSearch_Synonyms_Data_AutoplayVideos: String { return self._s[1450]! }
    public var Watch_Conversation_Unblock: String { return self._s[1452]! }
    public func Time_MonthOfYear_m9(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[1453]!, self._r[1453]!, [_0])
    }
    public var CloudStorage_Title: String { return self._s[1454]! }
    public var GroupInfo_DeleteAndExitConfirmation: String { return self._s[1455]! }
    public func NetworkUsageSettings_WifiUsageSince(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[1456]!, self._r[1456]!, [_0])
    }
    public var Channel_AdminLogFilter_AdminsTitle: String { return self._s[1457]! }
    public var Watch_Suggestion_OnMyWay: String { return self._s[1458]! }
    public var TwoStepAuth_RecoveryEmailTitle: String { return self._s[1459]! }
    public var Passport_Address_EditBankStatement: String { return self._s[1460]! }
    public var ChatSettings_DownloadInBackgroundInfo: String { return self._s[1461]! }
    public var ShareMenu_Comment: String { return self._s[1462]! }
    public var Permissions_ContactsTitle_v0: String { return self._s[1463]! }
    public var Notifications_PermissionsTitle: String { return self._s[1464]! }
    public var GroupPermission_NoSendLinks: String { return self._s[1465]! }
    public var Privacy_Forwards_NeverAllow_Title: String { return self._s[1466]! }
    public var Settings_Support: String { return self._s[1467]! }
    public var Notifications_ChannelNotificationsSound: String { return self._s[1468]! }
    public var SettingsSearch_Synonyms_Data_AutoDownloadReset: String { return self._s[1469]! }
    public var Privacy_Forwards_Preview: String { return self._s[1470]! }
    public var GroupPermission_ApplyAlertAction: String { return self._s[1471]! }
    public var Watch_Stickers_StickerPacks: String { return self._s[1472]! }
    public var Common_Select: String { return self._s[1474]! }
    public var CheckoutInfo_ErrorEmailInvalid: String { return self._s[1475]! }
    public var WallpaperSearch_ColorGray: String { return self._s[1477]! }
    public var ChatAdmins_AllMembersAreAdminsOffHelp: String { return self._s[1478]! }
    public var PasscodeSettings_AutoLock_IfAwayFor_5hours: String { return self._s[1479]! }
    public var Appearance_PreviewReplyAuthor: String { return self._s[1480]! }
    public var TwoStepAuth_RecoveryTitle: String { return self._s[1481]! }
    public var Widget_AuthRequired: String { return self._s[1482]! }
    public var Camera_FlashOn: String { return self._s[1483]! }
    public var Channel_Stickers_NotFoundHelp: String { return self._s[1484]! }
    public var Watch_Suggestion_OK: String { return self._s[1485]! }
    public func Username_LinkHint(_ _0: String) -> (String, [(Int, NSRange)]) {
    ...
    public var DialogList_AdLabel: String { return self._s[1490]! }
    public var WatchRemote_NotificationText: String { return self._s[1491]! }
    public var SettingsSearch_Synonyms_Notifications_MessageNotificationsAlert: String { return self._s[1492]! }
    public var Conversation_ReportSpam: String { return self._s[1493]! }
    public var SettingsSearch_Synonyms_Privacy_Data_TopPeers: String { return self._s[1494]! }
    public var Settings_LogoutConfirmationTitle: String { return self._s[1496]! }
    public var PhoneLabel_Title: String { return self._s[1497]! }
    public var Passport_Address_EditRentalAgreement: String { return self._s[1498]! }
    public var Settings_ChangePhoneNumber: String { return self._s[1499]! }
    public var Notifications_ExceptionsTitle: String { return self._s[1500]! }
    public var Notifications_AlertTones: String { return self._s[1501]! }
    public var Call_ReportIncludeLogDescription: String { return self._s[1502]! }
    public var SettingsSearch_Synonyms_Notifications_ResetAllNotifications: String { return self._s[1503]! }
    public var AutoDownloadSettings_PrivateChats: String { return self._s[1504]! }
    public var TwoStepAuth_AddHintTitle: String { return self._s[1506]! }
    public var ReportPeer_ReasonOther: String { return self._s[1507]! }
    public var KeyCommand_ScrollDown: String { return self._s[1509]! }
    public func Login_BannedPhoneSubject(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[1510]!, self._r[1510]!, [_0])
    }
    public var NetworkUsageSettings_MediaVideoDataSection: String { return self._s[1511]! }
    public var ChannelInfo_DeleteGroupConfirmation: String { return self._s[1512]! }
    public var AuthSessions_LogOut: String { return self._s[1513]! }
    public var Passport_Identity_TypeInternalPassport: String { return self._s[1514]! }
    public var ChatSettings_AutoDownloadVoiceMessages: String { return self._s[1515]! }
    public var Passport_Phone_Title: String { return self._s[1516]! }
    public var Settings_PhoneNumber: String { return self._s[1517]! }
    public var NotificationsSound_Alert: String { return self._s[1518]! }
    public var WebSearch_SearchNoResults: String { return self._s[1519]! }
    public var Privacy_ProfilePhoto_AlwaysShareWith_Title: String { return self._s[1521]! }
    public var LogoutOptions_AlternativeOptionsSection: String { return self._s[1522]! }
    public var SettingsSearch_Synonyms_Passport: String { return self._s[1523]! }
    public var PhotoEditor_CurvesTool: String { return self._s[1524]! }
    public var Checkout_PaymentMethod: String { return self._s[1526]! }
    public func PUSH_CHAT_ADD_YOU(_ _1: String, _ _2: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[1527]!, self._r[1527]!, [_1, _2])
    }
    public var Contacts_AccessDeniedError: String { return self._s[1528]! }
    public var Camera_PhotoMode: String { return self._s[1531]! }
    public var Passport_Address_AddUtilityBill: String { return self._s[1532]! }
    public var CallSettings_OnMobile: String { return self._s[1533]! }
    public var Tour_Text2: String { return self._s[1534]! }
    public func PUSH_CHAT_MESSAGE_ROUND(_ _1: String, _ _2: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[1535]!, self._r[1535]!, [_1, _2])
    }
    public var DialogList_EncryptionProcessing: String { return self._s[1537]! }
    public var Permissions_Skip: String { return self._s[1538]! }
    public var SecretImage_Title: String { return self._s[1539]! }
    public var Watch_MessageView_Title: String { return self._s[1540]! }
    public var AttachmentMenu_Poll: String { return self._s[1541]! }
    public func Notification_GroupInviter(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[1542]!, self._r[1542]!, [_0])
    }
    public var Notification_CallCanceled: String { return self._s[1543]! }
    public var WallpaperPreview_Title: String { return self._s[1544]! }
    public var Privacy_PaymentsClear_PaymentInfo: String { return self._s[1545]! }
    public var Settings_ProxyConnecting: String { return self._s[1546]! }
    public var Settings_CheckPhoneNumberText: String { return self._s[1548]! }
    public var Profile_MessageLifetime5s: String { return self._s[1549]! }
    public var Username_InvalidCharacters: String { return self._s[1550]! }
    public var WallpaperPreview_CropBottomText: String { return self._s[1551]! }
    public var AutoDownloadSettings_LimitBySize: String { return self._s[1552]! }
    public var Settings_AddAccount: String { return self._s[1553]! }
    public var Notification_CreatedChannel: String { return self._s[1556]! }
    public func PUSH_CHAT_DELETE_MEMBER(_ _1: String, _ _2: String, _ _3: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[1557]!, self._r[1557]!, [_1, _2, _3])
    }
    public var Passcode_AppLockedAlert: String { return self._s[1559]! }
    public var Contacts_TopSection: String { return self._s[1560]! }
    public func Time_MonthOfYear_m6(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[1561]!, self._r[1561]!, [_0])
    }
    public var ReportPeer_ReasonSpam: String { return self._s[1562]! }
    public var UserInfo_TapToCall: String { return self._s[1563]! }
    public var Conversation_ForwardAuthorHiddenTooltip: String { return self._s[1565]! }
    public var AutoDownloadSettings_DataUsageCustom: String { return self._s[1566]! }
    public var Common_Search: String { return self._s[1567]! }
    public var AuthSessions_IncompleteAttemptsInfo: String { return self._s[1568]! }
    public var Message_InvoiceLabel: String { return self._s[1569]! }
    public var Conversation_InputTextPlaceholder: String { return self._s[1570]! }
    public var NetworkUsageSettings_MediaImageDataSection: String { return self._s[1571]! }
    public func Passport_Address_UploadOneOfScan(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[1572]!, self._r[1572]!, [_0])
    }
    public var Conversation_Info: String { return self._s[1573]! }
    public var Login_InfoDeletePhoto: String { return self._s[1574]! }
    public var Passport_Language_vi: String { return self._s[1576]! }
    public var Conversation_Search: String { return self._s[1577]! }
    public var DialogList_DeleteBotConversationConfirmation: String { return self._s[1578]! }
    public var ReportPeer_ReasonPornography: String { return self._s[1579]! }
    public var AutoDownloadSettings_PhotosTitle: String { return self._s[1580]! }
    public var Conversation_SendMessageErrorGroupRestricted: String { return self._s[1581]! }
    public var Map_LiveLocationGroupDescription: String { return self._s[1582]! }
    public var Channel_Setup_TypeHeader: String { return self._s[1583]! }
    public var AuthSessions_LoggedIn: String { return self._s[1584]! }
    public var Privacy_Forwards_AlwaysAllow_Title: String { return self._s[1585]! }
    public var Login_SmsRequestState3: String { return self._s[1586]! }
    public var Passport_Address_EditUtilityBill: String { return self._s[1587]! }
    public var Appearance_ReduceMotionInfo: String { return self._s[1588]! }
    public var Channel_Edit_LinkItem: String { return self._s[1589]! }
    public var Privacy_Calls_P2PNever: String { return self._s[1590]! }
    public var Conversation_AddToReadingList: String { return self._s[1592]! }
    public var Message_Animation: String { return self._s[1593]! }
    public var Conversation_DefaultRestrictedMedia: String { return self._s[1594]! }
    public var Map_Unknown: String { return self._s[1595]! }
    public var AutoDownloadSettings_LastDelimeter: String { return self._s[1596]! }
    public func PUSH_PINNED_TEXT(_ _1: String, _ _2: String) -> (String, [(Int, NSRange)]) {
    ...
    public var Call_StatusRequesting: String { return self._s[1599]! }
    public var Conversation_SecretChatContextBotAlert: String { return self._s[1600]! }
    public var SocksProxySetup_ProxyStatusChecking: String { return self._s[1601]! }
    public func PUSH_CHAT_MESSAGE_DOC(_ _1: String, _ _2: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[1602]!, self._r[1602]!, [_1, _2])
    }
    public var Weekday_Monday: String { return self._s[1603]! }
    public var Update_Skip: String { return self._s[1604]! }
    public var Group_Username_RemoveExistingUsernamesInfo: String { return self._s[1605]! }
    public var Message_PinnedPollMessage: String { return self._s[1606]! }
    public var BlockedUsers_Title: String { return self._s[1607]! }
    public func PUSH_CHANNEL_MESSAGE_AUDIO(_ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[1608]!, self._r[1608]!, [_1])
    }
    public var Username_CheckingUsername: String { return self._s[1609]! }
    public var NotificationsSound_Bell: String { return self._s[1610]! }
    public var Conversation_SendMessageErrorFlood: String { return self._s[1611]! }
    public func Notification_PinnedLocationMessage(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[1612]!, self._r[1612]!, [_0])
    }
    public var SettingsSearch_Synonyms_Notifications_DisplayNamesOnLockScreen: String { return self._s[1613]! }
    public var ChannelMembers_ChannelAdminsTitle: String { return self._s[1614]! }
    public var ChatSettings_Groups: String { return self._s[1615]! }
    public var Your_card_was_declined: String { return self._s[1616]! }
    public var TwoStepAuth_EnterPasswordHelp: String { return self._s[1618]! }
    public var ChatList_Unmute: String { return self._s[1619]! }
    public var PhotoEditor_CurvesAll: String { return self._s[1620]! }
    public var Weekday_ShortTuesday: String { return self._s[1621]! }
    public var DialogList_Read: String { return self._s[1622]! }
    public var ChannelMembers_WhoCanAddMembers_AllMembers: String { return self._s[1623]! }
    public var Passport_Identity_Gender: String { return self._s[1624]! }
    public func Target_ShareGameConfirmationPrivate(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[1625]!, self._r[1625]!, [_0])
    }
    public var Target_SelectGroup: String { return self._s[1626]! }
    public func DialogList_EncryptedChatStartedIncoming(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[1628]!, self._r[1628]!, [_0])
    }
    public var Passport_Language_en: String { return self._s[1629]! }
    public var AutoDownloadSettings_AutodownloadPhotos: String { return self._s[1630]! }
    public var Channel_Username_CreatePublicLinkHelp: String { return self._s[1631]! }
    public var Login_CancelPhoneVerificationContinue: String { return self._s[1632]! }
    public var Checkout_NewCard_PaymentCard: String { return self._s[1634]! }
    public var Login_InfoHelp: String { return self._s[1635]! }
    public var Contacts_PermissionsSuppressWarningTitle: String { return self._s[1636]! }
    public var SettingsSearch_Synonyms_Stickers_FeaturedPacks: String { return self._s[1637]! }
    public var SocksProxySetup_AddProxy: String { return self._s[1640]! }
    public var CreatePoll_Title: String { return self._s[1641]! }
    public var SettingsSearch_Synonyms_Privacy_Data_SecretChatLinkPreview: String { return self._s[1642]! }
    public var PasscodeSettings_SimplePasscodeHelp: String { return self._s[1643]! }
    public var UserInfo_GroupsInCommon: String { return self._s[1644]! }
    public var Call_AudioRouteHide: String { return self._s[1645]! }
    public var ContactInfo_PhoneLabelMobile: String { return self._s[1647]! }
    public func ChatList_LeaveGroupConfirmation(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[1648]!, self._r[1648]!, [_0])
    }
    public var TextFormat_Bold: String { return self._s[1649]! }
    public var FastTwoStepSetup_EmailSection: String { return self._s[1650]! }
    public var Notifications_Title: String { return self._s[1651]! }
    public var Group_Username_InvalidTooShort: String { return self._s[1652]! }
    public var Channel_ErrorAddTooMuch: String { return self._s[1653]! }
    public func DialogList_MultipleTypingSuffix(_ _0: Int) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[1654]!, self._r[1654]!, ["\(_0)"])
    }
    public var Stickers_SuggestAdded: String { return self._s[1656]! }
    public var Login_CountryCode: String { return self._s[1657]! }
    public var ChatSettings_AutoPlayVideos: String { return self._s[1658]! }
    public var Map_GetDirections: String { return self._s[1659]! }
    public var Login_PhoneFloodError: String { return self._s[1660]! }
    public func Time_MonthOfYear_m3(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[1661]!, self._r[1661]!, [_0])
    }
    public var Settings_SetUsername: String { return self._s[1663]! }
    public var Notification_GroupInviterSelf: String { return self._s[1664]! }
    public var InstantPage_TapToOpenLink: String { return self._s[1665]! }
    public func Notification_ChannelInviter(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[1666]!, self._r[1666]!, [_0])
    }
    public var Watch_Suggestion_TalkLater: String { return self._s[1667]! }
    public var SecretChat_Title: String { return self._s[1668]! }
    public var Group_UpgradeNoticeText1: String { return self._s[1669]! }
    public var AuthSessions_Title: String { return self._s[1670]! }
    public var PhotoEditor_CropAuto: String { return self._s[1671]! }
    public var Channel_About_Title: String { return self._s[1672]! }
    public var FastTwoStepSetup_EmailHelp: String { return self._s[1673]! }
    public func Conversation_Bytes(_ _0: Int) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[1675]!, self._r[1675]!, ["\(_0)"])
    }
    public var Conversation_PinMessageAlert_OnlyPin: String { return self._s[1677]! }
    public var Group_Setup_HistoryVisibleHelp: String { return self._s[1678]! }
    public func PUSH_MESSAGE_GIF(_ _1: String) -> (String, [(Int, NSRange)]) {
    ...
    public var Privacy_PaymentsClearInfoHelp: String { return self._s[1683]! }
    public var Presence_online: String { return self._s[1685]! }
    public var PasscodeSettings_Title: String { return self._s[1686]! }
    public var Passport_Identity_ExpiryDatePlaceholder: String { return self._s[1687]! }
    public var Web_OpenExternal: String { return self._s[1688]! }
    public var AutoDownloadSettings_AutoDownload: String { return self._s[1690]! }
    public func AutoNightTheme_AutomaticHelp(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[1691]!, self._r[1691]!, [_0])
    }
    public var FastTwoStepSetup_PasswordConfirmationPlaceholder: String { return self._s[1692]! }
    public var Map_YouAreHere: String { return self._s[1693]! }
    public func AuthSessions_Message(_ _0: String) -> (String, [(Int, NSRange)]) {
    ...
    public var PrivacyLastSeenSettings_AlwaysShareWith: String { return self._s[1696]! }
    public var Target_InviteToGroupErrorAlreadyInvited: String { return self._s[1697]! }
    public func AuthSessions_AppUnofficial(_ _0: String) -> (String, [(Int, NSRange)]) {
    ...
    public var SocksProxySetup_Username: String { return self._s[1700]! }
    public var Bot_Start: String { return self._s[1701]! }
    public func Channel_AdminLog_EmptyFilterQueryText(_ _0: String) -> (String, [(Int, NSRange)]) {
    ...
    public var Contacts_SortByPresence: String { return self._s[1704]! }
    public var Conversation_DiscardVoiceMessageTitle: String { return self._s[1706]! }
    public func PUSH_CHAT_CREATED(_ _1: String, _ _2: String) -> (String, [(Int, NSRange)]) {
    ...
    public var Passport_Email_EnterOtherEmail: String { return self._s[1709]! }
    public var Login_InfoAvatarPhoto: String { return self._s[1710]! }
    public var Privacy_PaymentsClear_ShippingInfo: String { return self._s[1711]! }
    public var Tour_Title4: String { return self._s[1712]! }
    public var Passport_Identity_Translation: String { return self._s[1713]! }
    public var SettingsSearch_Synonyms_Notifications_ContactJoined: String { return self._s[1714]! }
    public var Login_TermsOfServiceLabel: String { return self._s[1716]! }
    public var Passport_Language_it: String { return self._s[1717]! }
    public var KeyCommand_JumpToNextUnreadChat: String { return self._s[1718]! }
    public var Passport_Identity_SelfieHelp: String { return self._s[1719]! }
    public var Conversation_ClearAll: String { return self._s[1721]! }
    public var TwoStepAuth_FloodError: String { return self._s[1723]! }
    public func PUSH_CHANNEL_MESSAGE_GEO(_ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[1724]!, self._r[1724]!, [_1])
    }
    public var Paint_Delete: String { return self._s[1725]! }
    public var LogoutOptions_SetPasscodeText: String { return self._s[1726]! }
    public func Passport_AcceptHelp(_ _1: String, _ _2: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[1727]!, self._r[1727]!, [_1, _2])
    }
    public var Message_PinnedAudioMessage: String { return self._s[1728]! }
    public func Watch_Time_ShortTodayAt(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[1729]!, self._r[1729]!, [_0])
    }
    public var Notification_Mute1hMin: String { return self._s[1730]! }
    public var Notifications_GroupNotificationsSound: String { return self._s[1731]! }
    public var SocksProxySetup_ShareProxyList: String { return self._s[1732]! }
    public var Conversation_MessageEditedLabel: String { return self._s[1733]! }
    public var Notification_Exceptions_AlwaysOff: String { return self._s[1734]! }
    public func Channel_AdminLog_MessageAdmin(_ _0: String, _ _1: String, _ _2: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[1735]!, self._r[1735]!, [_0, _1, _2])
    }
    public var NetworkUsageSettings_ResetStats: String { return self._s[1736]! }
    public func PUSH_MESSAGE_GEOLIVE(_ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[1737]!, self._r[1737]!, [_1])
    }
    public var AccessDenied_LocationTracking: String { return self._s[1738]! }
    public var DataUpgrade_Running: String { return self._s[1739]! }
    public var Month_GenOctober: String { return self._s[1740]! }
    public var GroupInfo_InviteLink_RevokeAlert_Revoke: String { return self._s[1741]! }
    public var EnterPasscode_EnterPasscode: String { return self._s[1742]! }
    public var MediaPicker_TimerTooltip: String { return self._s[1744]! }
    public var SharedMedia_TitleAll: String { return self._s[1745]! }
    public var SettingsSearch_Synonyms_Notifications_ChannelNotificationsExceptions: String { return self._s[1748]! }
    public var Conversation_RestrictedMedia: String { return self._s[1749]! }
    public var AccessDenied_PhotosRestricted: String { return self._s[1750]! }
    public var Privacy_Forwards_WhoCanForward: String { return self._s[1752]! }
    public var ChangePhoneNumberCode_Called: String { return self._s[1753]! }
    public func Notification_PinnedDocumentMessage(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[1754]!, self._r[1754]!, [_0])
    }
    public var Conversation_SavedMessages: String { return self._s[1757]! }
    public var Your_cards_expiration_month_is_invalid: String { return self._s[1759]! }
    public var FastTwoStepSetup_PasswordPlaceholder: String { return self._s[1760]! }
    public func Target_ShareGameConfirmationGroup(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[1762]!, self._r[1762]!, [_0])
    }
    public var ReportPeer_AlertSuccess: String { return self._s[1763]! }
    public var PhotoEditor_CropAspectRatioOriginal: String { return self._s[1764]! }
    public func InstantPage_RelatedArticleAuthorAndDateTitle(_ _1: String, _ _2: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[1765]!, self._r[1765]!, [_1, _2])
    }
    public var Checkout_PasswordEntry_Title: String { return self._s[1766]! }
    public var PhotoEditor_FadeTool: String { return self._s[1767]! }
    public var Privacy_ContactsReset: String { return self._s[1768]! }
    public func Channel_AdminLog_MessageRestrictedUntil(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[1770]!, self._r[1770]!, [_0])
    }
    public var Message_PinnedVideoMessage: String { return self._s[1771]! }
    public var ChatList_Mute: String { return self._s[1772]! }
    public var Permissions_CellularDataText_v0: String { return self._s[1773]! }
    public var ShareMenu_SelectChats: String { return self._s[1775]! }
    public var MusicPlayer_VoiceNote: String { return self._s[1776]! }
    public var Conversation_RestrictedText: String { return self._s[1777]! }
    public var SettingsSearch_Synonyms_Privacy_Data_DeleteDrafts: String { return self._s[1778]! }
    public var TwoStepAuth_DisableSuccess: String { return self._s[1779]! }
    public var Cache_Videos: String { return self._s[1780]! }
    public var FeatureDisabled_Oops: String { return self._s[1782]! }
    public var Passport_Address_PostcodePlaceholder: String { return self._s[1783]! }
    public var Stickers_GroupStickersHelp: String { return self._s[1784]! }
    public var GroupPermission_NoSendPolls: String { return self._s[1785]! }
    public var Message_VideoExpired: String { return self._s[1787]! }
    public var Notifications_Badge: String { return self._s[1788]! }
    public var GroupInfo_GroupHistoryVisible: String { return self._s[1789]! }
    public var CreatePoll_OptionPlaceholder: String { return self._s[1790]! }
    public var Username_InvalidTooShort: String { return self._s[1791]! }
    public var EnterPasscode_EnterNewPasscodeChange: String { return self._s[1792]! }
    public var Channel_AdminLog_PinMessages: String { return self._s[1793]! }
    public func Notification_MessageLifetimeRemoved(_ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[1794]!, self._r[1794]!, [_1])
    }
    public var Permissions_SiriAllowInSettings_v0: String { return self._s[1795]! }
    public var Conversation_DefaultRestrictedText: String { return self._s[1796]! }
    public var SharedMedia_CategoryDocs: String { return self._s[1799]! }
    public func PUSH_MESSAGE_CONTACT(_ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[1800]!, self._r[1800]!, [_1])
    }
    public var Privacy_Forwards_NeverLink: String { return self._s[1802]! }
    public func Notification_MessageLifetimeChangedOutgoing(_ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[1803]!, self._r[1803]!, [_1])
    }
    public var CheckoutInfo_ErrorShippingNotAvailable: String { return self._s[1804]! }
    public func Time_MonthOfYear_m12(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[1805]!, self._r[1805]!, [_0])
    }
    public var ChatSettings_PrivateChats: String { return self._s[1806]! }
    public var SettingsSearch_Synonyms_EditProfile_Logout: String { return self._s[1807]! }
    public var Conversation_PrivateMessageLinkCopied: String { return self._s[1808]! }
    public var Channel_UpdatePhotoItem: String { return self._s[1809]! }
    public var GroupInfo_LeftStatus: String { return self._s[1810]! }
    public var Watch_MessageView_Forward: String { return self._s[1812]! }
    public var ReportPeer_ReasonChildAbuse: String { return self._s[1813]! }
    public var Cache_ClearEmpty: String { return self._s[1815]! }
    public var Localization_LanguageName: String { return self._s[1816]! }
    public var WebSearch_GIFs: String { return self._s[1817]! }
    public var Notifications_DisplayNamesOnLockScreenInfoWithLink: String { return self._s[1818]! }
    public var Username_InvalidStartsWithNumber: String { return self._s[1819]! }
    public var Common_Back: String { return self._s[1820]! }
    public var Passport_Identity_DateOfBirthPlaceholder: String { return self._s[1821]! }
    public func PUSH_CHANNEL_MESSAGE_STICKER(_ _1: String, _ _2: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[1822]!, self._r[1822]!, [_1, _2])
    }
    public var Passport_Email_Help: String { return self._s[1823]! }
    public var Watch_Conversation_Reply: String { return self._s[1825]! }
    public var Conversation_EditingMessageMediaChange: String { return self._s[1827]! }
    public var Passport_Identity_IssueDatePlaceholder: String { return self._s[1828]! }
    public var Channel_BanUser_Unban: String { return self._s[1830]! }
    public var Channel_EditAdmin_PermissionPostMessages: String { return self._s[1831]! }
    public var Group_Username_CreatePublicLinkHelp: String { return self._s[1832]! }
    public var TwoStepAuth_ConfirmEmailCodePlaceholder: String { return self._s[1834]! }
    public var Passport_Identity_Name: String { return self._s[1835]! }
    public var GroupRemoved_ViewUserInfo: String { return self._s[1836]! }
    public var Conversation_BlockUser: String { return self._s[1837]! }
    public var Month_GenJanuary: String { return self._s[1838]! }
    public var ChatSettings_TextSize: String { return self._s[1839]! }
    public var Notification_PassportValuePhone: String { return self._s[1840]! }
    public var Passport_Language_ne: String { return self._s[1841]! }
    public var Notification_CallBack: String { return self._s[1842]! }
    public var TwoStepAuth_EmailHelp: String { return self._s[1843]! }
    public func Time_YesterdayAt(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[1844]!, self._r[1844]!, [_0])
    }
    public var Channel_Info_Management: String { return self._s[1845]! }
    public var Passport_FieldIdentityUploadHelp: String { return self._s[1846]! }
    public var Stickers_FrequentlyUsed: String { return self._s[1847]! }
    public var Channel_BanUser_PermissionSendMessages: String { return self._s[1848]! }
    public var Passport_Address_OneOfTypeUtilityBill: String { return self._s[1850]! }
    public func LOCAL_CHANNEL_MESSAGE_FWDS(_ _1: String, _ _2: Int) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[1851]!, self._r[1851]!, [_1, "\(_2)"])
    }
    public var Passport_Address_EditResidentialAddress: String { return self._s[1852]! }
    public var PrivacyPolicy_DeclineTitle: String { return self._s[1853]! }
    public var CreatePoll_TextHeader: String { return self._s[1854]! }
    public func Checkout_SavePasswordTimeoutAndTouchId(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[1855]!, self._r[1855]!, [_0])
    }
    public var PhotoEditor_QualityMedium: String { return self._s[1856]! }
    public var InfoPlist_NSMicrophoneUsageDescription: String { return self._s[1857]! }
    public var Conversation_StatusKickedFromChannel: String { return self._s[1859]! }
    public var CheckoutInfo_ReceiverInfoName: String { return self._s[1860]! }
    public var Group_ErrorSendRestrictedStickers: String { return self._s[1861]! }
    public func Conversation_RestrictedInlineTimed(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[1862]!, self._r[1862]!, [_0])
    }
    public var Conversation_LinkDialogOpen: String { return self._s[1864]! }
    public var Settings_Username: String { return self._s[1865]! }
    public var Wallpaper_Wallpaper: String { return self._s[1867]! }
    public var SocksProxySetup_UseProxy: String { return self._s[1869]! }
    public var UserInfo_ShareMyContactInfo: String { return self._s[1870]! }
    public var MessageTimer_Forever: String { return self._s[1871]! }
    public var Privacy_Calls_WhoCanCallMe: String { return self._s[1872]! }
    public var PhotoEditor_DiscardChanges: String { return self._s[1873]! }
    public var AuthSessions_TerminateOtherSessionsHelp: String { return self._s[1874]! }
    public var Passport_Language_da: String { return self._s[1875]! }
    public var SocksProxySetup_PortPlaceholder: String { return self._s[1876]! }
    public func SecretGIF_NotViewedYet(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[1877]!, self._r[1877]!, [_0])
    }
    public var Passport_Address_EditPassportRegistration: String { return self._s[1878]! }
    public func Channel_AdminLog_MessageChangedGroupAbout(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[1880]!, self._r[1880]!, [_0])
    }
    public var Passport_Identity_ResidenceCountryPlaceholder: String { return self._s[1882]! }
    public var Conversation_SearchByName_Prefix: String { return self._s[1883]! }
    public var Conversation_PinnedPoll: String { return self._s[1884]! }
    public var Conversation_EmptyGifPanelPlaceholder: String { return self._s[1885]! }
    public func PUSH_ENCRYPTION_ACCEPT(_ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[1886]!, self._r[1886]!, [_1])
    }
    public var WallpaperSearch_ColorPurple: String { return self._s[1887]! }
    public var Cache_ByPeerHeader: String { return self._s[1888]! }
    public func Conversation_EncryptedPlaceholderTitleIncoming(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[1889]!, self._r[1889]!, [_0])
    }
    public var ChatSettings_AutoDownloadDocuments: String { return self._s[1890]! }
    public var Notification_PinnedMessage: String { return self._s[1893]! }
    public var Contacts_SortBy: String { return self._s[1895]! }
    public func PUSH_CHANNEL_MESSAGE_NOTEXT(_ _1: String) -> (String, [(Int, NSRange)]) {
    ...
    public var Call_EncryptionKey_Title: String { return self._s[1899]! }
    public var Watch_UserInfo_Service: String { return self._s[1900]! }
    public var SettingsSearch_Synonyms_Data_SaveEditedPhotos: String { return self._s[1902]! }
    public var Conversation_Unpin: String { return self._s[1904]! }
    public var CancelResetAccount_Title: String { return self._s[1905]! }
    public var Map_LiveLocationFor15Minutes: String { return self._s[1906]! }
    public func Time_PreciseDate_m8(_ _1: String, _ _2: String, _ _3: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[1908]!, self._r[1908]!, [_1, _2, _3])
    }
    public var Group_Members_AddMemberBotErrorNotAllowed: String { return self._s[1909]! }
    public var CallSettings_Title: String { return self._s[1910]! }
    public var SettingsSearch_Synonyms_Appearance_ChatBackground: String { return self._s[1911]! }
    public var PasscodeSettings_EncryptDataHelp: String { return self._s[1913]! }
    public var AutoDownloadSettings_Contacts: String { return self._s[1914]! }
    public var Passport_Identity_DocumentDetails: String { return self._s[1915]! }
    public var LoginPassword_PasswordHelp: String { return self._s[1916]! }
    public var SettingsSearch_Synonyms_Data_AutoDownloadUsingWifi: String { return self._s[1917]! }
    public var PrivacyLastSeenSettings_CustomShareSettings_Delete: String { return self._s[1918]! }
    public var Checkout_TotalPaidAmount: String { return self._s[1919]! }
    public func FileSize_KB(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[1920]!, self._r[1920]!, [_0])
    }
    public var PasscodeSettings_ChangePasscode: String { return self._s[1921]! }
    public var Conversation_SecretLinkPreviewAlert: String { return self._s[1923]! }
    public var Privacy_SecretChatsLinkPreviews: String { return self._s[1924]! }
    public func PUSH_CHANNEL_MESSAGE_DOC(_ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[1925]!, self._r[1925]!, [_1])
    }
    public var Contacts_InviteFriends: String { return self._s[1927]! }
    public var Map_ChooseLocationTitle: String { return self._s[1928]! }
    public var Conversation_StopPoll: String { return self._s[1930]! }
    public func WebSearch_SearchNoResultsDescription(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[1931]!, self._r[1931]!, [_0])
    }
    public var Call_Camera: String { return self._s[1932]! }
    public var LogoutOptions_ChangePhoneNumberTitle: String { return self._s[1933]! }
    public var Calls_RatingFeedback: String { return self._s[1934]! }
    public var GroupInfo_BroadcastListNamePlaceholder: String { return self._s[1935]! }
    public var NotificationsSound_Pulse: String { return self._s[1936]! }
    public var Watch_LastSeen_Lately: String { return self._s[1937]! }
    public var Widget_NoUsers: String { return self._s[1940]! }
    public var Conversation_UnvotePoll: String { return self._s[1941]! }
    public var SettingsSearch_Synonyms_Privacy_ProfilePhoto: String { return self._s[1943]! }
    public var Privacy_ProfilePhoto_WhoCanSeeMyPhoto: String { return self._s[1944]! }
    public var NotificationsSound_Circles: String { return self._s[1945]! }
    public var PrivacyLastSeenSettings_AlwaysShareWith_Title: String { return self._s[1947]! }
    public var TwoStepAuth_RecoveryCodeExpired: String { return self._s[1948]! }
    public var Proxy_TooltipUnavailable: String { return self._s[1949]! }
    public var Passport_Identity_CountryPlaceholder: String { return self._s[1951]! }
    public var Conversation_FileDropbox: String { return self._s[1953]! }
    public var Notifications_ExceptionsUnmuted: String { return self._s[1954]! }
    public var Tour_Text3: String { return self._s[1956]! }
    public var Login_ResetAccountProtected_Title: String { return self._s[1958]! }
    public var GroupPermission_NoSendMessages: String { return self._s[1959]! }
    public var WallpaperSearch_ColorTitle: String { return self._s[1960]! }
    public var ChatAdmins_AllMembersAreAdminsOnHelp: String { return self._s[1961]! }
    public func Conversation_LiveLocationYouAnd(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[1963]!, self._r[1963]!, [_0])
    }
    public var GroupInfo_AddParticipantTitle: String { return self._s[1964]! }
    public var Checkout_ShippingOption_Title: String { return self._s[1965]! }
    public var ChatSettings_AutoDownloadTitle: String { return self._s[1966]! }
    public func DialogList_SingleTypingSuffix(_ _0: String) -> (String, [(Int, NSRange)]) {
    ...
    public var PrivacyLastSeenSettings_NeverShareWith_Placeholder: String { return self._s[1969]! }
    public var AutoDownloadSettings_Photos: String { return self._s[1971]! }
    public var Appearance_PreviewIncomingText: String { return self._s[1972]! }
    public var ChannelInfo_ConfirmLeave: String { return self._s[1973]! }
    public var MediaPicker_MomentsDateRangeSameMonthYearFormat: String { return self._s[1974]! }
    public var Passport_Identity_DocumentNumberPlaceholder: String { return self._s[1975]! }
    public var Channel_AdminLogFilter_EventsNewMembers: String { return self._s[1976]! }
    public var PasscodeSettings_AutoLock_IfAwayFor_5minutes: String { return self._s[1977]! }
    public var GroupInfo_SetGroupPhotoStop: String { return self._s[1978]! }
    public var Notification_SecretChatScreenshot: String { return self._s[1979]! }
    public var AccessDenied_Wallpapers: String { return self._s[1980]! }
    public var Passport_Address_City: String { return self._s[1982]! }
    public var InfoPlist_NSPhotoLibraryAddUsageDescription: String { return self._s[1983]! }
    public var SocksProxySetup_SecretPlaceholder: String { return self._s[1984]! }
    public var AccessDenied_LocationDisabled: String { return self._s[1985]! }
    public var SocksProxySetup_HostnamePlaceholder: String { return self._s[1987]! }
    public var GroupInfo_Sound: String { return self._s[1988]! }
    public var Stickers_RemoveFromFavorites: String { return self._s[1989]! }
    public var Contacts_Title: String { return self._s[1990]! }
    public var Passport_Language_fr: String { return self._s[1991]! }
    public var Notifications_ResetAllNotifications: String { return self._s[1992]! }
    public var PrivacySettings_SecurityTitle: String { return self._s[1995]! }
    public var Checkout_NewCard_Title: String { return self._s[1996]! }
    public var Login_HaveNotReceivedCodeInternal: String { return self._s[1997]! }
    public var Conversation_ForwardChats: String { return self._s[1998]! }
    public var Settings_FAQ: String { return self._s[2001]! }
    public var AutoDownloadSettings_DocumentsTitle: String { return self._s[2002]! }
    public var Conversation_ContextMenuForward: String { return self._s[2003]! }
    public var PrivacyPolicy_Title: String { return self._s[2008]! }
    public var Notifications_TextTone: String { return self._s[2009]! }
    public var Profile_CreateNewContact: String { return self._s[2010]! }
    public var Call_Speaker: String { return self._s[2012]! }
    public var AutoNightTheme_AutomaticSection: String { return self._s[2013]! }
    public var Channel_Username_InvalidCharacters: String { return self._s[2015]! }
    public func Channel_AdminLog_MessageChangedChannelUsername(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2016]!, self._r[2016]!, [_0])
    }
    public var AutoDownloadSettings_AutodownloadFiles: String { return self._s[2017]! }
    public var PrivacySettings_LastSeenTitle: String { return self._s[2018]! }
    public var Channel_AdminLog_CanInviteUsers: String { return self._s[2019]! }
    public var SettingsSearch_Synonyms_Privacy_Data_ClearPaymentsInfo: String { return self._s[2020]! }
    public var Conversation_MessageDeliveryFailed: String { return self._s[2021]! }
    public var Watch_ChatList_NoConversationsText: String { return self._s[2022]! }
    public var Bot_Unblock: String { return self._s[2023]! }
    public var TextFormat_Italic: String { return self._s[2024]! }
    public var WallpaperSearch_ColorPink: String { return self._s[2025]! }
    public var Settings_About_Help: String { return self._s[2026]! }
    public var SearchImages_Title: String { return self._s[2027]! }
    public var Weekday_Wednesday: String { return self._s[2028]! }
    public var Conversation_ClousStorageInfo_Description1: String { return self._s[2029]! }
    public var ExplicitContent_AlertTitle: String { return self._s[2030]! }
    public func Time_PreciseDate_m5(_ _1: String, _ _2: String, _ _3: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2031]!, self._r[2031]!, [_1, _2, _3])
    }
    public var Weekday_Thursday: String { return self._s[2032]! }
    public var Channel_BanUser_PermissionChangeGroupInfo: String { return self._s[2033]! }
    public var Channel_Members_AddMembersHelp: String { return self._s[2034]! }
    public func Checkout_SavePasswordTimeout(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2035]!, self._r[2035]!, [_0])
    }
    public var SettingsSearch_Synonyms_Notifications_InAppNotificationsVibrate: String { return self._s[2036]! }
    public var Passport_RequestedInformation: String { return self._s[2037]! }
    public var Login_PhoneAndCountryHelp: String { return self._s[2038]! }
    public var Conversation_EncryptionProcessing: String { return self._s[2040]! }
    public var Notifications_PermissionsSuppressWarningTitle: String { return self._s[2041]! }
    public var PhotoEditor_EnhanceTool: String { return self._s[2043]! }
    public var Channel_Setup_Title: String { return self._s[2044]! }
    public var Conversation_SearchPlaceholder: String { return self._s[2045]! }
    public var AccessDenied_LocationAlwaysDenied: String { return self._s[2046]! }
    public var Checkout_ErrorGeneric: String { return self._s[2047]! }
    public var Passport_Language_hu: String { return self._s[2048]! }
    public func Passport_Identity_UploadOneOfScan(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2050]!, self._r[2050]!, [_0])
    }
    public func PUSH_MESSAGE(_ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2053]!, self._r[2053]!, [_1])
    }
    public var Conversation_CloudStorageInfo_Title: String { return self._s[2054]! }
    public var PhotoEditor_CropAspectRatioSquare: String { return self._s[2055]! }
    public func Notification_Exceptions_MutedUntil(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2056]!, self._r[2056]!, [_0])
    }
    public var Conversation_ClearPrivateHistory: String { return self._s[2057]! }
    public var ContactInfo_PhoneLabelHome: String { return self._s[2058]! }
    public var PrivacySettings_LastSeenContacts: String { return self._s[2059]! }
    public func ChangePhone_ErrorOccupied(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2060]!, self._r[2060]!, [_0])
    }
    public var Passport_Language_cs: String { return self._s[2061]! }
    public var Message_PinnedAnimationMessage: String { return self._s[2063]! }
    public var Passport_Identity_ReverseSideHelp: String { return self._s[2065]! }
    public var SettingsSearch_Synonyms_Data_Storage_Title: String { return self._s[2066]! }
    public var SettingsSearch_Synonyms_Privacy_PasscodeAndTouchId: String { return self._s[2068]! }
    public var Embed_PlayingInPIP: String { return self._s[2069]! }
    public var AutoNightTheme_ScheduleSection: String { return self._s[2070]! }
    public func Call_EmojiDescription(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2071]!, self._r[2071]!, [_0])
    }
    public var MediaPicker_LivePhotoDescription: String { return self._s[2072]! }
    public func Channel_AdminLog_MessageRestrictedName(_ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2073]!, self._r[2073]!, [_1])
    }
    public var Notification_PaymentSent: String { return self._s[2074]! }
    public var PhotoEditor_CurvesGreen: String { return self._s[2075]! }
    public var SaveIncomingPhotosSettings_Title: String { return self._s[2076]! }
    public var NotificationSettings_ShowNotificationsAllAccounts: String { return self._s[2077]! }
    public func PUSH_MESSAGE_SCREENSHOT(_ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2080]!, self._r[2080]!, [_1])
    }
    public func PUSH_MESSAGE_PHOTO_SECRET(_ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2081]!, self._r[2081]!, [_1])
    }
    public func ApplyLanguage_UnsufficientDataText(_ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2082]!, self._r[2082]!, [_1])
    }
    public var NetworkUsageSettings_CallDataSection: String { return self._s[2084]! }
    public var PasscodeSettings_HelpTop: String { return self._s[2085]! }
    public var Passport_Address_TypeRentalAgreement: String { return self._s[2086]! }
    public var ReportPeer_ReasonOther_Placeholder: String { return self._s[2087]! }
    public var CheckoutInfo_ErrorPhoneInvalid: String { return self._s[2088]! }
    public var Call_Accept: String { return self._s[2090]! }
    public var GroupRemoved_RemoveInfo: String { return self._s[2091]! }
    public var Month_GenMarch: String { return self._s[2093]! }
    public var PhotoEditor_ShadowsTool: String { return self._s[2094]! }
    public var LoginPassword_Title: String { return self._s[2095]! }
    public var Call_End: String { return self._s[2096]! }
    public var Watch_Conversation_GroupInfo: String { return self._s[2097]! }
    public var CallSettings_Always: String { return self._s[2098]! }
    public var CallFeedback_Success: String { return self._s[2099]! }
    public var TwoStepAuth_SetupHint: String { return self._s[2100]! }
    public var ConversationProfile_UsersTooMuchError: String { return self._s[2101]! }
    public var Login_PhoneTitle: String { return self._s[2102]! }
    public var Passport_FieldPhoneHelp: String { return self._s[2103]! }
    public var Weekday_ShortSunday: String { return self._s[2104]! }
    public var Passport_InfoFAQ_URL: String { return self._s[2105]! }
    public var ContactInfo_Job: String { return self._s[2107]! }
    public var UserInfo_InviteBotToGroup: String { return self._s[2108]! }
    public var TwoStepAuth_PasswordRemovePassportConfirmation: String { return self._s[2109]! }
    public var SettingsSearch_Synonyms_Notifications_InAppNotificationsPreview: String { return self._s[2110]! }
    public var Passport_DeletePersonalDetailsConfirmation: String { return self._s[2111]! }
    public var CallFeedback_ReasonNoise: String { return self._s[2112]! }
    public var Passport_Identity_AddInternalPassport: String { return self._s[2114]! }
    public var MediaPicker_AddCaption: String { return self._s[2115]! }
    public var CallSettings_TabIconDescription: String { return self._s[2116]! }
    public var Privacy_GroupsAndChannels_AlwaysAllow: String { return self._s[2117]! }
    public var Passport_Identity_TypePersonalDetails: String { return self._s[2118]! }
    public var DialogList_SearchSectionRecent: String { return self._s[2119]! }
    public var PrivacyPolicy_DeclineMessage: String { return self._s[2120]! }
    public var LogoutOptions_ClearCacheText: String { return self._s[2123]! }
    public var LastSeen_WithinAWeek: String { return self._s[2124]! }
    public var ChannelMembers_GroupAdminsTitle: String { return self._s[2125]! }
    public var Conversation_CloudStorage_ChatStatus: String { return self._s[2127]! }
    public var Passport_Address_TypeResidentialAddress: String { return self._s[2128]! }
    public var Conversation_StatusLeftGroup: String { return self._s[2129]! }
    public var SocksProxySetup_ProxyDetailsTitle: String { return self._s[2130]! }
    public var SettingsSearch_Synonyms_Calls_Title: String { return self._s[2132]! }
    public var GroupPermission_AddSuccess: String { return self._s[2133]! }
    public var PhotoEditor_BlurToolRadial: String { return self._s[2135]! }
    public var Conversation_ContextMenuCopy: String { return self._s[2136]! }
    public var AccessDenied_CallMicrophone: String { return self._s[2137]! }
    public func Time_PreciseDate_m2(_ _1: String, _ _2: String, _ _3: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2138]!, self._r[2138]!, [_1, _2, _3])
    }
    public var Login_InvalidFirstNameError: String { return self._s[2139]! }
    public var Notifications_Badge_CountUnreadMessages_InfoOn: String { return self._s[2140]! }
    public var Checkout_PaymentMethod_New: String { return self._s[2141]! }
    public var ShareMenu_CopyShareLinkGame: String { return self._s[2142]! }
    public var PhotoEditor_QualityTool: String { return self._s[2143]! }
    public var Login_SendCodeViaSms: String { return self._s[2144]! }
    public var SettingsSearch_Synonyms_Privacy_DeleteAccountIfAwayFor: String { return self._s[2145]! }
    public var Login_EmailNotConfiguredError: String { return self._s[2146]! }
    public var SocksProxySetup_Status: String { return self._s[2147]! }
    public var PrivacyPolicy_Accept: String { return self._s[2148]! }
    public var Notifications_ExceptionsMessagePlaceholder: String { return self._s[2149]! }
    public func PUSH_CHAT_MESSAGE_TEXT(_ _1: String, _ _2: String, _ _3: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2150]!, self._r[2150]!, [_1, _2, _3])
    }
    public var InfoPlist_NSLocationAlwaysUsageDescription: String { return self._s[2151]! }
    public var AutoNightTheme_Automatic: String { return self._s[2152]! }
    public var Channel_Username_InvalidStartsWithNumber: String { return self._s[2153]! }
    public var Privacy_ContactsSyncHelp: String { return self._s[2154]! }
    public var Cache_Help: String { return self._s[2155]! }
    public var Passport_Language_fa: String { return self._s[2156]! }
    public var Login_ResetAccountProtected_TimerTitle: String { return self._s[2157]! }
    public var PrivacySettings_LastSeen: String { return self._s[2158]! }
    public func DialogList_MultipleTyping(_ _0: String, _ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2159]!, self._r[2159]!, [_0, _1])
    }
    public var Preview_SaveGif: String { return self._s[2163]! }
    public var SettingsSearch_Synonyms_Privacy_TwoStepAuth: String { return self._s[2164]! }
    public var Profile_About: String { return self._s[2165]! }
    public var Channel_About_Placeholder: String { return self._s[2166]! }
    public var Login_InfoTitle: String { return self._s[2167]! }
    public func TwoStepAuth_SetupPendingEmail(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2168]!, self._r[2168]!, [_0])
    }
    public var Watch_Suggestion_CantTalk: String { return self._s[2170]! }
    public var ContactInfo_Title: String { return self._s[2171]! }
    public var Media_ShareThisVideo: String { return self._s[2172]! }
    public var Weekday_ShortFriday: String { return self._s[2173]! }
    public var AccessDenied_Contacts: String { return self._s[2174]! }
    public var Notification_CallIncomingShort: String { return self._s[2175]! }
    public var Group_Setup_TypePublic: String { return self._s[2176]! }
    public var Notifications_MessageNotificationsExceptions: String { return self._s[2177]! }
    public var Notifications_Badge_IncludeChannels: String { return self._s[2178]! }
    public var Notifications_MessageNotificationsPreview: String { return self._s[2181]! }
    public var ConversationProfile_ErrorCreatingConversation: String { return self._s[2182]! }
    public var Group_ErrorAddTooMuchBots: String { return self._s[2183]! }
    public var Privacy_GroupsAndChannels_CustomShareHelp: String { return self._s[2184]! }
    public var Permissions_CellularDataAllowInSettings_v0: String { return self._s[2185]! }
    public var DialogList_Typing: String { return self._s[2186]! }
    public var CallFeedback_IncludeLogs: String { return self._s[2188]! }
    public var Checkout_Phone: String { return self._s[2190]! }
    public var Login_InfoFirstNamePlaceholder: String { return self._s[2193]! }
    public var Privacy_Calls_Integration: String { return self._s[2194]! }
    public var Notifications_PermissionsAllow: String { return self._s[2195]! }
    public var TwoStepAuth_AddHintDescription: String { return self._s[2199]! }
    public var Settings_ChatSettings: String { return self._s[2200]! }
    public func PUSH_MESSAGE_ALBUM(_ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2201]!, self._r[2201]!, [_1])
    }
    public func Channel_AdminLog_MessageInvitedNameUsername(_ _1: String, _ _2: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2202]!, self._r[2202]!, [_1, _2])
    }
    public var GroupRemoved_DeleteUser: String { return self._s[2204]! }
    public func Channel_AdminLog_PollStopped(_ _0: String) -> (String, [(Int, NSRange)]) {
    ...
    public var Login_ContinueWithLocalization: String { return self._s[2207]! }
    public var Watch_Message_ForwardedFrom: String { return self._s[2208]! }
    public var TwoStepAuth_EnterEmailCode: String { return self._s[2210]! }
    public var Conversation_Unblock: String { return self._s[2211]! }
    public var PrivacySettings_DataSettings: String { return self._s[2212]! }
    public var Notifications_InAppNotificationsVibrate: String { return self._s[2213]! }
    public func Privacy_GroupsAndChannels_InviteToChannelError(_ _0: String, _ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2214]!, self._r[2214]!, [_0, _1])
    }
    public var PrivacySettings_Passcode: String { return self._s[2217]! }
    public var Call_Mute: String { return self._s[2218]! }
    public var Passport_Language_dz: String { return self._s[2219]! }
    public var Passport_Language_tk: String { return self._s[2220]! }
    public func Login_EmailCodeSubject(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2221]!, self._r[2221]!, [_0])
    }
    public var Settings_Search: String { return self._s[2222]! }
    public var InfoPlist_NSPhotoLibraryUsageDescription: String { return self._s[2223]! }
    public var Conversation_ContextMenuReply: String { return self._s[2224]! }
    public var WallpaperSearch_ColorBrown: String { return self._s[2225]! }
    public var Tour_Title1: String { return self._s[2226]! }
    public var Conversation_ClearGroupHistory: String { return self._s[2228]! }
    public var WallpaperPreview_Motion: String { return self._s[2229]! }
    public func Checkout_PasswordEntry_Text(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2230]!, self._r[2230]!, [_0])
    }
    public var Call_RateCall: String { return self._s[2231]! }
    public var Channel_AdminLog_BanSendStickersAndGifs: String { return self._s[2232]! }
    public var Passport_PasswordCompleteSetup: String { return self._s[2233]! }
    public var Conversation_InputTextSilentBroadcastPlaceholder: String { return self._s[2234]! }
    public var UserInfo_LastNamePlaceholder: String { return self._s[2236]! }
    public func Login_WillCallYou(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2238]!, self._r[2238]!, [_0])
    }
    public var Compose_Create: String { return self._s[2239]! }
    public var Contacts_InviteToTelegram: String { return self._s[2240]! }
    public var GroupInfo_Notifications: String { return self._s[2241]! }
    public var Message_PinnedLiveLocationMessage: String { return self._s[2243]! }
    public var Month_GenApril: String { return self._s[2244]! }
    public var Appearance_AutoNightTheme: String { return self._s[2245]! }
    public var ChatSettings_AutomaticAudioDownload: String { return self._s[2247]! }
    public var Login_CodeSentSms: String { return self._s[2249]! }
    public func UserInfo_UnblockConfirmation(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2250]!, self._r[2250]!, [_0])
    }
    public var EmptyGroupInfo_Line3: String { return self._s[2251]! }
    public var LogoutOptions_ContactSupportText: String { return self._s[2252]! }
    public var Passport_Language_hr: String { return self._s[2253]! }
    public func Channel_AdminLog_MessageRestrictedNewSetting(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2254]!, self._r[2254]!, [_0])
    }
    public var GroupInfo_InviteLink_CopyLink: String { return self._s[2255]! }
    public var Conversation_InputTextBroadcastPlaceholder: String { return self._s[2256]! }
    public var Privacy_SecretChatsTitle: String { return self._s[2257]! }
    public var Notification_SecretChatMessageScreenshotSelf: String { return self._s[2259]! }
    public var GroupInfo_AddUserLeftError: String { return self._s[2260]! }
    public var AutoDownloadSettings_TypePrivateChats: String { return self._s[2261]! }
    public var LogoutOptions_ContactSupportTitle: String { return self._s[2262]! }
    public var Preview_DeleteGif: String { return self._s[2263]! }
    public var GroupInfo_Permissions_Exceptions: String { return self._s[2264]! }
    public var Group_ErrorNotMutualContact: String { return self._s[2265]! }
    public var Notification_MessageLifetime5s: String { return self._s[2266]! }
    public func Watch_LastSeen_AtDate(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2267]!, self._r[2267]!, [_0])
    }
    public var Passport_Address_AddBankStatement: String { return self._s[2269]! }
    public var Notification_CallIncoming: String { return self._s[2270]! }
    public var Compose_NewGroupTitle: String { return self._s[2271]! }
    public var TwoStepAuth_RecoveryCodeHelp: String { return self._s[2273]! }
    public var Passport_Address_Postcode: String { return self._s[2275]! }
    public func LastSeen_YesterdayAt(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2276]!, self._r[2276]!, [_0])
    }
    public var Checkout_NewCard_SaveInfoHelp: String { return self._s[2277]! }
    public var WallpaperColors_Title: String { return self._s[2278]! }
    public var SocksProxySetup_ShareQRCodeInfo: String { return self._s[2279]! }
    public var GroupPermission_Duration: String { return self._s[2280]! }
    public func Cache_Clear(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2281]!, self._r[2281]!, [_0])
    }
    public var Bot_GroupStatusDoesNotReadHistory: String { return self._s[2282]! }
    public var Username_Placeholder: String { return self._s[2283]! }
    public var CallFeedback_WhatWentWrong: String { return self._s[2284]! }
    public var Passport_FieldAddressUploadHelp: String { return self._s[2285]! }
    public var Permissions_NotificationsAllowInSettings_v0: String { return self._s[2286]! }
    public var Passport_PasswordDescription: String { return self._s[2288]! }
    public var Channel_MessagePhotoUpdated: String { return self._s[2289]! }
    public var MediaPicker_TapToUngroupDescription: String { return self._s[2290]! }
    public var SettingsSearch_Synonyms_Notifications_BadgeCountUnreadMessages: String { return self._s[2291]! }
    public var AttachmentMenu_PhotoOrVideo: String { return self._s[2292]! }
    public var Conversation_ContextMenuMore: String { return self._s[2293]! }
    public var Privacy_PaymentsClearInfo: String { return self._s[2294]! }
    public var CallSettings_TabIcon: String { return self._s[2295]! }
    public var KeyCommand_Find: String { return self._s[2296]! }
    public var Message_PinnedGame: String { return self._s[2297]! }
    public var Notifications_Badge_CountUnreadMessages_InfoOff: String { return self._s[2299]! }
    public var Login_CallRequestState2: String { return self._s[2301]! }
    public var CheckoutInfo_ReceiverInfoNamePlaceholder: String { return self._s[2303]! }
    public func Checkout_PayPrice(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2305]!, self._r[2305]!, [_0])
    }
    public var WallpaperPreview_Blurred: String { return self._s[2306]! }
    public var Conversation_InstantPagePreview: String { return self._s[2307]! }
    public func DialogList_SingleUploadingVideoSuffix(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2308]!, self._r[2308]!, [_0])
    }
    public var SecretTimer_VideoDescription: String { return self._s[2311]! }
    public var WallpaperSearch_ColorRed: String { return self._s[2312]! }
    public var GroupPermission_NoPinMessages: String { return self._s[2313]! }
    public var Passport_Language_es: String { return self._s[2314]! }
    public var Permissions_ContactsAllow_v0: String { return self._s[2316]! }
    public var Conversation_EditingMessageMediaEditCurrentVideo: String { return self._s[2317]! }
    public func PUSH_CHAT_MESSAGE_CONTACT(_ _1: String, _ _2: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2318]!, self._r[2318]!, [_1, _2])
    }
    public var Privacy_Forwards_CustomHelp: String { return self._s[2319]! }
    public var WebPreview_GettingLinkInfo: String { return self._s[2320]! }
    public var Watch_UserInfo_Unmute: String { return self._s[2321]! }
    public var GroupInfo_ChannelListNamePlaceholder: String { return self._s[2322]! }
    public var AccessDenied_CameraRestricted: String { return self._s[2324]! }
    public func Conversation_Kilobytes(_ _0: Int) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2325]!, self._r[2325]!, ["\(_0)"])
    }
    public var ChatList_ReadAll: String { return self._s[2327]! }
    public var Settings_CopyUsername: String { return self._s[2328]! }
    public var Contacts_SearchLabel: String { return self._s[2329]! }
    public var Map_OpenInYandexNavigator: String { return self._s[2331]! }
    public var PasscodeSettings_EncryptData: String { return self._s[2332]! }
    public var WallpaperSearch_ColorPrefix: String { return self._s[2333]! }
    public var Notifications_GroupNotificationsPreview: String { return self._s[2334]! }
    public var DialogList_AdNoticeAlert: String { return self._s[2335]! }
    public var CheckoutInfo_ShippingInfoAddress1: String { return self._s[2337]! }
    public var CheckoutInfo_ShippingInfoAddress2: String { return self._s[2338]! }
    public var Localization_LanguageCustom: String { return self._s[2339]! }
    public var Passport_Identity_TypeDriversLicenseUploadScan: String { return self._s[2340]! }
    public var CallFeedback_Title: String { return self._s[2341]! }
    public var Passport_Address_OneOfTypePassportRegistration: String { return self._s[2344]! }
    public var Conversation_InfoGroup: String { return self._s[2345]! }
    public var Compose_NewMessage: String { return self._s[2346]! }
    public var FastTwoStepSetup_HintPlaceholder: String { return self._s[2347]! }
    public var ChatSettings_AutoDownloadVideoMessages: String { return self._s[2348]! }
    public func Passport_Scans_ScanIndex(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2349]!, self._r[2349]!, [_0])
    }
    public var Channel_AdminLog_CanDeleteMessages: String { return self._s[2350]! }
    public var Login_CancelSignUpConfirmation: String { return self._s[2351]! }
    public var ChangePhoneNumberCode_Help: String { return self._s[2352]! }
    public var PrivacySettings_DeleteAccountHelp: String { return self._s[2353]! }
    public var Channel_BlackList_Title: String { return self._s[2354]! }
    public var UserInfo_PhoneCall: String { return self._s[2355]! }
    public var Passport_Address_OneOfTypeBankStatement: String { return self._s[2357]! }
    public var State_connecting: String { return self._s[2358]! }
    public func DialogList_SingleRecordingAudioSuffix(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2359]!, self._r[2359]!, [_0])
    }
    public var Notifications_GroupNotifications: String { return self._s[2360]! }
    public var Passport_Identity_EditPassport: String { return self._s[2361]! }
    public var EnterPasscode_RepeatNewPasscode: String { return self._s[2363]! }
    public var Localization_EnglishLanguageName: String { return self._s[2364]! }
    public var Share_AuthDescription: String { return self._s[2365]! }
    public var SettingsSearch_Synonyms_Notifications_ChannelNotificationsAlert: String { return self._s[2366]! }
    public var Passport_Identity_Surname: String { return self._s[2367]! }
    public var Compose_TokenListPlaceholder: String { return self._s[2368]! }
    public var Passport_Identity_OneOfTypePassport: String { return self._s[2369]! }
    public var Settings_AboutEmpty: String { return self._s[2370]! }
    public var Conversation_Unmute: String { return self._s[2371]! }
    public func PUSH_CONTACT_JOINED(_ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2373]!, self._r[2373]!, [_1])
    }
    public var Login_CodeSentCall: String { return self._s[2374]! }
    public var ContactInfo_PhoneLabelHomeFax: String { return self._s[2376]! }
    public var ChatSettings_Appearance: String { return self._s[2377]! }
    public var Appearance_PickAccentColor: String { return self._s[2378]! }
    public func PUSH_CHAT_MESSAGE_NOTEXT(_ _1: String, _ _2: String) -> (String, [(Int, NSRange)]) {
    ...
    public var Notification_CallMissed: String { return self._s[2381]! }
    public var SettingsSearch_Synonyms_Appearance_ChatBackground_Custom: String { return self._s[2382]! }
    public var Channel_AdminLogFilter_EventsInfo: String { return self._s[2383]! }
    public var ChatAdmins_AdminLabel: String { return self._s[2385]! }
    public var KeyCommand_JumpToNextChat: String { return self._s[2386]! }
    public var Conversation_StopPollConfirmationTitle: String { return self._s[2388]! }
    public var ChangePhoneNumberCode_CodePlaceholder: String { return self._s[2389]! }
    public var Month_GenJune: String { return self._s[2390]! }
    public var Watch_Location_Current: String { return self._s[2391]! }
    public var Conversation_TitleMute: String { return self._s[2392]! }
    public func PUSH_CHANNEL_MESSAGE_ROUND(_ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2393]!, self._r[2393]!, [_1])
    }
    public var GroupInfo_DeleteAndExit: String { return self._s[2394]! }
    public func Conversation_Moderate_DeleteAllMessages(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2395]!, self._r[2395]!, [_0])
    }
    public var Call_ReportPlaceholder: String { return self._s[2396]! }
    public var MaskStickerSettings_Info: String { return self._s[2397]! }
    public func GroupInfo_AddParticipantConfirmation(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2398]!, self._r[2398]!, [_0])
    }
    public var Checkout_NewCard_PostcodeTitle: String { return self._s[2399]! }
    public var Passport_Address_RegionPlaceholder: String { return self._s[2401]! }
    public var Contacts_ShareTelegram: String { return self._s[2402]! }
    public var EnterPasscode_EnterNewPasscodeNew: String { return self._s[2403]! }
    public var Channel_ErrorAccessDenied: String { return self._s[2404]! }
    public var Stickers_GroupChooseStickerPack: String { return self._s[2406]! }
    public var Call_ConnectionErrorTitle: String { return self._s[2407]! }
    public var UserInfo_NotificationsEnable: String { return self._s[2408]! }
    public var Tour_Text4: String { return self._s[2411]! }
    public var WallpaperSearch_Recent: String { return self._s[2412]! }
    public var Profile_MessageLifetime2s: String { return self._s[2414]! }
    public var Notification_MessageLifetime2s: String { return self._s[2415]! }
    public func Time_PreciseDate_m10(_ _1: String, _ _2: String, _ _3: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2416]!, self._r[2416]!, [_1, _2, _3])
    }
    public var Cache_ClearCache: String { return self._s[2417]! }
    public var AutoNightTheme_UpdateLocation: String { return self._s[2418]! }
    public var Permissions_NotificationsUnreachableText_v0: String { return self._s[2419]! }
    public func Channel_AdminLog_MessageChangedGroupUsername(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2423]!, self._r[2423]!, [_0])
    }
    public var Channel_AdminLog_EmptyFilterTitle: String { return self._s[2425]! }
    public var SocksProxySetup_TypeSocks: String { return self._s[2426]! }
    public var AutoNightTheme_Title: String { return self._s[2427]! }
    public var InstantPage_FeedbackButton: String { return self._s[2428]! }
    public var Passport_FieldAddress: String { return self._s[2429]! }
    public var Month_ShortMarch: String { return self._s[2430]! }
    public func PUSH_MESSAGE_INVOICE(_ _1: String, _ _2: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2431]!, self._r[2431]!, [_1, _2])
    }
    public var SocksProxySetup_UsernamePlaceholder: String { return self._s[2432]! }
    public var Conversation_ShareInlineBotLocationConfirmation: String { return self._s[2433]! }
    public var Passport_FloodError: String { return self._s[2434]! }
    public var SecretGif_Title: String { return self._s[2435]! }
    public var NotificationSettings_ShowNotificationsAllAccountsInfoOn: String { return self._s[2436]! }
    public var Passport_Language_th: String { return self._s[2438]! }
    public var Passport_Address_Address: String { return self._s[2439]! }
    public var Login_InvalidLastNameError: String { return self._s[2440]! }
    public var Notifications_InAppNotificationsPreview: String { return self._s[2441]! }
    public var Notifications_PermissionsUnreachableTitle: String { return self._s[2442]! }
    public var SettingsSearch_FAQ: String { return self._s[2443]! }
    public var ShareMenu_Send: String { return self._s[2444]! }
    public var WallpaperSearch_ColorYellow: String { return self._s[2446]! }
    public var Month_GenNovember: String { return self._s[2448]! }
    public var SettingsSearch_Synonyms_Appearance_LargeEmoji: String { return self._s[2450]! }
    public var Checkout_Email: String { return self._s[2451]! }
    public var NotificationsSound_Tritone: String { return self._s[2452]! }
    public var StickerPacksSettings_ManagingHelp: String { return self._s[2454]! }
    public func PUSH_PINNED_ROUND(_ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2457]!, self._r[2457]!, [_1])
    }
    public var ChangePhoneNumberNumber_Help: String { return self._s[2458]! }
    public func Checkout_LiabilityAlert(_ _1: String, _ _2: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2459]!, self._r[2459]!, [_1, _1, _1, _2])
    }
    public var DialogList_You: String { return self._s[2460]! }
    public var MediaPicker_Send: String { return self._s[2463]! }
    public var SettingsSearch_Synonyms_Stickers_Title: String { return self._s[2464]! }
    public var Call_AudioRouteSpeaker: String { return self._s[2465]! }
    public var Watch_UserInfo_Title: String { return self._s[2466]! }
    public var Appearance_AccentColor: String { return self._s[2467]! }
    public func Login_EmailPhoneSubject(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2468]!, self._r[2468]!, [_0])
    }
    public var Permissions_ContactsAllowInSettings_v0: String { return self._s[2469]! }
    public func PUSH_CHANNEL_MESSAGE_GAME(_ _1: String, _ _2: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2470]!, self._r[2470]!, [_1, _2])
    }
    public var Conversation_ClousStorageInfo_Description2: String { return self._s[2471]! }
    public var WebSearch_RecentClearConfirmation: String { return self._s[2472]! }
    public var Notification_CallOutgoing: String { return self._s[2473]! }
    public var PrivacySettings_PasscodeAndFaceId: String { return self._s[2474]! }
    public var Call_RecordingDisabledMessage: String { return self._s[2475]! }
    public var Message_Game: String { return self._s[2476]! }
    public var Conversation_PressVolumeButtonForSound: String { return self._s[2477]! }
    public var PrivacyLastSeenSettings_CustomHelp: String { return self._s[2478]! }
    public var Channel_EditAdmin_PermissionAddAdmins: String { return self._s[2479]! }
    public var Date_DialogDateFormat: String { return self._s[2480]! }
    public var WallpaperColors_SetCustomColor: String { return self._s[2481]! }
    public var Notifications_InAppNotifications: String { return self._s[2482]! }
    public func Channel_Management_RemovedBy(_ _0: String) -> (String, [(Int, NSRange)]) {
    ...
    public var NewContact_Title: String { return self._s[2485]! }
    public func AutoDownloadSettings_UpToForAll(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2486]!, self._r[2486]!, [_0])
    }
    public var Conversation_ViewContactDetails: String { return self._s[2487]! }
    public func PUSH_CHANNEL_MESSAGE_CONTACT(_ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2489]!, self._r[2489]!, [_1])
    }
    public var Checkout_NewCard_CardholderNameTitle: String { return self._s[2490]! }
    public var Passport_Identity_ExpiryDateNone: String { return self._s[2491]! }
    public var PrivacySettings_Title: String { return self._s[2492]! }
    public var Conversation_SilentBroadcastTooltipOff: String { return self._s[2495]! }
    public var GroupRemoved_UsersSectionTitle: String { return self._s[2496]! }
    public var Contacts_PhoneNumber: String { return self._s[2497]! }
    public var Map_ShowPlaces: String { return self._s[2499]! }
    public var ChatAdmins_Title: String { return self._s[2500]! }
    public var InstantPage_Reference: String { return self._s[2502]! }
    public func PUSH_CHAT_MESSAGE_FWD(_ _1: String, _ _2: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2503]!, self._r[2503]!, [_1, _2])
    }
    public var Camera_FlashOff: String { return self._s[2504]! }
    public var Watch_UserInfo_Block: String { return self._s[2505]! }
    public var ChatSettings_Stickers: String { return self._s[2506]! }
    public var ChatSettings_DownloadInBackground: String { return self._s[2507]! }
    public func UserInfo_BlockConfirmation(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2508]!, self._r[2508]!, [_0])
    }
    public var Settings_ViewPhoto: String { return self._s[2509]! }
    public var Login_CheckOtherSessionMessages: String { return self._s[2510]! }
    public var AutoDownloadSettings_Cellular: String { return self._s[2511]! }
    public var SettingsSearch_Synonyms_Notifications_GroupNotificationsExceptions: String { return self._s[2512]! }
    public func Target_InviteToGroupConfirmation(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2514]!, self._r[2514]!, [_0])
    }
    public var Privacy_DeleteDrafts: String { return self._s[2515]! }
    public var Wallpaper_SetCustomBackgroundInfo: String { return self._s[2516]! }
    public func LastSeen_AtDate(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2517]!, self._r[2517]!, [_0])
    }
    public var DialogList_SavedMessagesHelp: String { return self._s[2518]! }
    public var DialogList_SavedMessages: String { return self._s[2519]! }
    public var GroupInfo_UpgradeButton: String { return self._s[2520]! }
    public var DialogList_Pin: String { return self._s[2522]! }
    public func ForwardedAuthors2(_ _0: String, _ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2523]!, self._r[2523]!, [_0, _1])
    }
    public func Login_PhoneGenericEmailSubject(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2524]!, self._r[2524]!, [_0])
    }
    public var Notification_Exceptions_AlwaysOn: String { return self._s[2525]! }
    public var UserInfo_NotificationsDisable: String { return self._s[2526]! }
    public var Paint_Outlined: String { return self._s[2527]! }
    public var Activity_PlayingGame: String { return self._s[2528]! }
    public var SearchImages_NoImagesFound: String { return self._s[2529]! }
    public var SocksProxySetup_ProxyType: String { return self._s[2530]! }
    public var AppleWatch_ReplyPresetsHelp: String { return self._s[2532]! }
    public var Conversation_ContextMenuCancelSending: String { return self._s[2533]! }
    public var Settings_AppLanguage: String { return self._s[2534]! }
    public var TwoStepAuth_ResetAccountHelp: String { return self._s[2535]! }
    public var Common_ChoosePhoto: String { return self._s[2536]! }
    public var CallFeedback_ReasonEcho: String { return self._s[2537]! }
    public func PUSH_PINNED_AUDIO(_ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2538]!, self._r[2538]!, [_1])
    }
    public var Privacy_Calls_AlwaysAllow: String { return self._s[2539]! }
    public var Activity_UploadingVideo: String { return self._s[2540]! }
    public var ChannelInfo_DeleteChannelConfirmation: String { return self._s[2541]! }
    public var NetworkUsageSettings_Wifi: String { return self._s[2542]! }
    public var Channel_BanUser_PermissionReadMessages: String { return self._s[2543]! }
    public var Checkout_PayWithTouchId: String { return self._s[2544]! }
    public var Wallpaper_ResetWallpapersConfirmation: String { return self._s[2545]! }
    public func PUSH_LOCKED_MESSAGE(_ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2547]!, self._r[2547]!, [_1])
    }
    public var Notifications_ExceptionsNone: String { return self._s[2548]! }
    public func Message_ForwardedMessageShort(_ _0: String) -> (String, [(Int, NSRange)]) {
    ...
    public var AuthSessions_IncompleteAttempts: String { return self._s[2552]! }
    public var Passport_Address_Region: String { return self._s[2555]! }
    public var ChatList_DeleteChat: String { return self._s[2556]! }
    public var LogoutOptions_ClearCacheTitle: String { return self._s[2557]! }
    public var PhotoEditor_TiltShift: String { return self._s[2558]! }
    public var Settings_FAQ_URL: String { return self._s[2559]! }
    public var Passport_Language_sl: String { return self._s[2560]! }
    public var Settings_PrivacySettings: String { return self._s[2562]! }
    public var SharedMedia_TitleLink: String { return self._s[2563]! }
    public var Passport_Identity_TypePassportUploadScan: String { return self._s[2564]! }
    public var Settings_SetProfilePhoto: String { return self._s[2565]! }
    public var Channel_About_Help: String { return self._s[2566]! }
    public var Contacts_PermissionsEnable: String { return self._s[2567]! }
    public var SettingsSearch_Synonyms_Notifications_GroupNotificationsAlert: String { return self._s[2568]! }
    public var AttachmentMenu_SendAsFiles: String { return self._s[2569]! }
    public var CallFeedback_ReasonInterruption: String { return self._s[2571]! }
    public var Passport_Address_AddTemporaryRegistration: String { return self._s[2572]! }
    public var AutoDownloadSettings_AutodownloadVideos: String { return self._s[2573]! }
    public var ChatSettings_AutoDownloadSettings_Delimeter: String { return self._s[2574]! }
    public var PrivacySettings_DeleteAccountTitle: String { return self._s[2575]! }
    public var AccessDenied_VideoMessageCamera: String { return self._s[2577]! }
    public var Map_OpenInYandexMaps: String { return self._s[2579]! }
    public var PhotoEditor_SaturationTool: String { return self._s[2580]! }
    public func PUSH_MESSAGE_STICKER(_ _1: String, _ _2: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2581]!, self._r[2581]!, [_1, _2])
    }
    public var Notification_Exceptions_NewException_NotificationHeader: String { return self._s[2582]! }
    public var Appearance_TextSize: String { return self._s[2583]! }
    public func LOCAL_MESSAGE_FWDS(_ _1: String, _ _2: Int) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2584]!, self._r[2584]!, [_1, "\(_2)"])
    }
    public var Channel_Username_InvalidTooShort: String { return self._s[2586]! }
    public func PUSH_CHAT_MESSAGE_GAME(_ _1: String, _ _2: String, _ _3: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2587]!, self._r[2587]!, [_1, _2, _3])
    }
    public var Passport_PassportInformation: String { return self._s[2590]! }
    public var WatchRemote_AlertTitle: String { return self._s[2591]! }
    public var Privacy_GroupsAndChannels_NeverAllow: String { return self._s[2592]! }
    public var ConvertToSupergroup_HelpText: String { return self._s[2594]! }
    public func Time_MonthOfYear_m7(_ _0: String) -> (String, [(Int, NSRange)]) {
    ...
    public var Privacy_GroupsAndChannels_CustomHelp: String { return self._s[2597]! }
    public var TwoStepAuth_RecoveryCodeInvalid: String { return self._s[2599]! }
    public var AccessDenied_CameraDisabled: String { return self._s[2600]! }
    public func Channel_Username_UsernameIsAvailable(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2601]!, self._r[2601]!, [_0])
    }
    public var PhotoEditor_ContrastTool: String { return self._s[2604]! }
    public func PUSH_PINNED_DOC(_ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2605]!, self._r[2605]!, [_1])
    }
    public var DialogList_Draft: String { return self._s[2606]! }
    public var Privacy_TopPeersDelete: String { return self._s[2608]! }
    public var LoginPassword_PasswordPlaceholder: String { return self._s[2609]! }
    public var Passport_Identity_TypeIdentityCardUploadScan: String { return self._s[2610]! }
    public var WebSearch_RecentSectionClear: String { return self._s[2611]! }
    public var Watch_ChatList_NoConversationsTitle: String { return self._s[2613]! }
    public var Common_Done: String { return self._s[2615]! }
    public var AuthSessions_EmptyText: String { return self._s[2616]! }
    public var Conversation_ShareBotContactConfirmation: String { return self._s[2617]! }
    public var Tour_Title5: String { return self._s[2618]! }
    public func Map_DirectionsDriveEta(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2619]!, self._r[2619]!, [_0])
    }
    public var ApplyLanguage_UnsufficientDataTitle: String { return self._s[2620]! }
    public var Conversation_LinkDialogSave: String { return self._s[2621]! }
    public var GroupInfo_ActionRestrict: String { return self._s[2622]! }
    public var Checkout_Title: String { return self._s[2623]! }
    public var Channel_AdminLog_CanChangeInfo: String { return self._s[2626]! }
    public var Notification_RenamedGroup: String { return self._s[2627]! }
    public var Checkout_PayWithFaceId: String { return self._s[2628]! }
    public var Channel_BanList_BlockedTitle: String { return self._s[2629]! }
    public var SettingsSearch_Synonyms_Notifications_InAppNotificationsSound: String { return self._s[2631]! }
    public var Checkout_WebConfirmation_Title: String { return self._s[2632]! }
    public var Notifications_MessageNotificationsAlert: String { return self._s[2633]! }
    public var Profile_AddToExisting: String { return self._s[2635]! }
    public func Profile_CreateEncryptedChatOutdatedError(_ _0: String, _ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2636]!, self._r[2636]!, [_0, _1])
    }
    public var Cache_Files: String { return self._s[2638]! }
    public var Permissions_PrivacyPolicy: String { return self._s[2639]! }
    public var SocksProxySetup_ConnectAndSave: String { return self._s[2640]! }
    public var UserInfo_NotificationsDefaultDisabled: String { return self._s[2641]! }
    public var AutoDownloadSettings_TypeContacts: String { return self._s[2643]! }
    public var Calls_NoCallsPlaceholder: String { return self._s[2645]! }
    public var Channel_Username_RevokeExistingUsernamesInfo: String { return self._s[2646]! }
    public var Notifications_ExceptionsGroupPlaceholder: String { return self._s[2648]! }
    public func PUSH_CHAT_MESSAGE_INVOICE(_ _1: String, _ _2: String, _ _3: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2649]!, self._r[2649]!, [_1, _2, _3])
    }
    public var SettingsSearch_Synonyms_Notifications_GroupNotificationsSound: String { return self._s[2650]! }
    public var Passport_FieldAddressHelp: String { return self._s[2651]! }
    public var Privacy_GroupsAndChannels_InviteToChannelMultipleError: String { return self._s[2652]! }
    public func Login_TermsOfService_ProceedBot(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2653]!, self._r[2653]!, [_0])
    }
    public var Channel_AdminLog_EmptyTitle: String { return self._s[2654]! }
    public var Privacy_Calls_NeverAllow_Title: String { return self._s[2656]! }
    public var Login_UnknownError: String { return self._s[2657]! }
    public var Group_UpgradeNoticeText2: String { return self._s[2659]! }
    public var Watch_Compose_AddContact: String { return self._s[2660]! }
    public var Web_Error: String { return self._s[2661]! }
    public var Gif_Search: String { return self._s[2662]! }
    public var Profile_MessageLifetime1h: String { return self._s[2663]! }
    public var CheckoutInfo_ReceiverInfoEmailPlaceholder: String { return self._s[2664]! }
    public var Channel_Username_CheckingUsername: String { return self._s[2665]! }
    public var CallFeedback_ReasonSilentRemote: String { return self._s[2666]! }
    public var AutoDownloadSettings_TypeChannels: String { return self._s[2667]! }
    public var Channel_AboutItem: String { return self._s[2668]! }
    public var Privacy_GroupsAndChannels_AlwaysAllow_Placeholder: String { return self._s[2670]! }
    public var GroupInfo_SharedMedia: String { return self._s[2671]! }
    public func Channel_AdminLog_MessagePromotedName(_ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2672]!, self._r[2672]!, [_1])
    }
    public var Call_PhoneCallInProgressMessage: String { return self._s[2673]! }
    public func PUSH_CHANNEL_ALBUM(_ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2674]!, self._r[2674]!, [_1])
    }
    public var GroupInfo_InviteLink_RevokeAlert_Text: String { return self._s[2675]! }
    public var Conversation_SearchByName_Placeholder: String { return self._s[2676]! }
    public var CreatePoll_AddOption: String { return self._s[2677]! }
    public var GroupInfo_Permissions_SearchPlaceholder: String { return self._s[2678]! }
    public var Group_UpgradeNoticeHeader: String { return self._s[2679]! }
    public var Channel_Management_AddModerator: String { return self._s[2680]! }
    public var AutoDownloadSettings_MaxFileSize: String { return self._s[2681]! }
    public var StickerPacksSettings_ShowStickersButton: String { return self._s[2682]! }
    public var NotificationsSound_Hello: String { return self._s[2683]! }
    public var SocksProxySetup_SavedProxies: String { return self._s[2684]! }
    public var Channel_Stickers_Placeholder: String { return self._s[2686]! }
    public func Login_EmailCodeBody(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2687]!, self._r[2687]!, [_0])
    }
    public var PrivacyPolicy_DeclineDeclineAndDelete: String { return self._s[2688]! }
    public var Channel_Management_AddModeratorHelp: String { return self._s[2689]! }
    public var ContactInfo_BirthdayLabel: String { return self._s[2690]! }
    public var ChangePhoneNumberCode_RequestingACall: String { return self._s[2691]! }
    public var AutoDownloadSettings_Channels: String { return self._s[2692]! }
    public var Passport_Language_mn: String { return self._s[2693]! }
    public var Notifications_ResetAllNotificationsHelp: String { return self._s[2696]! }
    public var Passport_Language_ja: String { return self._s[2698]! }
    public var Settings_About_Title: String { return self._s[2699]! }
    public var Settings_NotificationsAndSounds: String { return self._s[2700]! }
    public var ChannelInfo_DeleteGroup: String { return self._s[2701]! }
    public var Settings_BlockedUsers: String { return self._s[2702]! }
    public func Time_MonthOfYear_m4(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2703]!, self._r[2703]!, [_0])
    }
    public var AutoDownloadSettings_PreloadVideo: String { return self._s[2704]! }
    public var Passport_Address_AddResidentialAddress: String { return self._s[2705]! }
    public var Channel_Username_Title: String { return self._s[2706]! }
    public func Notification_RemovedGroupPhoto(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2707]!, self._r[2707]!, [_0])
    }
    public var AttachmentMenu_File: String { return self._s[2709]! }
    public var AppleWatch_Title: String { return self._s[2710]! }
    public var Activity_RecordingVideoMessage: String { return self._s[2711]! }
    public var Weekday_Saturday: String { return self._s[2712]! }
    public var WallpaperPreview_SwipeColorsTopText: String { return self._s[2713]! }
    public var Profile_CreateEncryptedChatError: String { return self._s[2714]! }
    public var Common_Next: String { return self._s[2716]! }
    public var Channel_Stickers_YourStickers: String { return self._s[2718]! }
    public var Call_AudioRouteHeadphones: String { return self._s[2719]! }
    public var TwoStepAuth_EnterPasswordForgot: String { return self._s[2721]! }
    public var Watch_Contacts_NoResults: String { return self._s[2723]! }
    public var PhotoEditor_TintTool: String { return self._s[2726]! }
    public var LoginPassword_ResetAccount: String { return self._s[2728]! }
    public var Settings_SavedMessages: String { return self._s[2729]! }
    public var SettingsSearch_Synonyms_Appearance_Animations: String { return self._s[2730]! }
    public var Bot_GenericSupportStatus: String { return self._s[2731]! }
    public var StickerPack_Add: String { return self._s[2732]! }
    public var Checkout_TotalAmount: String { return self._s[2733]! }
    public var Your_cards_number_is_invalid: String { return self._s[2734]! }
    public var SettingsSearch_Synonyms_Appearance_AutoNightTheme: String { return self._s[2735]! }
    public func ChangePhoneNumberCode_CallTimer(_ _0: String) -> (String, [(Int, NSRange)]) {
    ...
    public var ChatSettings_ConnectionType_UseSocks5: String { return self._s[2738]! }
    public func PUSH_CHAT_PHOTO_EDITED(_ _1: String, _ _2: String) -> (String, [(Int, NSRange)]) {
    ...
    public var GroupInfo_InviteLink_ShareLink: String { return self._s[2742]! }
    public var StickerPack_Share: String { return self._s[2743]! }
    public var Passport_DeleteAddress: String { return self._s[2744]! }
    public var Settings_Passport: String { return self._s[2745]! }
    public var SharedMedia_EmptyFilesText: String { return self._s[2746]! }
    public var Conversation_DeleteMessagesForMe: String { return self._s[2747]! }
    public var PasscodeSettings_AutoLock_IfAwayFor_1hour: String { return self._s[2748]! }
    public var Contacts_PermissionsText: String { return self._s[2749]! }
    public var Group_Setup_HistoryVisible: String { return self._s[2750]! }
    public var Passport_Address_AddRentalAgreement: String { return self._s[2752]! }
    public var SocksProxySetup_Title: String { return self._s[2753]! }
    public var Notification_Mute1h: String { return self._s[2754]! }
    public func Passport_Email_CodeHelp(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2755]!, self._r[2755]!, [_0])
    }
    public var NotificationSettings_ShowNotificationsAllAccountsInfoOff: String { return self._s[2756]! }
    public func PUSH_PINNED_GEOLIVE(_ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2757]!, self._r[2757]!, [_1])
    }
    public var FastTwoStepSetup_PasswordSection: String { return self._s[2758]! }
    public var NetworkUsageSettings_ResetStatsConfirmation: String { return self._s[2761]! }
    public var InfoPlist_NSFaceIDUsageDescription: String { return self._s[2763]! }
    public var DialogList_NoMessagesText: String { return self._s[2764]! }
    public var Privacy_ContactsResetConfirmation: String { return self._s[2765]! }
    public var Privacy_Calls_P2PHelp: String { return self._s[2766]! }
    public var Your_cards_expiration_year_is_invalid: String { return self._s[2768]! }
    public var Common_TakePhotoOrVideo: String { return self._s[2769]! }
    public var Call_StatusBusy: String { return self._s[2770]! }
    public var Conversation_PinnedMessage: String { return self._s[2771]! }
    public var AutoDownloadSettings_VoiceMessagesTitle: String { return self._s[2772]! }
    public var TwoStepAuth_SetupPasswordConfirmFailed: String { return self._s[2773]! }
    public var Undo_ChatCleared: String { return self._s[2774]! }
    public var AppleWatch_ReplyPresets: String { return self._s[2775]! }
    public var Passport_DiscardMessageDescription: String { return self._s[2777]! }
    public var Login_NetworkError: String { return self._s[2778]! }
    public func Notification_PinnedRoundMessage(_ _0: String) -> (String, [(Int, NSRange)]) {
    ...
    public var SocksProxySetup_PasswordPlaceholder: String { return self._s[2781]! }
    public var Login_ResetAccountProtected_LimitExceeded: String { return self._s[2783]! }
    public func Watch_LastSeen_YesterdayAt(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2785]!, self._r[2785]!, [_0])
    }
    public var Call_ConnectionErrorMessage: String { return self._s[2786]! }
    public var SettingsSearch_Synonyms_Notifications_MessageNotificationsSound: String { return self._s[2787]! }
    public var Compose_GroupTokenListPlaceholder: String { return self._s[2789]! }
    public var ConversationMedia_Title: String { return self._s[2790]! }
    public var EncryptionKey_Title: String { return self._s[2792]! }
    public var TwoStepAuth_EnterPasswordTitle: String { return self._s[2793]! }
    public var Notification_Exceptions_AddException: String { return self._s[2794]! }
    public var Profile_MessageLifetime1m: String { return self._s[2795]! }
    public func Channel_AdminLog_MessageUnkickedName(_ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2796]!, self._r[2796]!, [_1])
    }
    public var Month_GenMay: String { return self._s[2797]! }
    public func LiveLocationUpdated_TodayAt(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2798]!, self._r[2798]!, [_0])
    }
    public var ChannelMembers_WhoCanAddMembersAllHelp: String { return self._s[2799]! }
    public var AutoDownloadSettings_ResetSettings: String { return self._s[2800]! }
    public var Conversation_EmptyPlaceholder: String { return self._s[2802]! }
    public var Passport_Address_AddPassportRegistration: String { return self._s[2803]! }
    public var Notifications_ChannelNotificationsAlert: String { return self._s[2804]! }
    public var ChatSettings_AutoDownloadUsingCellular: String { return self._s[2805]! }
    public var Camera_TapAndHoldForVideo: String { return self._s[2806]! }
    public var Channel_JoinChannel: String { return self._s[2808]! }
    public var Appearance_Animations: String { return self._s[2811]! }
    public func Notification_MessageLifetimeChanged(_ _1: String, _ _2: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2812]!, self._r[2812]!, [_1, _2])
    }
    public var Stickers_GroupStickers: String { return self._s[2814]! }
    public var ConvertToSupergroup_HelpTitle: String { return self._s[2816]! }
    public var Passport_Address_Street: String { return self._s[2817]! }
    public var Conversation_AddContact: String { return self._s[2818]! }
    public var Login_PhonePlaceholder: String { return self._s[2819]! }
    public var Channel_Members_InviteLink: String { return self._s[2821]! }
    public var Bot_Stop: String { return self._s[2822]! }
    public var SettingsSearch_Synonyms_Proxy_UseForCalls: String { return self._s[2824]! }
    public var Notification_PassportValueAddress: String { return self._s[2825]! }
    public var Month_ShortJuly: String { return self._s[2826]! }
    public var Passport_Address_TypeTemporaryRegistrationUploadScan: String { return self._s[2827]! }
    public var Channel_AdminLog_BanSendMedia: String { return self._s[2828]! }
    public var Passport_Identity_ReverseSide: String { return self._s[2829]! }
    public var Watch_Stickers_Recents: String { return self._s[2832]! }
    public var PrivacyLastSeenSettings_EmpryUsersPlaceholder: String { return self._s[2834]! }
    public var Map_SendThisLocation: String { return self._s[2835]! }
    public func Time_MonthOfYear_m1(_ _0: String) -> (String, [(Int, NSRange)]) {
    ...
    public var ConvertToSupergroup_Note: String { return self._s[2838]! }
    public func FileSize_MB(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2839]!, self._r[2839]!, [_0])
    }
    public var NetworkUsageSettings_GeneralDataSection: String { return self._s[2840]! }
    public func Compatibility_SecretMediaVersionTooLow(_ _0: String, _ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2841]!, self._r[2841]!, [_0, _1])
    }
    public var Login_CallRequestState3: String { return self._s[2843]! }
    public var Wallpaper_SearchShort: String { return self._s[2844]! }
    public var SettingsSearch_Synonyms_Appearance_ColorTheme: String { return self._s[2846]! }
    public var PasscodeSettings_UnlockWithFaceId: String { return self._s[2847]! }
    public func PUSH_CHAT_MESSAGE_GEOLIVE(_ _1: String, _ _2: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2848]!, self._r[2848]!, [_1, _2])
    }
    public var Channel_AdminLogFilter_Title: String { return self._s[2849]! }
    public var Notifications_GroupNotificationsExceptions: String { return self._s[2853]! }
    public func FileSize_B(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2854]!, self._r[2854]!, [_0])
    }
    public var Passport_CorrectErrors: String { return self._s[2855]! }
    public func Channel_MessageTitleUpdated(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2856]!, self._r[2856]!, [_0])
    }
    public var Map_SendMyCurrentLocation: String { return self._s[2857]! }
    public func PUSH_PINNED_CONTACT(_ _1: String, _ _2: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2858]!, self._r[2858]!, [_1, _2])
    }
    public var SharedMedia_SearchNoResults: String { return self._s[2859]! }
    public var Permissions_NotificationsText_v0: String { return self._s[2860]! }
    public var LoginPassword_FloodError: String { return self._s[2861]! }
    public var Group_Setup_HistoryHiddenHelp: String { return self._s[2863]! }
    public func TwoStepAuth_PendingEmailHelp(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2864]!, self._r[2864]!, [_0])
    }
    public var Passport_Language_bn: String { return self._s[2865]! }
    public func DialogList_SingleUploadingPhotoSuffix(_ _0: String) -> (String, [(Int, NSRange)]) {
    ...
    public var GroupInfo_InvitationLinkGroupFull: String { return self._s[2871]! }
    public var Group_EditAdmin_PermissionChangeInfo: String { return self._s[2873]! }
    public var Contacts_PermissionsAllow: String { return self._s[2874]! }
    public var ReportPeer_ReasonCopyright: String { return self._s[2875]! }
    public var Channel_EditAdmin_PermissinAddAdminOn: String { return self._s[2876]! }
    public var WallpaperPreview_Pattern: String { return self._s[2877]! }
    public var Paint_Duplicate: String { return self._s[2878]! }
    public var Passport_Address_Country: String { return self._s[2879]! }
    public var Notification_RenamedChannel: String { return self._s[2881]! }
    public var CheckoutInfo_ErrorPostcodeInvalid: String { return self._s[2882]! }
    public var Group_MessagePhotoUpdated: String { return self._s[2883]! }
    public var Channel_BanUser_PermissionSendMedia: String { return self._s[2884]! }
    public var Conversation_ContextMenuBan: String { return self._s[2885]! }
    public var TwoStepAuth_EmailSent: String { return self._s[2886]! }
    public var MessagePoll_NoVotes: String { return self._s[2887]! }
    public var Passport_Language_is: String { return self._s[2888]! }
    public var Tour_Text5: String { return self._s[2890]! }
    public func Call_GroupFormat(_ _1: String, _ _2: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2892]!, self._r[2892]!, [_1, _2])
    }
    public var Undo_SecretChatDeleted: String { return self._s[2893]! }
    public var SocksProxySetup_ShareQRCode: String { return self._s[2894]! }
    public var LogoutOptions_ChangePhoneNumberText: String { return self._s[2895]! }
    public var Paint_Edit: String { return self._s[2897]! }
    public var Undo_DeletedGroup: String { return self._s[2900]! }
    public var LoginPassword_ForgotPassword: String { return self._s[2901]! }
    public var GroupInfo_GroupNamePlaceholder: String { return self._s[2902]! }
    public func Notification_Kicked(_ _0: String, _ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2903]!, self._r[2903]!, [_0, _1])
    }
    public var Conversation_InputTextCaptionPlaceholder: String { return self._s[2904]! }
    public var AutoDownloadSettings_VideoMessagesTitle: String { return self._s[2905]! }
    public var Passport_Language_uz: String { return self._s[2906]! }
    public var Conversation_PinMessageAlertGroup: String { return self._s[2907]! }
    public var SettingsSearch_Synonyms_Privacy_GroupsAndChannels: String { return self._s[2908]! }
    public var Map_StopLiveLocation: String { return self._s[2910]! }
    public var PasscodeSettings_Help: String { return self._s[2912]! }
    public var NotificationsSound_Input: String { return self._s[2913]! }
    public var Share_Title: String { return self._s[2916]! }
    public var LogoutOptions_Title: String { return self._s[2917]! }
    public var Login_TermsOfServiceAgree: String { return self._s[2918]! }
    public var Compose_NewEncryptedChatTitle: String { return self._s[2919]! }
    public var Channel_AdminLog_TitleSelectedEvents: String { return self._s[2920]! }
    public var Channel_EditAdmin_PermissionEditMessages: String { return self._s[2921]! }
    public var EnterPasscode_EnterTitle: String { return self._s[2922]! }
    public func Call_PrivacyErrorMessage(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2923]!, self._r[2923]!, [_0])
    }
    public var Settings_CopyPhoneNumber: String { return self._s[2924]! }
    public var NotificationsSound_Keys: String { return self._s[2925]! }
    public func Call_ParticipantVersionOutdatedError(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2926]!, self._r[2926]!, [_0])
    }
    public var Notification_MessageLifetime1w: String { return self._s[2927]! }
    public var Message_Video: String { return self._s[2928]! }
    public var AutoDownloadSettings_CellularTitle: String { return self._s[2929]! }
    public func PUSH_CHANNEL_MESSAGE_PHOTO(_ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2930]!, self._r[2930]!, [_1])
    }
    public func Notification_JoinedChat(_ _0: String) -> (String, [(Int, NSRange)]) {
    ...
    public var Passport_Language_mk: String { return self._s[2935]! }
    public var CreatePoll_CancelConfirmation: String { return self._s[2936]! }
    public var Conversation_SilentBroadcastTooltipOn: String { return self._s[2938]! }
    public var PrivacyPolicy_Decline: String { return self._s[2939]! }
    public var Passport_Identity_DoesNotExpire: String { return self._s[2940]! }
    public var Channel_AdminLogFilter_EventsRestrictions: String { return self._s[2941]! }
    public var Permissions_SiriAllow_v0: String { return self._s[2943]! }
    public func LOCAL_CHAT_MESSAGE_FWDS(_ _1: String, _ _2: Int) -> (String, [(Int, NSRange)]) {
    ...
    public var Paint_Regular: String { return self._s[2946]! }
    public var ChatSettings_AutoDownloadReset: String { return self._s[2947]! }
    public var SocksProxySetup_ShareLink: String { return self._s[2948]! }
    public var BlockedUsers_SelectUserTitle: String { return self._s[2949]! }
    public var GroupInfo_InviteByLink: String { return self._s[2951]! }
    public var MessageTimer_Custom: String { return self._s[2952]! }
    public var UserInfo_NotificationsDefaultEnabled: String { return self._s[2953]! }
    public var Passport_Address_TypeTemporaryRegistration: String { return self._s[2955]! }
    public var ChatSettings_AutoDownloadUsingWiFi: String { return self._s[2956]! }
    public var Channel_Username_InvalidTaken: String { return self._s[2957]! }
    public var Conversation_ClousStorageInfo_Description3: String { return self._s[2958]! }
    public var Settings_ChatBackground: String { return self._s[2959]! }
    public var Channel_Subscribers_Title: String { return self._s[2960]! }
    public var ApplyLanguage_ChangeLanguageTitle: String { return self._s[2961]! }
    public var Watch_ConnectionDescription: String { return self._s[2962]! }
    public var Wallpaper_ResetWallpapers: String { return self._s[2966]! }
    public var EditProfile_Title: String { return self._s[2967]! }
    public var NotificationsSound_Bamboo: String { return self._s[2969]! }
    public var Channel_AdminLog_MessagePreviousMessage: String { return self._s[2971]! }
    public var Login_SmsRequestState2: String { return self._s[2972]! }
    public var Passport_Language_ar: String { return self._s[2973]! }
    public var SettingsSearch_Synonyms_EditProfile_Title: String { return self._s[2974]! }
    public var Conversation_MessageDialogEdit: String { return self._s[2975]! }
    public func PUSH_AUTH_UNKNOWN(_ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2976]!, self._r[2976]!, [_1])
    }
    public var Common_Close: String { return self._s[2977]! }
    public var SettingsSearch_Synonyms_Notifications_GroupNotificationsPreview: String { return self._s[2978]! }
    public func Channel_AdminLog_MessageToggleInvitesOff(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2982]!, self._r[2982]!, [_0])
    }
    public var UserInfo_About_Placeholder: String { return self._s[2983]! }
    public func Conversation_FileHowToText(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2984]!, self._r[2984]!, [_0])
    }
    public var GroupInfo_Permissions_SectionTitle: String { return self._s[2985]! }
    public var Channel_Info_Banned: String { return self._s[2987]! }
    public func Time_MonthOfYear_m11(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2988]!, self._r[2988]!, [_0])
    }
    public var Appearance_Other: String { return self._s[2989]! }
    public var Passport_Language_my: String { return self._s[2990]! }
    public var Group_Setup_BasicHistoryHiddenHelp: String { return self._s[2991]! }
    public func Time_PreciseDate_m9(_ _1: String, _ _2: String, _ _3: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2992]!, self._r[2992]!, [_1, _2, _3])
    }
    public var SettingsSearch_Synonyms_Privacy_PasscodeAndFaceId: String { return self._s[2993]! }
    public var Preview_CopyAddress: String { return self._s[2994]! }
    public func DialogList_SinglePlayingGameSuffix(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2995]!, self._r[2995]!, [_0])
    }
    public var KeyCommand_JumpToPreviousChat: String { return self._s[2996]! }
    public var UserInfo_BotSettings: String { return self._s[2997]! }
    public var LiveLocation_MenuStopAll: String { return self._s[2999]! }
    public var Passport_PasswordCreate: String { return self._s[3000]! }
    public var StickerSettings_MaskContextInfo: String { return self._s[3001]! }
    public var Message_PinnedLocationMessage: String { return self._s[3002]! }
    public var Map_Satellite: String { return self._s[3003]! }
    public var Watch_Message_Unsupported: String { return self._s[3004]! }
    public var Username_TooManyPublicUsernamesError: String { return self._s[3005]! }
    public var TwoStepAuth_EnterPasswordInvalid: String { return self._s[3006]! }
    public func Notification_PinnedTextMessage(_ _0: String, _ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[3007]!, self._r[3007]!, [_0, _1])
    }
    public var Notifications_ChannelNotificationsHelp: String { return self._s[3008]! }
    public var Privacy_Calls_P2PContacts: String { return self._s[3009]! }
    public var NotificationsSound_None: String { return self._s[3010]! }
    public var AccessDenied_VoiceMicrophone: String { return self._s[3012]! }
    public func ApplyLanguage_ChangeLanguageAlreadyActive(_ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[3013]!, self._r[3013]!, [_1])
    }
    public var Cache_Indexing: String { return self._s[3014]! }
    public var DialogList_RecentTitlePeople: String { return self._s[3016]! }
    public var DialogList_EncryptionRejected: String { return self._s[3017]! }
    public var GroupInfo_Administrators: String { return self._s[3018]! }
    public var Passport_ScanPassportHelp: String { return self._s[3019]! }
    public var Application_Name: String { return self._s[3020]! }
    public var Channel_AdminLogFilter_ChannelEventsInfo: String { return self._s[3021]! }
    public var Passport_Identity_TranslationHelp: String { return self._s[3023]! }
    public func Notification_JoinedGroupByLink(_ _0: String) -> (String, [(Int, NSRange)]) {
    ...
    public var Channel_EditAdmin_PermissionDeleteMessages: String { return self._s[3026]! }
    public var Privacy_ChatsTitle: String { return self._s[3027]! }
    public var DialogList_ClearHistoryConfirmation: String { return self._s[3028]! }
    public var SettingsSearch_Synonyms_Data_Storage_ClearCache: String { return self._s[3029]! }
    public var Watch_Suggestion_HoldOn: String { return self._s[3030]! }
    public var SocksProxySetup_RequiredCredentials: String { return self._s[3031]! }
    public var Passport_Address_TypeRentalAgreementUploadScan: String { return self._s[3032]! }
    public var TwoStepAuth_EmailSkipAlert: String { return self._s[3033]! }
    public var Channel_Setup_TypePublic: String { return self._s[3036]! }
    public func Channel_AdminLog_MessageToggleInvitesOn(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[3037]!, self._r[3037]!, [_0])
    }
    public var Channel_TypeSetup_Title: String { return self._s[3039]! }
    public var Map_OpenInMaps: String { return self._s[3041]! }
    public func PUSH_PINNED_NOTEXT(_ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[3042]!, self._r[3042]!, [_1])
    }
    public var NotificationsSound_Tremolo: String { return self._s[3044]! }
    public func Date_ChatDateHeaderYear(_ _1: String, _ _2: String, _ _3: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[3045]!, self._r[3045]!, [_1, _2, _3])
    }
    public var ConversationProfile_UnknownAddMemberError: String { return self._s[3046]! }
    public var Passport_PasswordHelp: String { return self._s[3047]! }
    public var Login_CodeExpiredError: String { return self._s[3048]! }
    public var Channel_EditAdmin_PermissionChangeInfo: String { return self._s[3049]! }
    public var Conversation_TitleUnmute: String { return self._s[3050]! }
    public var Passport_Identity_ScansHelp: String { return self._s[3051]! }
    public var Passport_Language_lo: String { return self._s[3052]! }
    public var Camera_FlashAuto: String { return self._s[3053]! }
    public var Common_Cancel: String { return self._s[3054]! }
    public var DialogList_SavedMessagesTooltip: String { return self._s[3055]! }
    public var TwoStepAuth_SetupPasswordTitle: String { return self._s[3056]! }
    public func PUSH_MESSAGE_FWD(_ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[3057]!, self._r[3057]!, [_1])
    }
    public var Conversation_ReportSpamConfirmation: String { return self._s[3058]! }
    public var ChatSettings_Title: String { return self._s[3060]! }
    public var Passport_PasswordReset: String { return self._s[3061]! }
    public var SocksProxySetup_TypeNone: String { return self._s[3062]! }
    public var PhoneNumberHelp_Help: String { return self._s[3064]! }
    public var Checkout_EnterPassword: String { return self._s[3065]! }
    public var Share_AuthTitle: String { return self._s[3067]! }
    public var Activity_UploadingDocument: String { return self._s[3068]! }
    public var State_Connecting: String { return self._s[3069]! }
    public var Profile_MessageLifetime1w: String { return self._s[3070]! }
    public var Conversation_ContextMenuReport: String { return self._s[3071]! }
    public var CheckoutInfo_ReceiverInfoPhone: String { return self._s[3072]! }
    public var AutoNightTheme_ScheduledTo: String { return self._s[3073]! }
    public var AuthSessions_Terminate: String { return self._s[3074]! }
    public var Checkout_NewCard_CardholderNamePlaceholder: String { return self._s[3075]! }
    public var KeyCommand_JumpToPreviousUnreadChat: String { return self._s[3076]! }
    public var PhotoEditor_Set: String { return self._s[3077]! }
    public var EmptyGroupInfo_Title: String { return self._s[3078]! }
    public var Login_PadPhoneHelp: String { return self._s[3079]! }
    public var AutoDownloadSettings_TypeGroupChats: String { return self._s[3081]! }
    public var PrivacyPolicy_DeclineLastWarning: String { return self._s[3083]! }
    public var NotificationsSound_Complete: String { return self._s[3084]! }
    public var SettingsSearch_Synonyms_Privacy_Data_Title: String { return self._s[3085]! }
    public var Group_Info_AdminLog: String { return self._s[3086]! }
    public var GroupPermission_NotAvailableInPublicGroups: String { return self._s[3087]! }
    public var Channel_AdminLog_InfoPanelAlertText: String { return self._s[3088]! }
    public var Conversation_Admin: String { return self._s[3090]! }
    public var Conversation_GifTooltip: String { return self._s[3091]! }
    public var Passport_NotLoggedInMessage: String { return self._s[3092]! }
    public func AutoDownloadSettings_OnFor(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[3093]!, self._r[3093]!, [_0])
    }
    public var Profile_MessageLifetimeForever: String { return self._s[3094]! }
    public var SharedMedia_EmptyTitle: String { return self._s[3096]! }
    public var Channel_Edit_PrivatePublicLinkAlert: String { return self._s[3098]! }
    public var Username_Help: String { return self._s[3099]! }
    public var DialogList_LanguageTooltip: String { return self._s[3101]! }
    public var Map_LoadError: String { return self._s[3102]! }
    public var Login_PhoneNumberAlreadyAuthorized: String { return self._s[3103]! }
    public var Channel_AdminLog_AddMembers: String { return self._s[3104]! }
    public var Notification_Exceptions_NewException: String { return self._s[3105]! }
    public var TwoStepAuth_EmailTitle: String { return self._s[3106]! }
    public var WatchRemote_AlertText: String { return self._s[3107]! }
    public var ChatSettings_ConnectionType_Title: String { return self._s[3110]! }
    public func Settings_CheckPhoneNumberTitle(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[3111]!, self._r[3111]!, [_0])
    }
    public var SettingsSearch_Synonyms_Calls_CallTab: String { return self._s[3112]! }
    public var Passport_Address_CountryPlaceholder: String { return self._s[3113]! }
    public func DialogList_AwaitingEncryption(_ _0: String) -> (String, [(Int, NSRange)]) {
    ...
    public var Group_AdminLog_EmptyText: String { return self._s[3116]! }
    public var SettingsSearch_Synonyms_Appearance_Title: String { return self._s[3117]! }
    public var AccessDenied_VideoMicrophone: String { return self._s[3119]! }
    public var Conversation_ContextMenuStickerPackAdd: String { return self._s[3120]! }
    public var Cache_ClearNone: String { return self._s[3121]! }
    public var SocksProxySetup_FailedToConnect: String { return self._s[3122]! }
    public var Permissions_NotificationsTitle_v0: String { return self._s[3123]! }
    public func Channel_AdminLog_MessageEdited(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[3124]!, self._r[3124]!, [_0])
    }
    public var Passport_Identity_Country: String { return self._s[3125]! }
    public func ChatSettings_AutoDownloadSettings_TypeFile(_ _0: String) -> (String, [(Int, NSRange)]) {
    ...
    public var AccessDenied_Settings: String { return self._s[3128]! }
    public var Passport_Address_TypeUtilityBillUploadScan: String { return self._s[3129]! }
    public var Month_ShortMay: String { return self._s[3130]! }
    public var Compose_NewGroup: String { return self._s[3131]! }
    public var Group_Setup_TypePrivate: String { return self._s[3133]! }
    public var Login_PadPhoneHelpTitle: String { return self._s[3135]! }
    public var Appearance_ThemeDayClassic: String { return self._s[3136]! }
    public var Channel_AdminLog_MessagePreviousCaption: String { return self._s[3137]! }
    public var AutoDownloadSettings_OffForAll: String { return self._s[3138]! }
    public var Privacy_GroupsAndChannels_WhoCanAddMe: String { return self._s[3139]! }
    public var Conversation_typing: String { return self._s[3141]! }
    public var Paint_Masks: String { return self._s[3142]! }
    public var Username_InvalidTaken: String { return self._s[3143]! }
    public var Call_StatusNoAnswer: String { return self._s[3144]! }
    public var TwoStepAuth_EmailAddSuccess: String { return self._s[3145]! }
    public var SettingsSearch_Synonyms_Privacy_BlockedUsers: String { return self._s[3146]! }
    public var Passport_Identity_Selfie: String { return self._s[3147]! }
    public var Login_InfoLastNamePlaceholder: String { return self._s[3148]! }
    public var Privacy_SecretChatsLinkPreviewsHelp: String { return self._s[3149]! }
    public var Conversation_ClearSecretHistory: String { return self._s[3150]! }
    public var NetworkUsageSettings_Title: String { return self._s[3152]! }
    public var Your_cards_security_code_is_invalid: String { return self._s[3154]! }
    public func Notification_LeftChannel(_ _0: String) -> (String, [(Int, NSRange)]) {
    ...
    public var SaveIncomingPhotosSettings_From: String { return self._s[3159]! }
    public var Map_LiveLocationTitle: String { return self._s[3160]! }
    public var Login_InfoAvatarAdd: String { return self._s[3161]! }
    public var Passport_Identity_FilesView: String { return self._s[3162]! }
    public var UserInfo_GenericPhoneLabel: String { return self._s[3163]! }
    public var Privacy_Calls_NeverAllow: String { return self._s[3164]! }
    public func Contacts_AddPhoneNumber(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[3165]!, self._r[3165]!, [_0])
    }
    public var TwoStepAuth_ConfirmationText: String { return self._s[3166]! }
    public var ChatSettings_AutomaticVideoMessageDownload: String { return self._s[3167]! }
    public func PUSH_CHAT_MESSAGE_VIDEOS(_ _1: String, _ _2: String, _ _3: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[3168]!, self._r[3168]!, [_1, _2, _3])
    }
    public var Channel_AdminLogFilter_AdminsAll: String { return self._s[3169]! }
    public var Tour_Title2: String { return self._s[3170]! }
    public var Conversation_FileOpenIn: String { return self._s[3171]! }
    public var Checkout_ErrorPrecheckoutFailed: String { return self._s[3172]! }
    public var Wallpaper_Set: String { return self._s[3173]! }
    public var Passport_Identity_Translations: String { return self._s[3175]! }
    public func Channel_AdminLog_MessageChangedChannelAbout(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[3176]!, self._r[3176]!, [_0])
    }
    public var Channel_LeaveChannel: String { return self._s[3177]! }
    public func PINNED_INVOICE(_ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[3178]!, self._r[3178]!, [_1])
    }
    public var SettingsSearch_Synonyms_Proxy_AddProxy: String { return self._s[3179]! }
    public var PhotoEditor_HighlightsTint: String { return self._s[3180]! }
    public var Passport_Email_Delete: String { return self._s[3181]! }
    public var Conversation_Mute: String { return self._s[3183]! }
    public var Channel_AdminLog_CanSendMessages: String { return self._s[3185]! }
    public func Notification_PassportValuesSentMessage(_ _1: String, _ _2: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[3187]!, self._r[3187]!, [_1, _2])
    }
    public var Calls_CallTabDescription: String { return self._s[3188]! }
    public var Passport_Identity_NativeNameHelp: String { return self._s[3189]! }
    public var Common_No: String { return self._s[3190]! }
    public var Weekday_Sunday: String { return self._s[3191]! }
    public var Notification_Reply: String { return self._s[3192]! }
    public var Conversation_ViewMessage: String { return self._s[3193]! }
    public func Checkout_SavePasswordTimeoutAndFaceId(_ _0: String) -> (String, [(Int, NSRange)]) {
    ...
    public var SettingsSearch_Synonyms_EditProfile_AddAccount: String { return self._s[3196]! }
    public var Message_PinnedDocumentMessage: String { return self._s[3197]! }
    public var DialogList_TabTitle: String { return self._s[3199]! }
    public var ChatSettings_AutoPlayTitle: String { return self._s[3200]! }
    public var Passport_FieldEmail: String { return self._s[3201]! }
    public var Conversation_UnpinMessageAlert: String { return self._s[3202]! }
    public var Passport_Address_TypeBankStatement: String { return self._s[3203]! }
    public var Passport_Identity_ExpiryDate: String { return self._s[3204]! }
    public var Privacy_Calls_P2P: String { return self._s[3205]! }
    public func CancelResetAccount_Success(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[3207]!, self._r[3207]!, [_0])
    }
    public var SocksProxySetup_UseForCallsHelp: String { return self._s[3208]! }
    public func PUSH_CHAT_ALBUM(_ _1: String, _ _2: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[3209]!, self._r[3209]!, [_1, _2])
    }
    public var Stickers_ClearRecent: String { return self._s[3210]! }
    public var EnterPasscode_ChangeTitle: String { return self._s[3211]! }
    public var Passport_InfoText: String { return self._s[3212]! }
    public var Checkout_NewCard_SaveInfoEnableHelp: String { return self._s[3213]! }
    public func Login_InvalidPhoneEmailSubject(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[3214]!, self._r[3214]!, [_0])
    }
    public func Time_PreciseDate_m3(_ _1: String, _ _2: String, _ _3: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[3215]!, self._r[3215]!, [_1, _2, _3])
    }
    public var SettingsSearch_Synonyms_Notifications_BadgeIncludeMutedChannels: String { return self._s[3216]! }
    public var Passport_Identity_EditDriversLicense: String { return self._s[3217]! }
    public var Conversation_TapAndHoldToRecord: String { return self._s[3219]! }
    public var SettingsSearch_Synonyms_Notifications_BadgeIncludeMutedChats: String { return self._s[3220]! }
    public func Notification_CallTimeFormat(_ _1: String, _ _2: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[3221]!, self._r[3221]!, [_1, _2])
    }
    public var Channel_EditAdmin_PermissionInviteViaLink: String { return self._s[3223]! }
    public func Generic_OpenHiddenLinkAlert(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[3225]!, self._r[3225]!, [_0])
    }
    public var DialogList_Unread: String { return self._s[3226]! }
    public func PUSH_CHAT_MESSAGE_GIF(_ _1: String, _ _2: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[3227]!, self._r[3227]!, [_1, _2])
    }
    public var User_DeletedAccount: String { return self._s[3228]! }
    public func Watch_Time_ShortYesterdayAt(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[3229]!, self._r[3229]!, [_0])
    }
    public var UserInfo_NotificationsDefault: String { return self._s[3230]! }
    public var SharedMedia_CategoryMedia: String { return self._s[3231]! }
    public var SocksProxySetup_ProxyStatusUnavailable: String { return self._s[3232]! }
    public var Channel_AdminLog_MessageRestrictedForever: String { return self._s[3233]! }
    public var Watch_ChatList_Compose: String { return self._s[3234]! }
    public var Notifications_MessageNotificationsExceptionsHelp: String { return self._s[3235]! }
    public var AutoDownloadSettings_Delimeter: String { return self._s[3236]! }
    public var Watch_Microphone_Access: String { return self._s[3237]! }
    public var Group_Setup_HistoryHeader: String { return self._s[3238]! }
    public var Activity_UploadingPhoto: String { return self._s[3239]! }
    public var Conversation_Edit: String { return self._s[3241]! }
    public var Group_ErrorSendRestrictedMedia: String { return self._s[3242]! }
    public var Login_TermsOfServiceDecline: String { return self._s[3243]! }
    public var Message_PinnedContactMessage: String { return self._s[3244]! }
    public func Channel_AdminLog_MessageRestrictedNameUsername(_ _1: String, _ _2: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[3245]!, self._r[3245]!, [_1, _2])
    }
    public func Login_PhoneBannedEmailBody(_ _1: String, _ _2: String, _ _3: String, _ _4: String, _ _5: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[3246]!, self._r[3246]!, [_1, _2, _3, _4, _5])
    }
    public var Appearance_LargeEmoji: String { return self._s[3247]! }
    public var TwoStepAuth_AdditionalPassword: String { return self._s[3249]! }
    public func PUSH_CHAT_DELETE_YOU(_ _1: String, _ _2: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[3250]!, self._r[3250]!, [_1, _2])
    }
    public var Passport_Phone_EnterOtherNumber: String { return self._s[3251]! }
    public var Message_PinnedPhotoMessage: String { return self._s[3252]! }
    public var Passport_FieldPhone: String { return self._s[3253]! }
    public var TwoStepAuth_RecoveryEmailAddDescription: String { return self._s[3254]! }
    public var ChatSettings_AutoPlayGifs: String { return self._s[3255]! }
    public var InfoPlist_NSCameraUsageDescription: String { return self._s[3257]! }
    public var Conversation_Call: String { return self._s[3258]! }
    public var Common_TakePhoto: String { return self._s[3260]! }
    public var Channel_NotificationLoading: String { return self._s[3261]! }
    public func Notification_Exceptions_Sound(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[3262]!, self._r[3262]!, [_0])
    }
    public func PUSH_CHANNEL_MESSAGE_VIDEO(_ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[3263]!, self._r[3263]!, [_1])
    }
    public var Permissions_SiriTitle_v0: String { return self._s[3264]! }
    public func Login_ResetAccountProtected_Text(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[3265]!, self._r[3265]!, [_0])
    }
    public var Channel_MessagePhotoRemoved: String { return self._s[3266]! }
    public var Common_edit: String { return self._s[3267]! }
    public var PrivacySettings_AuthSessions: String { return self._s[3268]! }
    public var Month_ShortJune: String { return self._s[3269]! }
    public var PrivacyLastSeenSettings_AlwaysShareWith_Placeholder: String { return self._s[3270]! }
    public var Call_ReportSend: String { return self._s[3271]! }
    public var Watch_LastSeen_JustNow: String { return self._s[3272]! }
    public var Notifications_MessageNotifications: String { return self._s[3273]! }
    public var WallpaperSearch_ColorGreen: String { return self._s[3274]! }
    public var BroadcastListInfo_AddRecipient: String { return self._s[3276]! }
    public var Group_Status: String { return self._s[3277]! }
    public func AutoNightTheme_LocationHelp(_ _0: String, _ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[3278]!, self._r[3278]!, [_0, _1])
    }
    public var ShareMenu_ShareTo: String { return self._s[3279]! }
    public var Conversation_Moderate_Ban: String { return self._s[3280]! }
    public func Conversation_DeleteMessagesFor(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[3281]!, self._r[3281]!, [_0])
    }
    public var SharedMedia_ViewInChat: String { return self._s[3282]! }
    public var Map_LiveLocationFor8Hours: String { return self._s[3283]! }
    public func PUSH_PINNED_PHOTO(_ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[3284]!, self._r[3284]!, [_1])
    }
    public func PUSH_PINNED_POLL(_ _1: String, _ _2: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[3285]!, self._r[3285]!, [_1, _2])
    }
    public func Map_AccurateTo(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[3287]!, self._r[3287]!, [_0])
    }
    public var Map_OpenInHereMaps: String { return self._s[3288]! }
    public var Appearance_ReduceMotion: String { return self._s[3289]! }
    public func PUSH_MESSAGE_TEXT(_ _1: String, _ _2: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[3290]!, self._r[3290]!, [_1, _2])
    }
    public var Channel_Setup_TypePublicHelp: String { return self._s[3291]! }
    public var Passport_Identity_EditInternalPassport: String { return self._s[3292]! }
    public var PhotoEditor_Skip: String { return self._s[3293]! }
    public func MessageTimer_Hours(_ value: Int32) -> String {
>>>>>>> New passcode entry screen
...
<<<<<<< HEAD
    public func PUSH_CHAT_MESSAGES(_ selector: Int32, _ _2: String, _ _1: String, _ _3: Int32) -> String {
        ...
        return String(format: self._ps[7 * 6 + Int(form.rawValue)]!, _2, _1, _3)
    }
