...
public final class PresentationStrings {
    ...
    public var Channel_AdminLog_InfoPanelAlertText: String { return self._s[2860]! }
    public var Conversation_Admin: String { return self._s[2862]! }
    public var Conversation_GifTooltip: String { return self._s[2863]! }
    public var Passport_NotLoggedInMessage: String { return self._s[2864]! }
    public var Profile_MessageLifetimeForever: String { return self._s[2865]! }
    public func MESSAGE_POLL_SEPARATED(_ _1: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2867]!, self._r[2867]!, [_1])
    }
    public var SharedMedia_EmptyTitle: String { return self._s[2868]! }
    public var Channel_Edit_PrivatePublicLinkAlert: String { return self._s[2869]! }
    public var Username_Help: String { return self._s[2870]! }
    public var DialogList_LanguageTooltip: String { return self._s[2872]! }
    public var Map_LoadError: String { return self._s[2873]! }
    public var Notification_Exceptions_NewException: String { return self._s[2874]! }
    public var TwoStepAuth_EmailTitle: String { return self._s[2875]! }
    public var WatchRemote_AlertText: String { return self._s[2876]! }
    public var ChatSettings_ConnectionType_Title: String { return self._s[2878]! }
    ...
    public var Passport_Address_CountryPlaceholder: String { return self._s[2881]! }
    ...
    public func Time_PreciseDate_m6(_ _1: String, _ _2: String, _ _3: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[2883]!, self._r[2883]!, [_1, _2, _3])
    }
    public var Group_AdminLog_EmptyText: String { return self._s[2884]! }
    public var AccessDenied_VideoMicrophone: String { return self._s[2886]! }
    public var Conversation_ContextMenuStickerPackAdd: String { return self._s[2887]! }
    public var Cache_ClearNone: String { return self._s[2888]! }
    public var SocksProxySetup_FailedToConnect: String { return self._s[2889]! }
    public var Permissions_NotificationsTitle_v0: String { return self._s[2890]! }
    ...
    public var Passport_Identity_Country: String { return self._s[2892]! }
    ...
    public var AccessDenied_Settings: String { return self._s[2894]! }
    public var Passport_Address_TypeUtilityBillUploadScan: String { return self._s[2895]! }
    public var Month_ShortMay: String { return self._s[2896]! }
    public var Compose_NewGroup: String { return self._s[2897]! }
    public var Group_Setup_TypePrivate: String { return self._s[2899]! }
    public var Login_PadPhoneHelpTitle: String { return self._s[2900]! }
    public var Appearance_ThemeDayClassic: String { return self._s[2901]! }
    public var Channel_AdminLog_MessagePreviousCaption: String { return self._s[2902]! }
    public var Privacy_GroupsAndChannels_WhoCanAddMe: String { return self._s[2903]! }
    public var Conversation_typing: String { return self._s[2905]! }
    public var Paint_Masks: String { return self._s[2906]! }
    ...
    public var Username_InvalidTaken: String { return self._s[2908]! }
    ...
    public var Permissions_SiriTitle_v0: String { return self._s[3017]! }
    ...
    public var Channel_MessagePhotoRemoved: String { return self._s[3019]! }
    public var Common_edit: String { return self._s[3020]! }
    public var PrivacySettings_AuthSessions: String { return self._s[3021]! }
    public var Month_ShortJune: String { return self._s[3022]! }
    public var PrivacyLastSeenSettings_AlwaysShareWith_Placeholder: String { return self._s[3023]! }
    public var Call_ReportSend: String { return self._s[3024]! }
    public var Watch_LastSeen_JustNow: String { return self._s[3025]! }
    public var Notifications_MessageNotifications: String { return self._s[3026]! }
    public var BroadcastListInfo_AddRecipient: String { return self._s[3028]! }
    public var Group_Status: String { return self._s[3029]! }
    ...
    public var ShareMenu_ShareTo: String { return self._s[3031]! }
    public var Conversation_Moderate_Ban: String { return self._s[3032]! }
    ...
    public var SharedMedia_ViewInChat: String { return self._s[3034]! }
    public var Map_LiveLocationFor8Hours: String { return self._s[3035]! }
    public func Map_AccurateTo(_ _0: String) -> (String, [(Int, NSRange)]) {
        return formatWithArgumentRanges(self._s[3037]!, self._r[3037]!, [_0])
    }
    public var Appearance_ReduceMotion: String { return self._s[3038]! }
    public var Map_OpenInHereMaps: String { return self._s[3039]! }
    public var Channel_Setup_TypePublicHelp: String { return self._s[3040]! }
    public var Passport_Identity_EditInternalPassport: String { return self._s[3041]! }
    public var PhotoEditor_Skip: String { return self._s[3042]! }
