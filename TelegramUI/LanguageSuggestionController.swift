...
struct LanguageSuggestionControllerStrings {
    ...
    init(localization: SuggestedLocalizationInfo) {
    ...
    static let keys: [String] = ["Localization.ChooseLanguage",
...
func languageSuggestionController(context: AccountContext, suggestedLocalization: SuggestedLocalizationInfo, currentLanguageCode: String, openSelection: @escaping () -> Void) -> AlertController? {
    ...
    let contentNode = LanguageSuggestionAlertContentNode(theme: theme, strings: strings, englishStrings: englishStrings, suggestedLocalization: localization, openSelection: {
        ...
        if languageCode == currentLanguageCode {
            ...
            startActivity()
            disposable.set((downloadAndApplyLocalization(postbox: context.account.postbox, network: context.account.network, languageCode: languageCode)
