...
final class InstantPageController: ViewController {
    ...
    override public func loadDisplayNode() {
        self.displayNode = InstantPageControllerNode(account: self.account, settings: self.settings, presentationTheme: self.presentationData.theme, strings: self.presentationData.strings, timeFormat: self.presentationData.timeFormat, statusBar: self.statusBar, getNavigationController: { [weak self] in
