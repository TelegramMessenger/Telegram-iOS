...
final class PostboxTransaction {
    ...
    let currentPeerIdsWithHoleUpdates: Set<PeerId>
    ...
    var isEmpty: Bool {
        ...
        if !currentPeerIdsWithHoleUpdates.isEmpty {
            return false
        }
