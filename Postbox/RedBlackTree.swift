...
public class RBTree {
    ...
    private func depth(_ rooty: RBTNode?) -> Int {
        if rooty == nil {
            return 0
        } else {
    ...
    private func inOrder(_ root: RBTNode?) {
        if self.root == nil {
    ...
    /*
     ...
     [Set P's parent to Q]
     */
    private func leftRotate(_ x: RBTNode) {
        let newRoot = x.right!
    ...
    /*
     ...
     [Set Q's parent to P]
     */
    private func rightRotate(_ x: RBTNode) {
        let newRoot = x.left!
    ...
    private func insertCase2(_ inserted: RBTNode?) {
    ...
    private func insertCase3(_ inserted: RBTNode?) {
    ...
    private func insertCase4(_ insert: RBTNode?) {
        var inserted = insert
    ...
    private func insertCase5(_ inserted: RBTNode?) {
    ...
    private func insert(_ value: Int, parent: RBTNode) {
        if self.root == nil {
    ...
    public func replaceNode(_ n1: RBTNode, n2: RBTNode) {
        let temp = n1.data
    ...
    public func minimum(_ node: RBTNode) -> RBTNode {
    ...
    public func successor(_ node: RBTNode) -> RBTNode? {
    ...
    public func predecessor(_ node: RBTNode) -> RBTNode {
    ...
    public func maximum(_ rootnode: RBTNode) -> RBTNode {
    ...
    public func delete(_ x: Int) {
        let toDel = find(x)
        deleteNode(toDel!)
    }
    //Function call for removing a node
    private func deleteNode(_ todel: RBTNode?) {
        var toDel = todel
    ...
    private func deleteCase1(_ toDel: RBTNode?) {
        if toDel?.parent === nil {
            return
        } else {
            deleteCase2(toDel)
    ...
    private func deleteCase2(_ toDel: RBTNode?) {
    ...
    private func deleteCase3(_ toDel: RBTNode?) {
    ...
    private func deleteCase4(_ toDel: RBTNode?) {
    ...
    private func deleteCase5(_ toDel: RBTNode?) {
        if toDel! === toDel!.parent?.left &&
            toDel!.sibling()?.color == false &&
    ...
    private func deleteCase6(_ toDel: RBTNode?) {
