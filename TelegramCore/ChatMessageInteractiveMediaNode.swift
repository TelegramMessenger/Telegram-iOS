...
final class ChatMessageInteractiveMediaNode: ASTransformNode {
    ...
    func asyncLayout() -> (account: Account, media: Media, corners: ImageCorners, automaticDownload: Bool, constrainedSize: CGSize) -> (CGFloat, (CGSize) -> (CGFloat, (CGFloat) -> (CGSize, () -> Void))) {
    ...
    static func asyncLayout(_ node: ChatMessageInteractiveMediaNode?) -> (account: Account, media: Media, corners: ImageCorners, automaticDownload: Bool, constrainedSize: CGSize) -> (CGFloat, (CGSize) -> (CGFloat, (CGFloat) -> (CGSize, () -> ChatMessageInteractiveMediaNode))) {
        let currentAsyncLayout = node?.asyncLayout()
        
        return { account, media, corners, automaticDownload, constrainedSize in
            var imageNode: ChatMessageInteractiveMediaNode
            var imageLayout: (account: Account, media: Media, corners: ImageCorners, automaticDownload: Bool, constrainedSize: CGSize) -> (CGFloat, (CGSize) -> (CGFloat, (CGFloat) -> (CGSize, () -> Void)))
            ...
            let (initialWidth, continueLayout) = imageLayout(account: account, media: media, corners: corners, automaticDownload: automaticDownload, constrainedSize: constrainedSize)
