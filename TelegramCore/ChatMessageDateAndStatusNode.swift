...
class ChatMessageDateAndStatusNode: ASTransformLayerNode {
    ...
    func asyncLayout() -> (dateText: String, type: ChatMessageDateAndStatusType, constrainedSize: CGSize) -> (CGSize, () -> Void) {
        ...
        return { dateText, type, constrainedSize in
            ...
            let (date, dateApply) = dateLayout(attributedString: NSAttributedString(string: dateText, font: dateFont, textColor: dateColor), backgroundColor: nil, maximumNumberOfLines: 1, truncationType: .end, constrainedSize: constrainedSize, cutout: nil)
