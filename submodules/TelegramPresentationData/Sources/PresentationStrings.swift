...
public final class PresentationStrings: Equatable {
    ...
    public var ChatList_Search_FilterChats: String { return self._s[4309]! }
    public var WatchRemote_NotificationText: String { return self._s[4310]! }
    public var EditTheme_ChangeColors: String { return self._s[4311]! }
    public var GroupRemoved_ViewUserInfo: String { return self._s[4312]! }
    public var Wallet_TransactionInfo_RecipientHeader: String { return self._s[4313]! }
    public var CallSettings_OnMobile: String { return self._s[4315]! }
    public var Month_ShortFebruary: String { return self._s[4317]! }
    public var VoiceOver_MessageContextReply: String { return self._s[4318]! }
    ...
    public var Group_Location_ChangeLocation: String { return self._s[4320]! }
    public var Passport_Address_TypeBankStatementUploadScan: String { return self._s[4321]! }
    public var Wallet_Send_EncryptComment: String { return self._s[4322]! }
    public var VoiceOver_Media_PlaybackStop: String { return self._s[4323]! }
    public var SettingsSearch_Synonyms_Data_SaveIncomingPhotos: String { return self._s[4324]! }
    ...
    public var PhotoEditor_WarmthTool: String { return self._s[4327]! }
    public var Login_InfoAvatarPhoto: String { return self._s[4328]! }
    public var Notification_Exceptions_NewException_MessagePreviewHeader: String { return self._s[4329]! }
    public var Permissions_CellularDataAllowInSettings_v0: String { return self._s[4330]! }
    public var Map_PlacesInThisArea: String { return self._s[4331]! }
    public var VoiceOver_Chat_ContactEmail: String { return self._s[4332]! }
    public var Notifications_InAppNotificationsSounds: String { return self._s[4333]! }
    ...
    public var ShareMenu_Send: String { return self._s[4335]! }
    public var Username_InvalidStartsWithNumber: String { return self._s[4336]! }
    public var Appearance_AppIconClassicX: String { return self._s[4337]! }
    ...
    public var Conversation_StopPoll: String { return self._s[4339]! }
    public var InfoPlist_NSLocationAlwaysUsageDescription: String { return self._s[4341]! }
    public var Passport_Identity_EditIdentityCard: String { return self._s[4342]! }
    public var Appearance_ThemePreview_ChatList_3_Name: String { return self._s[4343]! }
    public var Wallet_WordCheck_Title: String { return self._s[4344]! }
    public var Conversation_Timer_Title: String { return self._s[4345]! }
    public var Common_Next: String { return self._s[4346]! }
    public var Notification_Exceptions_NewException: String { return self._s[4347]! }
    ...
    public var AccessDenied_CallMicrophone: String { return self._s[4349]! }
    public var SettingsSearch_Synonyms_Data_AutoDownloadUsingCellular: String { return self._s[4350]! }
    public var ChangePhoneNumberCode_Help: String { return self._s[4351]! }
    public var Passport_Identity_OneOfTypeIdentityCard: String { return self._s[4352]! }
    public var Channel_AdminLogFilter_EventsLeaving: String { return self._s[4353]! }
    public var BlockedUsers_LeavePrefix: String { return self._s[4354]! }
    ...
    public var Group_About_Help: String { return self._s[4356]! }
    public var TwoStepAuth_ChangePasswordDescription: String { return self._s[4357]! }
    public var Tour_Title3: String { return self._s[4358]! }
    public var Watch_Conversation_Unblock: String { return self._s[4359]! }
    public var Watch_UserInfo_Block: String { return self._s[4360]! }
    public var Notifications_ChannelNotificationsAlert: String { return self._s[4361]! }
    public var TwoFactorSetup_Hint_Action: String { return self._s[4362]! }
    public var IntentsSettings_SuggestedChatsInfo: String { return self._s[4363]! }
    public var Wallet_Alert_Cancel: String { return self._s[4364]! }
    public var TextFormat_AddLinkTitle: String { return self._s[4365]! }
    public var GroupInfo_InviteLink_RevokeAlert_Revoke: String { return self._s[4366]! }
    public var TwoStepAuth_EnterPasswordTitle: String { return self._s[4367]! }
    public var FastTwoStepSetup_PasswordSection: String { return self._s[4368]! }
    public var Compose_ChannelMembers: String { return self._s[4369]! }
    public var Conversation_ForwardTitle: String { return self._s[4370]! }
    ...
    public var Conversation_PinnedPoll: String { return self._s[4373]! }
    ...
    public var SettingsSearch_Synonyms_EditProfile_AddAccount: String { return self._s[4375]! }
    public var Conversation_ContextMenuStickerPackAdd: String { return self._s[4376]! }
    public var Stats_Overview: String { return self._s[4377]! }
    public var Map_HomeAndWorkTitle: String { return self._s[4378]! }
    public var Wallet_Intro_Terms: String { return self._s[4379]! }
    ...
    public var Passport_Address_CityPlaceholder: String { return self._s[4381]! }
    public var InfoPlist_NSLocationAlwaysAndWhenInUseUsageDescription: String { return self._s[4382]! }
    public var Privacy_PhoneNumber: String { return self._s[4383]! }
    public var ChatList_Search_FilterFiles: String { return self._s[4384]! }
    public var ChatList_DeleteForEveryoneConfirmationAction: String { return self._s[4385]! }
    public var ChannelIntro_CreateChannel: String { return self._s[4386]! }
    public var Conversation_InputTextAnonymousPlaceholder: String { return self._s[4387]! }
    ...
    public var Conversation_MessageLeaveComment: String { return self._s[4510]! }
    public var UserInfo_TapToCall: String { return self._s[4511]! }
    public var EnterPasscode_EnterNewPasscodeNew: String { return self._s[4512]! }
    public var Conversation_ClearAll: String { return self._s[4514]! }
    public var UserInfo_NotificationsDefault: String { return self._s[4515]! }
    public var Wallet_Send_OwnAddressAlertText: String { return self._s[4516]! }
    public var Map_ChooseAPlace: String { return self._s[4517]! }
    ...
    public var GroupInfo_AddParticipantTitle: String { return self._s[4519]! }
    public var ChatList_PeerTypeNonContact: String { return self._s[4520]! }
    public var Conversation_SlideToCancel: String { return self._s[4521]! }
    public var Month_ShortJuly: String { return self._s[4522]! }
    public var SocksProxySetup_ProxyType: String { return self._s[4523]! }
    ...
    public var ChatList_EditFolders: String { return self._s[4525]! }
    public var TwoStepAuth_SetPasswordHelp: String { return self._s[4526]! }
    public var Wallet_Send_ConfirmationConfirm: String { return self._s[4528]! }
    public var Wallet_Created_ExportErrorTitle: String { return self._s[4529]! }
    ...
    public var Permissions_PeopleNearbyTitle_v0: String { return self._s[4531]! }
    public var ScheduledMessages_RemindersTitle: String { return self._s[4532]! }
    public var Your_cards_expiration_year_is_invalid: String { return self._s[4533]! }
    public var Wallet_Info_TransactionPendingHeader: String { return self._s[4535]! }
    public var UserInfo_ShareMyContactInfo: String { return self._s[4536]! }
    public var Passport_DeleteAddress: String { return self._s[4538]! }
    public var Passport_DeletePassportConfirmation: String { return self._s[4539]! }
    public var Passport_Identity_ReverseSide: String { return self._s[4540]! }
    public var CheckoutInfo_ErrorEmailInvalid: String { return self._s[4541]! }
    public var Login_InfoLastNamePlaceholder: String { return self._s[4542]! }
    public var Passport_FieldAddress: String { return self._s[4543]! }
    public var SettingsSearch_Synonyms_Calls_Title: String { return self._s[4544]! }
    public var Passport_Identity_ResidenceCountryPlaceholder: String { return self._s[4546]! }
    public var Map_Home: String { return self._s[4548]! }
    public var PollResults_Title: String { return self._s[4549]! }
    public var ArchivedChats_IntroText2: String { return self._s[4551]! }
    public var PasscodeSettings_SimplePasscodeHelp: String { return self._s[4552]! }
    public var VoiceOver_Chat_ContactPhoneNumber: String { return self._s[4553]! }
    public var CallFeedback_ReasonSilentRemote: String { return self._s[4555]! }
    public var Passport_Identity_AddPersonalDetails: String { return self._s[4557]! }
    public var Group_Info_AdminLog: String { return self._s[4559]! }
    public var ChatSettings_AutoPlayTitle: String { return self._s[4560]! }
    public var Appearance_Animations: String { return self._s[4561]! }
    public var Appearance_TextSizeSetting: String { return self._s[4562]! }
