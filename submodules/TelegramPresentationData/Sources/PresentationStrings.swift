...
public final class PresentationStrings: Equatable {
    ...
    public var SetupUsername_ChangeLinkWarningGroup: String { return self._s[3081]! }
    ...
    public var SetupUsername_ChangeNameWarningGroup: String { return self._s[3506]! }
    public var AutoDownloadSettings_TypeChannels: String { return self._s[3507]! }
    public var Channel_AboutItem: String { return self._s[3508]! }
    public var Privacy_GroupsAndChannels_AlwaysAllow_Placeholder: String { return self._s[3510]! }
    public var VoiceOver_Chat_VoiceMessage: String { return self._s[3511]! }
    public var GroupInfo_SharedMedia: String { return self._s[3512]! }
    ...
    public var Call_PhoneCallInProgressMessage: String { return self._s[3514]! }
    ...
    public var ChatList_UndoArchiveRevealedText: String { return self._s[3516]! }
    public var GroupInfo_InviteLink_RevokeAlert_Text: String { return self._s[3517]! }
    ...
    public var GroupInfo_Permissions_SearchPlaceholder: String { return self._s[3520]! }
    public var Group_UpgradeNoticeHeader: String { return self._s[3521]! }
    public var Channel_Management_AddModerator: String { return self._s[3522]! }
    public var AutoDownloadSettings_MaxFileSize: String { return self._s[3523]! }
    public var StickerPacksSettings_ShowStickersButton: String { return self._s[3524]! }
    public var Wallet_Info_RefreshErrorNetworkText: String { return self._s[3525]! }
    public var Theme_Colors_Background: String { return self._s[3526]! }
    public var NotificationsSound_Hello: String { return self._s[3529]! }
    public var SocksProxySetup_SavedProxies: String { return self._s[3531]! }
    public var Channel_Stickers_Placeholder: String { return self._s[3533]! }
    ...
    public var PrivacyPolicy_DeclineDeclineAndDelete: String { return self._s[3535]! }
    public var Channel_Management_AddModeratorHelp: String { return self._s[3536]! }
    public var ContactInfo_BirthdayLabel: String { return self._s[3537]! }
    public var ChangePhoneNumberCode_RequestingACall: String { return self._s[3538]! }
    public var AutoDownloadSettings_Channels: String { return self._s[3539]! }
    public var Passport_Language_mn: String { return self._s[3540]! }
    public var Settings_ChatFolders: String { return self._s[3541]! }
    public var Notifications_ResetAllNotificationsHelp: String { return self._s[3544]! }
    public var GroupInfo_Permissions_SlowmodeValue_Off: String { return self._s[3545]! }
    public var Passport_Language_ja: String { return self._s[3547]! }
    public var Settings_About_Title: String { return self._s[3548]! }
    public var Settings_NotificationsAndSounds: String { return self._s[3549]! }
    public var ChannelInfo_DeleteGroup: String { return self._s[3550]! }
    public var Settings_BlockedUsers: String { return self._s[3551]! }
    ...
    public var EditTheme_Create_Preview_OutgoingText: String { return self._s[3553]! }
    public var Wallet_Weekday_Today: String { return self._s[3554]! }
    public var ChatListFolderSettings_AddRecommended: String { return self._s[3555]! }
    public var AutoDownloadSettings_PreloadVideo: String { return self._s[3556]! }
    public var Widget_ApplicationLocked: String { return self._s[3557]! }
    public var Passport_Address_AddResidentialAddress: String { return self._s[3558]! }
    public var Channel_Username_Title: String { return self._s[3559]! }
    ...
    public var AttachmentMenu_File: String { return self._s[3562]! }
    public var AppleWatch_Title: String { return self._s[3563]! }
    public var Activity_RecordingVideoMessage: String { return self._s[3564]! }
    ...
    public var Theme_Colors_Messages: String { return self._s[3566]! }
    public var Weekday_Saturday: String { return self._s[3567]! }
    public var WallpaperPreview_SwipeColorsTopText: String { return self._s[3568]! }
    public var Profile_CreateEncryptedChatError: String { return self._s[3569]! }
    public var Common_Next: String { return self._s[3571]! }
    public var Channel_Stickers_YourStickers: String { return self._s[3573]! }
    public var Message_Theme: String { return self._s[3574]! }
    public var Call_AudioRouteHeadphones: String { return self._s[3575]! }
    public var TwoStepAuth_EnterPasswordForgot: String { return self._s[3577]! }
    public var Watch_Contacts_NoResults: String { return self._s[3579]! }
    public var PhotoEditor_TintTool: String { return self._s[3582]! }
    public var LoginPassword_ResetAccount: String { return self._s[3584]! }
    public var Settings_SavedMessages: String { return self._s[3585]! }
    public var SettingsSearch_Synonyms_Appearance_Animations: String { return self._s[3586]! }
    public var Bot_GenericSupportStatus: String { return self._s[3587]! }
    public var StickerPack_Add: String { return self._s[3588]! }
    public var Checkout_TotalAmount: String { return self._s[3589]! }
    public var Your_cards_number_is_invalid: String { return self._s[3590]! }
    public var SettingsSearch_Synonyms_Appearance_AutoNightTheme: String { return self._s[3591]! }
    public var VoiceOver_Chat_VideoMessage: String { return self._s[3592]! }
    ...
    public var ChatSettings_ConnectionType_UseSocks5: String { return self._s[3595]! }
    ...
    public var GroupInfo_InviteLink_ShareLink: String { return self._s[3599]! }
    public var StickerPack_Share: String { return self._s[3600]! }
    public var Passport_DeleteAddress: String { return self._s[3601]! }
    public var Settings_Passport: String { return self._s[3602]! }
    public var SharedMedia_EmptyFilesText: String { return self._s[3603]! }
    public var Conversation_DeleteMessagesForMe: String { return self._s[3604]! }
    public var PasscodeSettings_AutoLock_IfAwayFor_1hour: String { return self._s[3605]! }
    public var Contacts_PermissionsText: String { return self._s[3606]! }
    public var Group_Setup_HistoryVisible: String { return self._s[3607]! }
    public var Wallet_Month_ShortDecember: String { return self._s[3609]! }
    public var Channel_EditAdmin_PermissionEnabledByDefault: String { return self._s[3610]! }
    public var Passport_Address_AddRentalAgreement: String { return self._s[3611]! }
    public var SocksProxySetup_Title: String { return self._s[3612]! }
    public var Notification_Mute1h: String { return self._s[3613]! }
    ...
    public var NotificationSettings_ShowNotificationsAllAccountsInfoOff: String { return self._s[3615]! }
    ...
    public var FastTwoStepSetup_PasswordSection: String { return self._s[3617]! }
    public var NetworkUsageSettings_ResetStatsConfirmation: String { return self._s[3620]! }
    public var InfoPlist_NSFaceIDUsageDescription: String { return self._s[3622]! }
    public var DialogList_NoMessagesText: String { return self._s[3623]! }
    public var Privacy_ContactsResetConfirmation: String { return self._s[3624]! }
    public var Privacy_Calls_P2PHelp: String { return self._s[3625]! }
    public var Channel_DiscussionGroup_SearchPlaceholder: String { return self._s[3627]! }
    public var Your_cards_expiration_year_is_invalid: String { return self._s[3628]! }
    public var Common_TakePhotoOrVideo: String { return self._s[3629]! }
    public var Wallet_Words_Text: String { return self._s[3630]! }
    public var Call_StatusBusy: String { return self._s[3631]! }
    public var Conversation_PinnedMessage: String { return self._s[3632]! }
    public var AutoDownloadSettings_VoiceMessagesTitle: String { return self._s[3633]! }
    public var ChatList_EmptyChatListNewMessage: String { return self._s[3634]! }
    public var Wallet_Configuration_BlockchainNameChangedProceed: String { return self._s[3635]! }
    public var TwoStepAuth_SetupPasswordConfirmFailed: String { return self._s[3636]! }
    public var Undo_ChatCleared: String { return self._s[3637]! }
    public var AppleWatch_ReplyPresets: String { return self._s[3638]! }
    public var Passport_DiscardMessageDescription: String { return self._s[3640]! }
    public var Login_NetworkError: String { return self._s[3641]! }
    ...
    public var SocksProxySetup_PasswordPlaceholder: String { return self._s[3644]! }
    public var Wallet_WordCheck_ViewWords: String { return self._s[3646]! }
    public var Login_ResetAccountProtected_LimitExceeded: String { return self._s[3647]! }
    ...
    public var Call_ConnectionErrorMessage: String { return self._s[3650]! }
    public var VoiceOver_Chat_Music: String { return self._s[3651]! }
    public var ChatListFolder_CategoryContacts: String { return self._s[3652]! }
    public var SettingsSearch_Synonyms_Notifications_MessageNotificationsSound: String { return self._s[3653]! }
    public var Compose_GroupTokenListPlaceholder: String { return self._s[3655]! }
    public var ConversationMedia_Title: String { return self._s[3656]! }
    public var EncryptionKey_Title: String { return self._s[3658]! }
    public var TwoStepAuth_EnterPasswordTitle: String { return self._s[3659]! }
    public var Notification_Exceptions_AddException: String { return self._s[3660]! }
    public var PrivacySettings_BlockedPeersEmpty: String { return self._s[3661]! }
    public var Profile_MessageLifetime1m: String { return self._s[3662]! }
    ...
    public var Month_GenMay: String { return self._s[3664]! }
    ...
    public var PeopleNearby_Users: String { return self._s[3666]! }
    public var Wallet_Send_AddressInfo: String { return self._s[3667]! }
    public var ChannelMembers_WhoCanAddMembersAllHelp: String { return self._s[3668]! }
    public var AutoDownloadSettings_ResetSettings: String { return self._s[3669]! }
