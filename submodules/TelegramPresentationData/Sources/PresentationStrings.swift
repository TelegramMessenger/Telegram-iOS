...
public final class PresentationStrings: Equatable {
    ...
    public var InviteLink_ContextShare: String { return self._s[1929]! }
    public var Appearance_AppIconClassic: String { return self._s[1930]! }
    public var PhotoEditor_QualityTool: String { return self._s[1931]! }
    public var ClearCache_ClearCache: String { return self._s[1932]! }
    public var TwoFactorSetup_Password_PlaceholderConfirmPassword: String { return self._s[1933]! }
    public var AutoDownloadSettings_Videos: String { return self._s[1934]! }
    public var GroupPermission_Duration: String { return self._s[1935]! }
    public var ChatList_Read: String { return self._s[1936]! }
    ...
    public var CallFeedback_Send: String { return self._s[1938]! }
    public var Channel_Stickers_Searching: String { return self._s[1939]! }
    public var ScheduledMessages_ReminderNotification: String { return self._s[1940]! }
    public var FastTwoStepSetup_HintSection: String { return self._s[1941]! }
    public var ChatSettings_AutoDownloadVideoMessages: String { return self._s[1942]! }
    public var EditTheme_CreateTitle: String { return self._s[1943]! }
    public var Application_Name: String { return self._s[1944]! }
    public var Paint_Stickers: String { return self._s[1945]! }
    public var Appearance_ThemePreview_Chat_1_Text: String { return self._s[1946]! }
    public var Call_StatusFailed: String { return self._s[1947]! }
    public var Stickers_FavoriteStickers: String { return self._s[1948]! }
    public var ClearCache_Clear: String { return self._s[1949]! }
    public var Passport_Language_mn: String { return self._s[1950]! }
    public var WallpaperPreview_PreviewTopText: String { return self._s[1951]! }
    public var LogoutOptions_ClearCacheTitle: String { return self._s[1952]! }
    public var Call_VoiceOver_VideoCallOutgoing: String { return self._s[1954]! }
    ...
    public var ChatListFolderSettings_RecommendedNewFolder: String { return self._s[1962]! }
    public var UserInfo_ShareContact: String { return self._s[1963]! }
    public var Passport_Identity_NamePlaceholder: String { return self._s[1964]! }
