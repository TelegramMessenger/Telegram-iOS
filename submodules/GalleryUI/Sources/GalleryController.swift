    ...
    if let _ = media as? TelegramMediaImage {
        ...
        if file.isVideo {
            ...
            if file.isAnimated {
                ...
                if !"".isEmpty && context.sharedContext.immediateExperimentalUISettings.liveStreamV2 {
                ...
                } else if true || (file.mimeType == "video/mpeg4" || file.mimeType == "video/mov" || file.mimeType == "video/mp4") {
