...
public extension TelegramEngine {
    final class Messages {
        ...
        public func addPollAnswer(messageId: MessageId, text: String, entities: [MessageTextEntity] = [], opaqueIdentifier: Data, mediaReference: AnyMediaReference? = nil) -> Signal<TelegramMediaPoll?, RequestMessageSelectPollOptionError> {
            return _internal_addPollAnswer(account: self.account, messageId: messageId, text: text, entities: entities, opaqueIdentifier: opaqueIdentifier, mediaReference: mediaReference)
        }
