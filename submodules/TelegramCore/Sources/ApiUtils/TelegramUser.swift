...
extension PeerVerification {
    init(apiBotVerification: Api.BotVerification) {
        ...
        case let .botVerification(_, botId, iconFileId, companyName, customDescription):
            self.init(
