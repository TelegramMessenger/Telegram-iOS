...
public struct ApplicationSpecificSharedDataKeys {
    ...
    public static let quickReactionSettings = applicationSpecificSharedDataKey(ApplicationSpecificSharedDataKeyValues.quickReactionSettings.rawValue)
}
