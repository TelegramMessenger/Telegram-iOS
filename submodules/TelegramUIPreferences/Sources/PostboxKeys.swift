...
public struct ApplicationSpecificSharedDataKeys {
    ...
    public static let cloudballonSettings = applicationSpecificPreferencesKey(ApplicationSpecificSharedDataKeyValues.cloudballonSettings.rawValue)
}
