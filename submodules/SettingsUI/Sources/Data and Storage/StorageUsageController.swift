...
private func storageUsageControllerEntries(presentationData: PresentationData, cacheSettings: CacheStorageSettings, accountSpecificCacheSettings: AccountSpecificCacheStorageSettings, cacheStats: CacheUsageStatsResult?, state: StorageUsageState, inactiveSecretChatPeerIds: Set<PeerId>) -> [StorageUsageEntry] {
...
public func storageUsageController(context: AccountContext, cacheUsagePromise: Promise<CacheUsageStatsResult?>? = nil, isModal: Bool = false) -> ViewController {
    ...
    let signal = combineLatest(context.sharedContext.presentationData, cacheSettingsPromise.get(), accountSpecificCacheSettingsPromise.get(), statsPromise.get(), statePromise.get(), context.inactiveSecretChatPeerIds) |> deliverOnMainQueue
        |> map { presentationData, cacheSettings, accountSpecificCacheSettings, cacheStats, state, inactiveSecretChatPeerIds -> (ItemListControllerState, (ItemListNodeState, Any)) in
            ...
            let listState = ItemListNodeState(presentationData: ItemListPresentationData(presentationData), entries: storageUsageControllerEntries(presentationData: presentationData, cacheSettings: cacheSettings, accountSpecificCacheSettings: accountSpecificCacheSettings, cacheStats: cacheStats, state: state, inactiveSecretChatPeerIds: inactiveSecretChatPeerIds), style: .blocks, emptyStateItem: nil, animateChanges: false)
