                ...
                if let strongSelf = self {
                    ...
                    for icon in item.icons {
                        ...
                        if let image = UIImage(named: icon.imageName, in: getAppBundle(), compatibleWith: nil) {
                            ...
                            switch icon.name {
                                case "PrimaryIcon":
                                    name = item.strings.Appearance_AppIcon_Primary
                                case "YellowIcon":
                                    name = item.strings.Appearance_AppIcon_Yellow
                                case "OrangeIcon":
                                    name = item.strings.Appearance_AppIcon_Orange
                                case "RedIcon":
                                    name = item.strings.Appearance_AppIcon_Red
                                default:
                                    name = icon.name
                            }
