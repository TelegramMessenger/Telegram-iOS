...
public final class MessageStoryRenderer {
    private let context: AccountContext
    ...
    public func update(layout: ContainerViewLayout, completion: @escaping (UIImage?) -> Void) {
        ...
        Queue.mainQueue().after(0.55) {
            ...
            let finalImage = generateImage(CGSize(width: 1080, height: 1920), contextGenerator: { size, context in
    ...
    private func updateMessagesLayout(layout: ContainerViewLayout) {
        ...
        self.wallpaperBackgroundNode.frame = CGRect(origin: CGPoint(), size: layout.size)
