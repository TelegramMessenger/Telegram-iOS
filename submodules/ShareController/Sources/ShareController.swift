                        ...
                        for message in messages {
                            ...
                            for attribute in message.attributes {
                                if let attribute = attribute as? RestrictedContentMessageAttribute {
                                    ...
                                    let isAllowedShare = isAllowedShare(restrictionReason: attribute.platformText(platform: "ios", contentSettings: strongSelf.currentContext.currentContentSettings.with { $0 }, extractReason: true), contentSettings: strongSelf.currentContext.currentContentSettings.with { $0 })
