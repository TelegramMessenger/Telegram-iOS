...
public final class MediaStreamingControllerImpl: ViewController, VoiceChatController {
    enum DisplayMode {
    ...
    fileprivate final class Node: ViewControllerTracingNode, UIGestureRecognizerDelegate {
        ...
        private weak var controller: MediaStreamingControllerImpl?
        ...
        init(controller: MediaStreamingControllerImpl, sharedContext: SharedAccountContext, call: PresentationGroupCall) {
