...
class ContactsAddItem: ListViewItem {
    ...
    init(theme: PresentationTheme, strings: PresentationStrings, phoneNumber: String, header: ListViewItemHeader?, action: @escaping () -> Void) {
        self.theme = theme
