...
func handleTextLinkActionImpl(context: AccountContextImpl, peerId: PeerId?, navigateDisposable: MetaDisposable, controller: ViewController, action: TextLinkItemActionType, itemLink: TextLinkItem) {
