...
func generatePlayerRateIcon(_ color: UIColor) -> UIImage? {
...
struct PresentationResourcesRootController {
    ...
    static func navigationPlayerRateActiveIcon(_ theme: PresentationTheme) -> UIImage? {
    ...
    static func navigationPlayerRateInactiveIcon(_ theme: PresentationTheme) -> UIImage? {
