...
final class StoryAvatarInfoComponent: Component {
	...
	final class View: UIView {
        ...
        func update(component: StoryAvatarInfoComponent, availableSize: CGSize, state: EmptyComponentState, environment: Environment<Empty>, transition: ComponentTransition) -> CGSize {
