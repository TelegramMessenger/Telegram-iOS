...
public final class AvatarStoryIndicatorComponent: Component {
    ...
    public final class View: UIView {
        ...
        func update(component: AvatarStoryIndicatorComponent, availableSize: CGSize, state: EmptyComponentState, environment: Environment<Empty>, transition: Transition) -> CGSize {
            ...
            self.indicatorView.image = generateImage(CGSize(width: availableSize.width + lineWidth * 2.0, height: availableSize.width + lineWidth * 2.0), rotatedContext: { size, context in
            ...
            transition.setFrame(view: self.indicatorView, frame: CGRect(origin: CGPoint(), size: availableSize).insetBy(dx: -lineWidth * 2.0, dy: -lineWidth * 2.0))
