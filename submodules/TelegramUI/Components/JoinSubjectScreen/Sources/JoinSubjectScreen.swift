...
private final class JoinSubjectScreenComponent: Component {
    ...
    let mode: JoinSubjectScreen.Mode
    ...
    final class View: UIView, UIScrollViewDelegate {
        ...
        private var currentMode: JoinSubjectScreen.Mode?
                ...
                items.append(.action(ContextMenuActionItem(text: peer.displayTitle(strings: environment.strings, displayOrder: presentationData.nameDisplayOrder), textLayout: .secondLineWithValue(peerLabel), icon: { _ in nil }, iconSource: ContextMenuActionItemIconSource(size: avatarSize, signal: avatarSignal), action: { [weak self] c, _ in
                    ...
                    case let .active(active):
                        ...
                        |> deliverOnMainQueue).startStrict(next: { [weak self] result in
                            ...
                            self.currentMode = .active(JoinSubjectScreen.Mode.Active(
                                targetPeer: peer,
                                bot: result,
...
public class JoinSubjectScreen: ViewControllerComponentContainer {
    public typealias Mode = JoinSubjectScreenMode
