...
final class StarsOverviewItemComponent: Component {
    ...
    final class View: UIView {
        ...
        func update(component: StarsOverviewItemComponent, availableSize: CGSize, state: EmptyComponentState, environment: Environment<Empty>, transition: Transition) -> CGSize {
