...
public final class PremiumPeerShortcutComponent: Component {
    ...
    public final class View: UIView {
        ...
        public func update(component: PremiumPeerShortcutComponent, availableSize: CGSize, state: EmptyComponentState, environment: Environment<Empty>, transition: Transition) -> CGSize {
