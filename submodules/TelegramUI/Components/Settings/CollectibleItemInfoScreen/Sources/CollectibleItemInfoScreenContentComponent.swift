...
/*public final class CollectibleItemInfoScreenContentComponent: Component {
    ...
    public final class View: UIView {
        ...
        func update(component: CollectibleItemInfoScreenContentComponent, availableSize: CGSize, state: EmptyComponentState, environment: Environment<Empty>, transition: Transition) -> CGSize {
