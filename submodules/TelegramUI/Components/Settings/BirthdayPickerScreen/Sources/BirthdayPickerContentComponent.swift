...
public final class BirthdayPickerContentComponent: Component {
    ...
    public final class View: UIView {
        ...
        func update(component: BirthdayPickerContentComponent, availableSize: CGSize, state: EmptyComponentState, environment: Environment<Empty>, transition: Transition) -> CGSize {
