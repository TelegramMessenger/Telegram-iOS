...
/*private final class ShareWithPeersScreenComponent: Component {
    ...
    final class View: UIView, UIScrollViewDelegate {
        ...
        override init(frame: CGRect) {
            ...
            self.backgroundView = UIImageView(image: generateStretchableFilledCircleImage(asdf))
                        ...
                        if case let .remove(folderId, _) = component.subject {
                            ...
                            if let navigationController = controller.navigationController as? NavigationController {
                                for viewController in navigationController.viewControllers.reversed() {
                                    if viewController is ShareWithPeersScreen {
                                        continue
                                    }
...
public class ShareWithPeersScreen: ViewControllerComponentContainer {
    ...
    public init(context: AccountContext, subject: Subject, contents: ChatFolderLinkContents, completion: (() -> Void)? = nil) {
        ...
        super.init(context: context, component: ShareWithPeersScreenComponent(context: context, subject: subject, linkContents: contents, completion: completion), navigationBarAppearance: .none)
